...
@SerializersFor([
  ...
  CacheRulesBase,
  CacheRulesCacheReserve,
  CacheRulesCacheReserveClear,
  ...
  CacheRulesOriginPostQuantumEncryption,
  ...
  SmartshieldSmartShieldSettings,
