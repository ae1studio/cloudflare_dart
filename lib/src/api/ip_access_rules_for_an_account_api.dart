...
class IPAccessRulesForAnAccountApi {
  ...
  const IPAccessRulesForAnAccountApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [FirewallResponseSingle] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FirewallResponseSingle>> ipAccessRulesForAnAccountCreateAnIpAccessRule({ 
    ...
    final _path = r'/accounts/{account_id}/firewall/access_rules/rules'.replaceAll('{' r'account_id' '}', encodeQueryParameter(_serializers, accountId, const FullType(String)).toString());
    ...
    FirewallResponseSingle? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FirewallResponseSingle),
      ) as FirewallResponseSingle;
    ...
    return Response<FirewallResponseSingle>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FirewallApiResponseSingleId] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FirewallApiResponseSingleId>> ipAccessRulesForAnAccountDeleteAnIpAccessRule({ 
    ...
    final _path = r'/accounts/{account_id}/firewall/access_rules/rules/{rule_id}'.replaceAll('{' r'rule_id' '}', encodeQueryParameter(_serializers, ruleId, const FullType(String)).toString()).replaceAll('{' r'account_id' '}', encodeQueryParameter(_serializers, accountId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
    ...
    FirewallApiResponseSingleId? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FirewallApiResponseSingleId),
      ) as FirewallApiResponseSingleId;
    ...
    return Response<FirewallApiResponseSingleId>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [FirewallResponseSingle] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FirewallResponseSingle>> ipAccessRulesForAnAccountGetAnIpAccessRule({ 
    required String ruleId,
    required String accountId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FirewallResponseCollection] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FirewallResponseCollection>> ipAccessRulesForAnAccountListIpAccessRules({ 
    required String accountId,
    ...
    FirewallResponseCollection? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FirewallResponseCollection),
      ) as FirewallResponseCollection;
    ...
    return Response<FirewallResponseCollection>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [FirewallResponseSingle] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FirewallResponseSingle>> ipAccessRulesForAnAccountUpdateAnIpAccessRule({ 
    required String ruleId,
    required String accountId,
    required FirewallSchemasRule firewallSchemasRule,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(FirewallSchemasRule);
      _bodyData = _serializers.serialize(firewallSchemasRule, specifiedType: _type);
