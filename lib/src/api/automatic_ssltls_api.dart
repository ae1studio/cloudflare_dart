...
class AutomaticSSLTLSApi {

  final Dio _dio;

  final Serializers _serializers;

  const AutomaticSSLTLSApi(this._dio, this._serializers);
  ...
  Future<Response<CacheApiResponseSingleId>> sslDetectorAutomaticModeGetEnrollment({ 
    ...
    final _path = r'/zones/{zone_id}/settings/ssl_automatic_mode'.replaceAll('{' r'zone_id' '}', encodeQueryParameter(_serializers, zoneId, const FullType(String)).toString());
  ...
  /// Returns a [Future] containing a [Response] with a [CacheApiResponseSingleId] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CacheApiResponseSingleId>> sslDetectorAutomaticModePatchEnrollment({ 
    required String zoneId,
    required CacheSchemasPatch cacheSchemasPatch,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CacheSchemasPatch);
      _bodyData = _serializers.serialize(cacheSchemasPatch, specifiedType: _type);
