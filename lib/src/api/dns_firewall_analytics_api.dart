...
class DNSFirewallAnalyticsApi {
  ...
  const DNSFirewallAnalyticsApi(this._dio, this._serializers);
  ...
  Future<Response<DnsFirewallAnalyticsByTime200Response>> dnsFirewallAnalyticsByTime({ 
    ...
    final _path = r'/accounts/{account_id}/dns_firewall/{dns_firewall_id}/dns_analytics/report/bytime'.replaceAll('{' r'dns_firewall_id' '}', encodeQueryParameter(_serializers, dnsFirewallId, const FullType(String)).toString()).replaceAll('{' r'account_id' '}', encodeQueryParameter(_serializers, accountId, const FullType(String)).toString());
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DnsFirewallAnalyticsTable200Response>> dnsFirewallAnalyticsTable({ 
    required String dnsFirewallId,
    required String accountId,
    String? metrics,
    String? dimensions,
    ...
    final _path = r'/accounts/{account_id}/dns_firewall/{dns_firewall_id}/dns_analytics/report'.replaceAll('{' r'dns_firewall_id' '}', encodeQueryParameter(_serializers, dnsFirewallId, const FullType(String)).toString()).replaceAll('{' r'account_id' '}', encodeQueryParameter(_serializers, accountId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
