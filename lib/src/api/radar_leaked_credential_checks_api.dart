...
class RadarLeakedCredentialChecksApi {

  final Dio _dio;

  final Serializers _serializers;

  const RadarLeakedCredentialChecksApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [RadarGetLeakedCredentialChecksSummary200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RadarGetLeakedCredentialChecksSummary200Response>> radarGetLeakedCredentialChecksSummary({ 
    ...
    final _path = r'/radar/leaked_credential_checks/summary/{dimension}'.replaceAll('{' r'dimension' '}', encodeQueryParameter(_serializers, dimension, const FullType(String)).toString());
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (compromised != null) r'compromised': encodeCollectionQueryParameter<String>(_serializers, compromised, const FullType(BuiltList, [FullType(String)]), format: ListFormat.multi,),
    ...
    RadarGetLeakedCredentialChecksSummary200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RadarGetLeakedCredentialChecksSummary200Response),
      ) as RadarGetLeakedCredentialChecksSummary200Response;
    ...
    return Response<RadarGetLeakedCredentialChecksSummary200Response>(
      data: _responseData,
  ...
  Future<Response<RadarGetHttpSummaryByBotClass200Response>> radarGetLeakedCredentialChecksSummaryByBotClass({ 
    BuiltList<String>? name,
    BuiltList<String>? dateRange,
    BuiltList<DateTime>? dateStart,
    BuiltList<DateTime>? dateEnd,
    ...
    final _path = r'/radar/leaked_credential_checks/summary/bot_class';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RadarGetLeakedCredentialChecksSummaryByCompromised200Response] as data
  /// Throws [DioException] if API call or serialization fails
  @Deprecated('This operation has been deprecated')
  Future<Response<RadarGetLeakedCredentialChecksSummaryByCompromised200Response>> radarGetLeakedCredentialChecksSummaryByCompromised({ 
    BuiltList<String>? name,
    BuiltList<String>? dateRange,
    BuiltList<DateTime>? dateStart,
    BuiltList<DateTime>? dateEnd,
    ...
    final _path = r'/radar/leaked_credential_checks/summary/compromised';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    RadarGetLeakedCredentialChecksSummaryByCompromised200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RadarGetLeakedCredentialChecksSummaryByCompromised200Response),
      ) as RadarGetLeakedCredentialChecksSummaryByCompromised200Response;
    ...
    return Response<RadarGetLeakedCredentialChecksSummaryByCompromised200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [botClass] - Filters results by bot class. Refer to [Bot classes](https://developers.cloudflare.com/radar/concepts/bot-classes/).
  /// * [compromised] - Filters results by compromised credential status (clean vs. compromised).
  /// * [checkResult] - Filters results by leaked credential check result.
  /// * [limitPerGroup] - Limits the number of objects per group to the top items within the specified time range. When item count exceeds the limit, extra items appear grouped under an \"other\" category.
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RadarGetLeakedCredentialChecksTimeseriesGroup200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RadarGetLeakedCredentialChecksTimeseriesGroup200Response>> radarGetLeakedCredentialChecksTimeseriesGroup({ 
    required String dimension,
    String? aggInterval,
    BuiltList<String>? name,
    BuiltList<String>? dateRange,
    ...
    final _path = r'/radar/leaked_credential_checks/timeseries_groups/{dimension}'.replaceAll('{' r'dimension' '}', encodeQueryParameter(_serializers, dimension, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (botClass != null) r'botClass': encodeCollectionQueryParameter<String>(_serializers, botClass, const FullType(BuiltList, [FullType(String)]), format: ListFormat.multi,),
      if (compromised != null) r'compromised': encodeCollectionQueryParameter<String>(_serializers, compromised, const FullType(BuiltList, [FullType(String)]), format: ListFormat.multi,),
      if (checkResult != null) r'checkResult': encodeCollectionQueryParameter<String>(_serializers, checkResult, const FullType(BuiltList, [FullType(String)]), format: ListFormat.multi,),
      if (limitPerGroup != null) r'limitPerGroup': encodeQueryParameter(_serializers, limitPerGroup, const FullType(int)),
    ...
    RadarGetLeakedCredentialChecksTimeseriesGroup200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RadarGetLeakedCredentialChecksTimeseriesGroup200Response),
      ) as RadarGetLeakedCredentialChecksTimeseriesGroup200Response;
    ...
    return Response<RadarGetLeakedCredentialChecksTimeseriesGroup200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  @Deprecated('This operation has been deprecated')
  Future<Response<RadarGetHttpTimeseriesGroupByBotClass200Response>> radarGetLeakedCredentialChecksTimeseriesGroupByBotClass({ 
    String? aggInterval,
    BuiltList<String>? name,
    BuiltList<String>? dateRange,
    BuiltList<DateTime>? dateStart,
    ...
    final _path = r'/radar/leaked_credential_checks/timeseries_groups/bot_class';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RadarGetLeakedCredentialChecksTimeseriesGroupByCompromised200Response] as data
  /// Throws [DioException] if API call or serialization fails
  @Deprecated('This operation has been deprecated')
  Future<Response<RadarGetLeakedCredentialChecksTimeseriesGroupByCompromised200Response>> radarGetLeakedCredentialChecksTimeseriesGroupByCompromised({ 
    String? aggInterval,
    BuiltList<String>? name,
    BuiltList<String>? dateRange,
    BuiltList<DateTime>? dateStart,
    ...
    final _path = r'/radar/leaked_credential_checks/timeseries_groups/compromised';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    RadarGetLeakedCredentialChecksTimeseriesGroupByCompromised200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RadarGetLeakedCredentialChecksTimeseriesGroupByCompromised200Response),
      ) as RadarGetLeakedCredentialChecksTimeseriesGroupByCompromised200Response;
    ...
    return Response<RadarGetLeakedCredentialChecksTimeseriesGroupByCompromised200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
