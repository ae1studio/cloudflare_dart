...
class PagesBuildCacheApi {
  ...
  const PagesBuildCacheApi(this._dio, this._serializers);
  ...
  Future<Response<PagesProjectDeleteProject200Response>> pagesPurgeBuildCache({ 
    ...
    final _path = r'/accounts/{account_id}/pages/projects/{project_name}/purge_build_cache'.replaceAll('{' r'project_name' '}', encodeQueryParameter(_serializers, projectName, const FullType(String)).toString()).replaceAll('{' r'account_id' '}', encodeQueryParameter(_serializers, accountId, const FullType(String)).toString());
