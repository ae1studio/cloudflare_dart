...
class WAFOverridesApi {
  ...
  const WAFOverridesApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [FirewallOverrideResponseSingle] as data
  /// Throws [DioException] if API call or serialization fails
  @Deprecated('This operation has been deprecated')
  Future<Response<FirewallOverrideResponseSingle>> wafOverridesCreateAWafOverride({ 
    required String zoneId,
    required WafOverridesCreateAWafOverrideRequest wafOverridesCreateAWafOverrideRequest,
    ...
    final _path = r'/zones/{zone_id}/firewall/waf/overrides'.replaceAll('{' r'zone_id' '}', encodeQueryParameter(_serializers, zoneId, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(WafOverridesCreateAWafOverrideRequest);
      _bodyData = _serializers.serialize(wafOverridesCreateAWafOverrideRequest, specifiedType: _type);
    ...
    FirewallOverrideResponseSingle? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FirewallOverrideResponseSingle),
      ) as FirewallOverrideResponseSingle;
    ...
    return Response<FirewallOverrideResponseSingle>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [WafOverridesDeleteAWafOverride200Response] as data
  /// Throws [DioException] if API call or serialization fails
  @Deprecated('This operation has been deprecated')
  Future<Response<WafOverridesDeleteAWafOverride200Response>> wafOverridesDeleteAWafOverride({ 
    required String overridesId,
    required String zoneId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/zones/{zone_id}/firewall/waf/overrides/{overrides_id}'.replaceAll('{' r'overrides_id' '}', encodeQueryParameter(_serializers, overridesId, const FullType(String)).toString()).replaceAll('{' r'zone_id' '}', encodeQueryParameter(_serializers, zoneId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
    ...
    WafOverridesDeleteAWafOverride200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(WafOverridesDeleteAWafOverride200Response),
      ) as WafOverridesDeleteAWafOverride200Response;
    ...
    return Response<WafOverridesDeleteAWafOverride200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  @Deprecated('This operation has been deprecated')
  Future<Response<FirewallOverrideResponseSingle>> wafOverridesGetAWafOverride({ 
    required String overridesId,
    required String zoneId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FirewallOverrideResponseCollection] as data
  /// Throws [DioException] if API call or serialization fails
  @Deprecated('This operation has been deprecated')
  Future<Response<FirewallOverrideResponseCollection>> wafOverridesListWafOverrides({ 
    required String zoneId,
    num? page = 1,
    num? perPage = 50,
    CancelToken? cancelToken,
    ...
    FirewallOverrideResponseCollection? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FirewallOverrideResponseCollection),
      ) as FirewallOverrideResponseCollection;
    ...
    return Response<FirewallOverrideResponseCollection>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  @Deprecated('This operation has been deprecated')
  Future<Response<FirewallOverrideResponseSingle>> wafOverridesUpdateWafOverride({ 
    required String overridesId,
    required String zoneId,
    required WafOverridesUpdateWafOverrideRequest wafOverridesUpdateWafOverrideRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(WafOverridesUpdateWafOverrideRequest);
      _bodyData = _serializers.serialize(wafOverridesUpdateWafOverrideRequest, specifiedType: _type);
