...
class FeedbackApi {
  ...
  Future<Response<void>> botManagementZoneFeedbackCreate({ 
    required String zoneId,
    required BotManagementFeedbackReportCreate botManagementFeedbackReportCreate,
    ...
    final _path = r'/zones/{zone_id}/bot_management/feedback'.replaceAll('{' r'zone_id' '}', encodeQueryParameter(_serializers, zoneId, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(BotManagementFeedbackReportCreate);
      _bodyData = _serializers.serialize(botManagementFeedbackReportCreate, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<BotManagementFeedbackReport>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<BotManagementFeedbackReport>>> botManagementZoneFeedbackList({ 
    required String zoneId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    BuiltList<BotManagementFeedbackReport>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(BotManagementFeedbackReport)]),
      ) as BuiltList<BotManagementFeedbackReport>;
    ...
    return Response<BuiltList<BotManagementFeedbackReport>>(
      data: _responseData,
