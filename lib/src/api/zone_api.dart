...
class ZoneApi {
  ...
  const ZoneApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [PutZonesZoneIdActivationCheck200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PutZonesZoneIdActivationCheck200Response>> putZonesZoneIdActivationCheck({ 
    ...
    final _path = r'/zones/{zone_id}/activation_check'.replaceAll('{' r'zone_id' '}', encodeQueryParameter(_serializers, zoneId, const FullType(String)).toString());
    ...
    PutZonesZoneIdActivationCheck200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PutZonesZoneIdActivationCheck200Response),
      ) as PutZonesZoneIdActivationCheck200Response;
    ...
    return Response<PutZonesZoneIdActivationCheck200Response>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CachePurgeApiResponseSingleId] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CachePurgeApiResponseSingleId>> zonePurge({ 
    required String zoneId,
    required ZonePurgeRequest zonePurgeRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/zones/{zone_id}/purge_cache'.replaceAll('{' r'zone_id' '}', encodeQueryParameter(_serializers, zoneId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ZonePurgeRequest);
      _bodyData = _serializers.serialize(zonePurgeRequest, specifiedType: _type);
    ...
    CachePurgeApiResponseSingleId? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CachePurgeApiResponseSingleId),
      ) as CachePurgeApiResponseSingleId;
    ...
    return Response<CachePurgeApiResponseSingleId>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ZonesApiResponseSingleId] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ZonesApiResponseSingleId>> zones0Delete({ 
    required String zoneId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/zones/{zone_id}'.replaceAll('{' r'zone_id' '}', encodeQueryParameter(_serializers, zoneId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ZonesApiResponseSingleId? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ZonesApiResponseSingleId),
      ) as ZonesApiResponseSingleId;
    ...
    return Response<ZonesApiResponseSingleId>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ZonesPost200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ZonesPost200Response>> zones0Get({ 
    required String zoneId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    ZonesPost200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ZonesPost200Response),
      ) as ZonesPost200Response;
    ...
    return Response<ZonesPost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [ZonesPost200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ZonesPost200Response>> zones0Patch({ 
    required String zoneId,
    required Zones0PatchRequest zones0PatchRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(Zones0PatchRequest);
      _bodyData = _serializers.serialize(zones0PatchRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ZonesGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ZonesGet200Response>> zonesGet({ 
    String? name,
    String? status,
    String? accountPeriodId,
    String? accountPeriodName,
    num? page = 1,
    num? perPage = 20,
    String? order,
    String? direction,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (accountPeriodId != null) r'account.id': encodeQueryParameter(_serializers, accountPeriodId, const FullType(String)),
      if (accountPeriodName != null) r'account.name': encodeQueryParameter(_serializers, accountPeriodName, const FullType(String)),
    ...
    ZonesGet200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ZonesGet200Response),
      ) as ZonesGet200Response;
    ...
    return Response<ZonesGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [ZonesPost200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ZonesPost200Response>> zonesPost({ 
    required ZonesPostRequest zonesPostRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(ZonesPostRequest);
      _bodyData = _serializers.serialize(zonesPostRequest, specifiedType: _type);
