...
class WAFPackagesApi {
  ...
  const WAFPackagesApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [FirewallPackageResponseSingle] as data
  /// Throws [DioException] if API call or serialization fails
  @Deprecated('This operation has been deprecated')
  Future<Response<FirewallPackageResponseSingle>> wafPackagesGetAWafPackage({ 
    ...
    final _path = r'/zones/{zone_id}/firewall/waf/packages/{package_id}'.replaceAll('{' r'package_id' '}', encodeQueryParameter(_serializers, packageId, const FullType(String)).toString()).replaceAll('{' r'zone_id' '}', encodeQueryParameter(_serializers, zoneId, const FullType(String)).toString());
    ...
    FirewallPackageResponseSingle? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FirewallPackageResponseSingle),
      ) as FirewallPackageResponseSingle;
    ...
    return Response<FirewallPackageResponseSingle>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FirewallPackageResponseCollection] as data
  /// Throws [DioException] if API call or serialization fails
  @Deprecated('This operation has been deprecated')
  Future<Response<FirewallPackageResponseCollection>> wafPackagesListWafPackages({ 
    required String zoneId,
    num? page = 1,
    num? perPage = 50,
    String? order,
    ...
    final _path = r'/zones/{zone_id}/firewall/waf/packages'.replaceAll('{' r'zone_id' '}', encodeQueryParameter(_serializers, zoneId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    FirewallPackageResponseCollection? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FirewallPackageResponseCollection),
      ) as FirewallPackageResponseCollection;
    ...
    return Response<FirewallPackageResponseCollection>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [WafPackagesUpdateAWafPackage200Response] as data
  /// Throws [DioException] if API call or serialization fails
  @Deprecated('This operation has been deprecated')
  Future<Response<WafPackagesUpdateAWafPackage200Response>> wafPackagesUpdateAWafPackage({ 
    required String packageId,
    required String zoneId,
    required WafPackagesUpdateAWafPackageRequest wafPackagesUpdateAWafPackageRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(WafPackagesUpdateAWafPackageRequest);
      _bodyData = _serializers.serialize(wafPackagesUpdateAWafPackageRequest, specifiedType: _type);
    ...
    WafPackagesUpdateAWafPackage200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(WafPackagesUpdateAWafPackage200Response),
      ) as WafPackagesUpdateAWafPackage200Response;
    ...
    return Response<WafPackagesUpdateAWafPackage200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
