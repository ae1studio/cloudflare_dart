...
class IPAccessRulesForAUserApi {
  ...
  const IPAccessRulesForAUserApi(this._dio, this._serializers);
  ...
  Future<Response<FirewallRuleSingleResponse>> ipAccessRulesForAUserCreateAnIpAccessRule({ 
    ...
    final _path = r'/user/firewall/access_rules/rules';
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FirewallRuleSingleIdResponse>> ipAccessRulesForAUserDeleteAnIpAccessRule({ 
    ...
    final _path = r'/user/firewall/access_rules/rules/{rule_id}'.replaceAll('{' r'rule_id' '}', encodeQueryParameter(_serializers, ruleId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FirewallRuleCollectionResponse>> ipAccessRulesForAUserListIpAccessRules({ 
  ...
  /// Returns a [Future] containing a [Response] with a [FirewallRuleSingleResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FirewallRuleSingleResponse>> ipAccessRulesForAUserUpdateAnIpAccessRule({ 
    required String ruleId,
