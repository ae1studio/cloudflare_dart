...
class ZeroTrustAccountsGetDeviceSettingsForZeroTrustAccount4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<ZeroTrustAccountsGetDeviceSettingsForZeroTrustAccount4XXResponseResultEnum> get serializer => _$zeroTrustAccountsGetDeviceSettingsForZeroTrustAccount4XXResponseResultEnumSerializer;

  const ZeroTrustAccountsGetDeviceSettingsForZeroTrustAccount4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<ZeroTrustAccountsGetDeviceSettingsForZeroTrustAccount4XXResponseResultEnum> get values => _$zeroTrustAccountsGetDeviceSettingsForZeroTrustAccount4XXResponseResultEnumValues;
  static ZeroTrustAccountsGetDeviceSettingsForZeroTrustAccount4XXResponseResultEnum valueOf(String name) => _$zeroTrustAccountsGetDeviceSettingsForZeroTrustAccount4XXResponseResultEnumValueOf(name);
}
