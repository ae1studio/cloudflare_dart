...
part 'rulesets_execute_rule.g.dart';
...
@BuiltValue()
abstract class RulesetsExecuteRule implements RulesetsRule, Built<RulesetsExecuteRule, RulesetsExecuteRuleBuilder> {
  RulesetsExecuteRule._();

  factory RulesetsExecuteRule([void updates(RulesetsExecuteRuleBuilder b)]) = _$RulesetsExecuteRule;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RulesetsExecuteRuleBuilder b) => b
      ..description = ''
      ..enabled = true
      ..actionParameters = {};

  @BuiltValueSerializer(custom: true)
  static Serializer<RulesetsExecuteRule> get serializer => _$RulesetsExecuteRuleSerializer();
}

class _$RulesetsExecuteRuleSerializer implements PrimitiveSerializer<RulesetsExecuteRule> {
  @override
  final Iterable<Type> types = const [RulesetsExecuteRule, _$RulesetsExecuteRule];

  @override
  final String wireName = r'RulesetsExecuteRule';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RulesetsExecuteRule object, {
  ...
  void _deserializeProperties(
    ...
    required RulesetsExecuteRuleBuilder result,
  ...
  @override
  RulesetsExecuteRule deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RulesetsExecuteRuleBuilder();
...
class RulesetsExecuteRuleActionEnum extends EnumClass {

  @BuiltValueEnumConst(wireName: r'execute')
  static const RulesetsExecuteRuleActionEnum execute = _$rulesetsExecuteRuleActionEnum_execute;

  static Serializer<RulesetsExecuteRuleActionEnum> get serializer => _$rulesetsExecuteRuleActionEnumSerializer;

  const RulesetsExecuteRuleActionEnum._(String name): super(name);

  static BuiltSet<RulesetsExecuteRuleActionEnum> get values => _$rulesetsExecuteRuleActionEnumValues;
  static RulesetsExecuteRuleActionEnum valueOf(String name) => _$rulesetsExecuteRuleActionEnumValueOf(name);
}
