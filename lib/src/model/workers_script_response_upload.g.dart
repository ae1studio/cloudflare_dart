...
part of 'workers_script_response_upload.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$WorkersScriptResponseUpload extends WorkersScriptResponseUpload {
  @override
  ...
  factory _$WorkersScriptResponseUpload(
          [void Function(WorkersScriptResponseUploadBuilder)? updates]) =>
      (WorkersScriptResponseUploadBuilder()..update(updates))._build();

  _$WorkersScriptResponseUpload._(
      {this.entryPoint,
      ...
      : super._();
  @override
  WorkersScriptResponseUpload rebuild(
          void Function(WorkersScriptResponseUploadBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  WorkersScriptResponseUploadBuilder toBuilder() =>
      WorkersScriptResponseUploadBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is WorkersScriptResponseUpload &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'WorkersScriptResponseUpload')
...
class WorkersScriptResponseUploadBuilder
    implements
        Builder<WorkersScriptResponseUpload,
            WorkersScriptResponseUploadBuilder>,
        WorkersScriptResponseBuilder {
  _$WorkersScriptResponseUpload? _$v;

  String? _entryPoint;
  String? get entryPoint => _$this._entryPoint;
  set entryPoint(covariant String? entryPoint) =>
  ...
  WorkersScriptResponseUploadBuilder() {
    WorkersScriptResponseUpload._defaults(this);
  }

  WorkersScriptResponseUploadBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant WorkersScriptResponseUpload other) {
    _$v = other as _$WorkersScriptResponseUpload;
  }

  @override
  void update(void Function(WorkersScriptResponseUploadBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  WorkersScriptResponseUpload build() => _build();

  _$WorkersScriptResponseUpload _build() {
    _$WorkersScriptResponseUpload _$result;
    try {
      _$result = _$v ??
          _$WorkersScriptResponseUpload._(
            entryPoint: entryPoint,
            startupTimeMs: BuiltValueNullFieldError.checkNotNull(
                startupTimeMs, r'WorkersScriptResponseUpload', 'startupTimeMs'),
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'WorkersScriptResponseUpload', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
