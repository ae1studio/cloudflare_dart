...
class SecondaryDnsSecondaryZoneSecondaryZoneConfigurationDetails4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<SecondaryDnsSecondaryZoneSecondaryZoneConfigurationDetails4XXResponseResultEnum> get serializer => _$secondaryDnsSecondaryZoneSecondaryZoneConfigurationDetails4XXResponseResultEnumSerializer;

  const SecondaryDnsSecondaryZoneSecondaryZoneConfigurationDetails4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<SecondaryDnsSecondaryZoneSecondaryZoneConfigurationDetails4XXResponseResultEnum> get values => _$secondaryDnsSecondaryZoneSecondaryZoneConfigurationDetails4XXResponseResultEnumValues;
  static SecondaryDnsSecondaryZoneSecondaryZoneConfigurationDetails4XXResponseResultEnum valueOf(String name) => _$secondaryDnsSecondaryZoneSecondaryZoneConfigurationDetails4XXResponseResultEnumValueOf(name);
}
