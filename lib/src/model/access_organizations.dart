...
part 'access_organizations.g.dart';
...
@BuiltValue()
abstract class AccessOrganizations implements Built<AccessOrganizations, AccessOrganizationsBuilder> {
  ...
  AccessOrganizations._();

  factory AccessOrganizations([void updates(AccessOrganizationsBuilder b)]) = _$AccessOrganizations;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AccessOrganizationsBuilder b) => b
      ..allowAuthenticateViaWarp = false
      ..autoRedirectToIdentity = false
      ..isUiReadOnly = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<AccessOrganizations> get serializer => _$AccessOrganizationsSerializer();
}

class _$AccessOrganizationsSerializer implements PrimitiveSerializer<AccessOrganizations> {
  @override
  final Iterable<Type> types = const [AccessOrganizations, _$AccessOrganizations];

  @override
  final String wireName = r'AccessOrganizations';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccessOrganizations object, {
  ...
  void _deserializeProperties(
    ...
    required AccessOrganizationsBuilder result,
  ...
  @override
  AccessOrganizations deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccessOrganizationsBuilder();
