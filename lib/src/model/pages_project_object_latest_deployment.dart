...
part 'pages_project_object_latest_deployment.g.dart';
...
@BuiltValue()
abstract class PagesProjectObjectLatestDeployment implements PagesDeployments, Built<PagesProjectObjectLatestDeployment, PagesProjectObjectLatestDeploymentBuilder> {
  PagesProjectObjectLatestDeployment._();

  factory PagesProjectObjectLatestDeployment([void updates(PagesProjectObjectLatestDeploymentBuilder b)]) = _$PagesProjectObjectLatestDeployment;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PagesProjectObjectLatestDeploymentBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PagesProjectObjectLatestDeployment> get serializer => _$PagesProjectObjectLatestDeploymentSerializer();
}

class _$PagesProjectObjectLatestDeploymentSerializer implements PrimitiveSerializer<PagesProjectObjectLatestDeployment> {
  @override
  final Iterable<Type> types = const [PagesProjectObjectLatestDeployment, _$PagesProjectObjectLatestDeployment];

  @override
  final String wireName = r'PagesProjectObjectLatestDeployment';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PagesProjectObjectLatestDeployment object, {
  ...
  void _deserializeProperties(
    ...
    required PagesProjectObjectLatestDeploymentBuilder result,
  ...
  @override
  PagesProjectObjectLatestDeployment deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PagesProjectObjectLatestDeploymentBuilder();
...
class PagesProjectObjectLatestDeploymentEnvironmentEnum extends EnumClass {

  /// Type of deploy.
  @BuiltValueEnumConst(wireName: r'preview')
  static const PagesProjectObjectLatestDeploymentEnvironmentEnum preview = _$pagesProjectObjectLatestDeploymentEnvironmentEnum_preview;
  /// Type of deploy.
