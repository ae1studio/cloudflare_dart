...
abstract class AccessBisoProps implements AccessFeatureAppProps {
  @BuiltValueSerializer(custom: true)
  static Serializer<AccessBisoProps> get serializer => _$AccessBisoPropsSerializer();
}

class _$AccessBisoPropsSerializer implements PrimitiveSerializer<AccessBisoProps> {
  @override
  final Iterable<Type> types = const [AccessBisoProps];

  @override
  final String wireName = r'AccessBisoProps';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccessBisoProps object, {
  ...
  @override
  AccessBisoProps deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized, specifiedType: FullType($AccessBisoProps)) as $AccessBisoProps;
  }
}

/// a concrete implementation of [AccessBisoProps], since [AccessBisoProps] is not instantiable
@BuiltValue(instantiable: true)
abstract class $AccessBisoProps implements AccessBisoProps, Built<$AccessBisoProps, $AccessBisoPropsBuilder> {
  $AccessBisoProps._();

  factory $AccessBisoProps([void Function($AccessBisoPropsBuilder)? updates]) = _$$AccessBisoProps;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($AccessBisoPropsBuilder b) => b;
...
class _$$AccessBisoPropsSerializer implements PrimitiveSerializer<$AccessBisoProps> {
  @override
  final Iterable<Type> types = const [$AccessBisoProps, _$$AccessBisoProps];
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(AccessBisoProps))!;
  }
  ...
  void _deserializeProperties(
    ...
    required AccessBisoPropsBuilder result,
  ...
  $AccessBisoProps deserialize(
    ...
    final result = $AccessBisoPropsBuilder();
