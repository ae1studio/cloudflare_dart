...
part 'access_policy_resp.g.dart';
...
abstract class AccessPolicyResp implements AccessBasePolicyResp {
  ...
  static Serializer<AccessPolicyResp> get serializer => _$AccessPolicyRespSerializer();
}

class _$AccessPolicyRespSerializer implements PrimitiveSerializer<AccessPolicyResp> {
  @override
  final Iterable<Type> types = const [AccessPolicyResp];

  @override
  final String wireName = r'AccessPolicyResp';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccessPolicyResp object, {
  ...
  @override
  AccessPolicyResp deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized, specifiedType: FullType($AccessPolicyResp)) as $AccessPolicyResp;
  }
}

/// a concrete implementation of [AccessPolicyResp], since [AccessPolicyResp] is not instantiable
@BuiltValue(instantiable: true)
abstract class $AccessPolicyResp implements AccessPolicyResp, Built<$AccessPolicyResp, $AccessPolicyRespBuilder> {
  $AccessPolicyResp._();

  factory $AccessPolicyResp([void Function($AccessPolicyRespBuilder)? updates]) = _$$AccessPolicyResp;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($AccessPolicyRespBuilder b) => b;
...
class _$$AccessPolicyRespSerializer implements PrimitiveSerializer<$AccessPolicyResp> {
  @override
  final Iterable<Type> types = const [$AccessPolicyResp, _$$AccessPolicyResp];
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(AccessPolicyResp))!;
  }
  ...
  void _deserializeProperties(
    ...
    required AccessPolicyRespBuilder result,
  ...
  $AccessPolicyResp deserialize(
    ...
    final result = $AccessPolicyRespBuilder();
