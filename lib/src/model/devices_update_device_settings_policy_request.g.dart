...
part of 'devices_update_device_settings_policy_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DevicesUpdateDeviceSettingsPolicyRequest
    extends DevicesUpdateDeviceSettingsPolicyRequest {
  @override
  ...
  factory _$DevicesUpdateDeviceSettingsPolicyRequest(
          [void Function(DevicesUpdateDeviceSettingsPolicyRequestBuilder)?
              updates]) =>
      (DevicesUpdateDeviceSettingsPolicyRequestBuilder()..update(updates))
          ._build();

  _$DevicesUpdateDeviceSettingsPolicyRequest._(
      ...
      : super._();
  @override
  DevicesUpdateDeviceSettingsPolicyRequest rebuild(
          void Function(DevicesUpdateDeviceSettingsPolicyRequestBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  DevicesUpdateDeviceSettingsPolicyRequestBuilder toBuilder() =>
      DevicesUpdateDeviceSettingsPolicyRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DevicesUpdateDeviceSettingsPolicyRequest &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'DevicesUpdateDeviceSettingsPolicyRequest')
...
class DevicesUpdateDeviceSettingsPolicyRequestBuilder
    implements
        Builder<DevicesUpdateDeviceSettingsPolicyRequest,
            DevicesUpdateDeviceSettingsPolicyRequestBuilder> {
  _$DevicesUpdateDeviceSettingsPolicyRequest? _$v;
  ...
  DevicesUpdateDeviceSettingsPolicyRequestBuilder() {
    DevicesUpdateDeviceSettingsPolicyRequest._defaults(this);
  }

  DevicesUpdateDeviceSettingsPolicyRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(DevicesUpdateDeviceSettingsPolicyRequest other) {
    _$v = other as _$DevicesUpdateDeviceSettingsPolicyRequest;
  }

  @override
  void update(
      void Function(DevicesUpdateDeviceSettingsPolicyRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  DevicesUpdateDeviceSettingsPolicyRequest build() => _build();

  _$DevicesUpdateDeviceSettingsPolicyRequest _build() {
    _$DevicesUpdateDeviceSettingsPolicyRequest _$result;
    try {
      _$result = _$v ??
          _$DevicesUpdateDeviceSettingsPolicyRequest._(
