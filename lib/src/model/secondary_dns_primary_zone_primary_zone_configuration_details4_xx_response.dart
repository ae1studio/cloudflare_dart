...
class SecondaryDnsPrimaryZonePrimaryZoneConfigurationDetails4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<SecondaryDnsPrimaryZonePrimaryZoneConfigurationDetails4XXResponseResultEnum> get serializer => _$secondaryDnsPrimaryZonePrimaryZoneConfigurationDetails4XXResponseResultEnumSerializer;

  const SecondaryDnsPrimaryZonePrimaryZoneConfigurationDetails4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<SecondaryDnsPrimaryZonePrimaryZoneConfigurationDetails4XXResponseResultEnum> get values => _$secondaryDnsPrimaryZonePrimaryZoneConfigurationDetails4XXResponseResultEnumValues;
  static SecondaryDnsPrimaryZonePrimaryZoneConfigurationDetails4XXResponseResultEnum valueOf(String name) => _$secondaryDnsPrimaryZonePrimaryZoneConfigurationDetails4XXResponseResultEnumValueOf(name);
}
