...
part 'browser_isolation_permissions_application2.g.dart';
...
@BuiltValue()
abstract class BrowserIsolationPermissionsApplication2 implements AccessSchemasBasicAppResponseProps, AccessSchemasBisoProps, Built<BrowserIsolationPermissionsApplication2, BrowserIsolationPermissionsApplication2Builder> {
  BrowserIsolationPermissionsApplication2._();

  factory BrowserIsolationPermissionsApplication2([void updates(BrowserIsolationPermissionsApplication2Builder b)]) = _$BrowserIsolationPermissionsApplication2;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BrowserIsolationPermissionsApplication2Builder b) => b
      ..autoRedirectToIdentity = false
      ..sessionDuration = '24h';

  @BuiltValueSerializer(custom: true)
  static Serializer<BrowserIsolationPermissionsApplication2> get serializer => _$BrowserIsolationPermissionsApplication2Serializer();
}

class _$BrowserIsolationPermissionsApplication2Serializer implements PrimitiveSerializer<BrowserIsolationPermissionsApplication2> {
  @override
  final Iterable<Type> types = const [BrowserIsolationPermissionsApplication2, _$BrowserIsolationPermissionsApplication2];

  @override
  final String wireName = r'BrowserIsolationPermissionsApplication2';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BrowserIsolationPermissionsApplication2 object, {
  ...
  void _deserializeProperties(
    ...
    required BrowserIsolationPermissionsApplication2Builder result,
  ...
  @override
  BrowserIsolationPermissionsApplication2 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BrowserIsolationPermissionsApplication2Builder();
