...
class DevicePostureIntegrationsCreateDevicePostureIntegration4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<DevicePostureIntegrationsCreateDevicePostureIntegration4XXResponseResultEnum> get serializer => _$devicePostureIntegrationsCreateDevicePostureIntegration4XXResponseResultEnumSerializer;

  const DevicePostureIntegrationsCreateDevicePostureIntegration4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<DevicePostureIntegrationsCreateDevicePostureIntegration4XXResponseResultEnum> get values => _$devicePostureIntegrationsCreateDevicePostureIntegration4XXResponseResultEnumValues;
  static DevicePostureIntegrationsCreateDevicePostureIntegration4XXResponseResultEnum valueOf(String name) => _$devicePostureIntegrationsCreateDevicePostureIntegration4XXResponseResultEnumValueOf(name);
}
