...
part 'access_schemas_scim_config.g.dart';

/// Configuration for provisioning to this application via SCIM. This is currently in closed beta.
///
/// Properties:
/// * [authentication] 
/// * [deactivateOnDelete] - If false, we propagate DELETE requests to the target application for SCIM resources. If true, we only set `active` to false on the SCIM resource. This is useful because some targets do not support DELETE operations.
...
@BuiltValue()
abstract class AccessSchemasScimConfig implements Built<AccessSchemasScimConfig, AccessSchemasScimConfigBuilder> {
  @BuiltValueField(wireName: r'authentication')
  AccessSchemasScimConfigAuthentication? get authentication;
  ...
  AccessSchemasScimConfig._();

  factory AccessSchemasScimConfig([void updates(AccessSchemasScimConfigBuilder b)]) = _$AccessSchemasScimConfig;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AccessSchemasScimConfigBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AccessSchemasScimConfig> get serializer => _$AccessSchemasScimConfigSerializer();
}

class _$AccessSchemasScimConfigSerializer implements PrimitiveSerializer<AccessSchemasScimConfig> {
  @override
  final Iterable<Type> types = const [AccessSchemasScimConfig, _$AccessSchemasScimConfig];

  @override
  final String wireName = r'AccessSchemasScimConfig';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccessSchemasScimConfig object, {
    ...
    if (object.authentication != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(AccessSchemasScimConfigAuthentication),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required AccessSchemasScimConfigBuilder result,
      ...
      switch (key) {
        case r'authentication':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(AccessSchemasScimConfigAuthentication),
          ) as AccessSchemasScimConfigAuthentication;
  ...
  @override
  AccessSchemasScimConfig deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccessSchemasScimConfigBuilder();
