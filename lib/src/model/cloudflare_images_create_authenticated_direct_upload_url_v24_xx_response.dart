...
class CloudflareImagesCreateAuthenticatedDirectUploadUrlV24XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<CloudflareImagesCreateAuthenticatedDirectUploadUrlV24XXResponseResultEnum> get serializer => _$cloudflareImagesCreateAuthenticatedDirectUploadUrlV24XXResponseResultEnumSerializer;

  const CloudflareImagesCreateAuthenticatedDirectUploadUrlV24XXResponseResultEnum._(String name): super(name);

  static BuiltSet<CloudflareImagesCreateAuthenticatedDirectUploadUrlV24XXResponseResultEnum> get values => _$cloudflareImagesCreateAuthenticatedDirectUploadUrlV24XXResponseResultEnumValues;
  static CloudflareImagesCreateAuthenticatedDirectUploadUrlV24XXResponseResultEnum valueOf(String name) => _$cloudflareImagesCreateAuthenticatedDirectUploadUrlV24XXResponseResultEnumValueOf(name);
}
