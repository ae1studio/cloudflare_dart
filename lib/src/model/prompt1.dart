...
@BuiltValue()
abstract class Prompt1 implements Built<Prompt1, Prompt1Builder> {
  ...
  factory Prompt1([void updates(Prompt1Builder b)]) = _$Prompt1;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(Prompt1Builder b) => b
      ..maxTokens = 256
      ..raw = false
      ..stream = false
      ..temperature = 0.6;
  ...
  static Serializer<Prompt1> get serializer => _$Prompt1Serializer();
}

class _$Prompt1Serializer implements PrimitiveSerializer<Prompt1> {
  @override
  final Iterable<Type> types = const [Prompt1, _$Prompt1];

  @override
  final String wireName = r'Prompt1';
  ...
  void _deserializeProperties(
    ...
    required Prompt1Builder result,
