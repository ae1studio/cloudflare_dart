...
class IpAddressManagementPrefixDelegationCreatePrefixDelegation4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<IpAddressManagementPrefixDelegationCreatePrefixDelegation4XXResponseResultEnum> get serializer => _$ipAddressManagementPrefixDelegationCreatePrefixDelegation4XXResponseResultEnumSerializer;

  const IpAddressManagementPrefixDelegationCreatePrefixDelegation4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<IpAddressManagementPrefixDelegationCreatePrefixDelegation4XXResponseResultEnum> get values => _$ipAddressManagementPrefixDelegationCreatePrefixDelegation4XXResponseResultEnumValues;
  static IpAddressManagementPrefixDelegationCreatePrefixDelegation4XXResponseResultEnum valueOf(String name) => _$ipAddressManagementPrefixDelegationCreatePrefixDelegation4XXResponseResultEnumValueOf(name);
}
