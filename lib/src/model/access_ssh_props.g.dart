...
class _$$AccessSshProps extends $AccessSshProps {
  ...
  @override
  $AccessSshPropsBuilder toBuilder() => $AccessSshPropsBuilder()..replace(this);
...
class $AccessSshPropsBuilder
  ...
  @override
  $AccessSshProps build() => _build();

  _$$AccessSshProps _build() {
    _$$AccessSshProps _$result;
    try {
      _$result = _$v ??
          _$$AccessSshProps._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'$AccessSshProps', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
