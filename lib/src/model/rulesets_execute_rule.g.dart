...
part of 'rulesets_execute_rule.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const RulesetsExecuteRuleActionEnum _$rulesetsExecuteRuleActionEnum_execute =
    const RulesetsExecuteRuleActionEnum._('execute');

RulesetsExecuteRuleActionEnum _$rulesetsExecuteRuleActionEnumValueOf(
    String name) {
  switch (name) {
    case 'execute':
      return _$rulesetsExecuteRuleActionEnum_execute;
    default:
      throw ArgumentError(name);
  }
}

final BuiltSet<RulesetsExecuteRuleActionEnum>
    _$rulesetsExecuteRuleActionEnumValues = BuiltSet<
        RulesetsExecuteRuleActionEnum>(const <RulesetsExecuteRuleActionEnum>[
  _$rulesetsExecuteRuleActionEnum_execute,
]);

Serializer<RulesetsExecuteRuleActionEnum>
    _$rulesetsExecuteRuleActionEnumSerializer =
    _$RulesetsExecuteRuleActionEnumSerializer();

class _$RulesetsExecuteRuleActionEnumSerializer
    implements PrimitiveSerializer<RulesetsExecuteRuleActionEnum> {
  ...
  @override
  final Iterable<Type> types = const <Type>[RulesetsExecuteRuleActionEnum];
  @override
  final String wireName = 'RulesetsExecuteRuleActionEnum';

  @override
  Object serialize(
          Serializers serializers, RulesetsExecuteRuleActionEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  RulesetsExecuteRuleActionEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      RulesetsExecuteRuleActionEnum.valueOf(
          _fromWire[serialized] ?? (serialized is String ? serialized : ''));
}

class _$RulesetsExecuteRule extends RulesetsExecuteRule {
  @override
  final String? action;
  @override
  ...
  factory _$RulesetsExecuteRule(
          [void Function(RulesetsExecuteRuleBuilder)? updates]) =>
      (RulesetsExecuteRuleBuilder()..update(updates))._build();

  _$RulesetsExecuteRule._(
      {this.action,
      ...
      : super._();
  @override
  RulesetsExecuteRule rebuild(
          void Function(RulesetsExecuteRuleBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RulesetsExecuteRuleBuilder toBuilder() =>
      RulesetsExecuteRuleBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RulesetsExecuteRule &&
        action == other.action &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RulesetsExecuteRule')
          ..add('action', action)
...
class RulesetsExecuteRuleBuilder
    implements
        Builder<RulesetsExecuteRule, RulesetsExecuteRuleBuilder>,
        RulesetsRuleBuilder {
  _$RulesetsExecuteRule? _$v;
  ...
  RulesetsExecuteRuleBuilder() {
    RulesetsExecuteRule._defaults(this);
  }

  RulesetsExecuteRuleBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _action = $v.action;
  ...
  @override
  void replace(covariant RulesetsExecuteRule other) {
    _$v = other as _$RulesetsExecuteRule;
  }

  @override
  void update(void Function(RulesetsExecuteRuleBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RulesetsExecuteRule build() => _build();

  _$RulesetsExecuteRule _build() {
    _$RulesetsExecuteRule _$result;
    try {
      _$result = _$v ??
          _$RulesetsExecuteRule._(
            action: action,
            ...
            lastUpdated: BuiltValueNullFieldError.checkNotNull(
                lastUpdated, r'RulesetsExecuteRule', 'lastUpdated'),
            logging: _logging?.build(),
            ratelimit: _ratelimit?.build(),
            ref: ref,
            version: BuiltValueNullFieldError.checkNotNull(
                version, r'RulesetsExecuteRule', 'version'),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'RulesetsExecuteRule', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
