...
part 'zones_multiple_settings_inner.g.dart';
...
@BuiltValue()
abstract class ZonesMultipleSettingsInner implements Built<ZonesMultipleSettingsInner, ZonesMultipleSettingsInnerBuilder> {
  ...
  ZonesMultipleSettingsInner._();

  factory ZonesMultipleSettingsInner([void updates(ZonesMultipleSettingsInnerBuilder b)]) = _$ZonesMultipleSettingsInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ZonesMultipleSettingsInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ZonesMultipleSettingsInner> get serializer => _$ZonesMultipleSettingsInnerSerializer();
}

class _$ZonesMultipleSettingsInnerSerializer implements PrimitiveSerializer<ZonesMultipleSettingsInner> {
  @override
  final Iterable<Type> types = const [ZonesMultipleSettingsInner, _$ZonesMultipleSettingsInner];

  @override
  final String wireName = r'ZonesMultipleSettingsInner';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ZonesMultipleSettingsInner object, {
  ...
  @override
  ZonesMultipleSettingsInner deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ZonesMultipleSettingsInnerBuilder();
    Object? anyOfDataSrc;
    final targetType = const FullType(AnyOf, [FullType(Zones0rtt), FullType(ZonesAdvancedDdos), FullType(ZonesCacheRulesAegis), FullType(ZonesAlwaysOnline), FullType(ZonesSchemasAlwaysUseHttps), FullType(ZonesSchemasAutomaticHttpsRewrites), FullType(ZonesBrotli), FullType(ZonesSchemasBrowserCacheTtl), FullType(ZonesSchemasBrowserCheck), FullType(ZonesSchemasCacheLevel), FullType(ZonesChallengeTtl), FullType(ZonesChinaNetworkEnabled), FullType(ZonesCiphers), FullType(ZonesCnameFlattening), FullType(ZonesDevelopmentMode), FullType(ZonesEarlyHints), FullType(ZonesSchemasEdgeCacheTtl), FullType(ZonesSchemasEmailObfuscation), FullType(ZonesH2Prioritization), FullType(ZonesHotlinkProtection), FullType(ZonesHttp2), FullType(ZonesHttp3), FullType(ZonesSchemasIpGeolocation), FullType(ZonesIpv6), FullType(ZonesMaxUpload), FullType(ZonesMinTlsVersion), FullType(ZonesSchemasMirage), FullType(ZonesNel), FullType(ZonesSchemasOpportunisticEncryption), FullType(ZonesOpportunisticOnion), FullType(ZonesOrangeToOrange), FullType(ZonesSchemasOriginErrorPagePassThru), FullType(ZonesCacheRulesOriginH2MaxStreams), FullType(ZonesCacheRulesOriginMaxHttpVersion), FullType(ZonesSchemasPolish), FullType(ZonesPrefetchPreload), FullType(ZonesPrivacyPass), FullType(ZonesProxyReadTimeout), FullType(ZonesPseudoIpv4), FullType(ZonesReplaceInsecureJs), FullType(ZonesSchemasResponseBuffering), FullType(ZonesSchemasRocketLoader), FullType(ZonesSchemasAutomaticPlatformOptimization), FullType(ZonesSecurityHeader), FullType(ZonesSchemasSecurityLevel), FullType(ZonesServerSideExclude), FullType(ZonesSha1Support), FullType(ZonesSchemasSortQueryStringForCache), FullType(ZonesSchemasSsl), FullType(ZonesSslRecommender), FullType(ZonesTls12Only), FullType(ZonesTls13), FullType(ZonesTlsClientAuth), FullType(ZonesSchemasTrueClientIpHeader), FullType(ZonesSchemasWaf), FullType(ZonesWebp), FullType(ZonesWebsockets), ]);
...
class ZonesMultipleSettingsInnerIdEnum extends EnumClass {
