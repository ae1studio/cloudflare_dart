...
part 'rulesets_score_rule.g.dart';
...
@BuiltValue()
abstract class RulesetsScoreRule implements RulesetsRule, Built<RulesetsScoreRule, RulesetsScoreRuleBuilder> {
  RulesetsScoreRule._();

  factory RulesetsScoreRule([void updates(RulesetsScoreRuleBuilder b)]) = _$RulesetsScoreRule;
  ...
  static Serializer<RulesetsScoreRule> get serializer => _$RulesetsScoreRuleSerializer();
}

class _$RulesetsScoreRuleSerializer implements PrimitiveSerializer<RulesetsScoreRule> {
  @override
  final Iterable<Type> types = const [RulesetsScoreRule, _$RulesetsScoreRule];

  @override
  final String wireName = r'RulesetsScoreRule';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RulesetsScoreRule object, {
  ...
  void _deserializeProperties(
    ...
    required RulesetsScoreRuleBuilder result,
  ...
  @override
  RulesetsScoreRule deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RulesetsScoreRuleBuilder();
...
class RulesetsScoreRuleActionEnum extends EnumClass {
