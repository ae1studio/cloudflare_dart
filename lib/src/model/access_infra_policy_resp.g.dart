...
part of 'access_infra_policy_resp.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$AccessInfraPolicyResp extends AccessInfraPolicyResp {
  @override
  ...
  factory _$AccessInfraPolicyResp(
          [void Function(AccessInfraPolicyRespBuilder)? updates]) =>
      (AccessInfraPolicyRespBuilder()..update(updates))._build();

  _$AccessInfraPolicyResp._(
      ...
      : super._();
  @override
  AccessInfraPolicyResp rebuild(
          void Function(AccessInfraPolicyRespBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  AccessInfraPolicyRespBuilder toBuilder() =>
      AccessInfraPolicyRespBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AccessInfraPolicyResp &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AccessInfraPolicyResp')
...
class AccessInfraPolicyRespBuilder
    implements
        Builder<AccessInfraPolicyResp, AccessInfraPolicyRespBuilder>,
        AccessBasePolicyRespBuilder {
  _$AccessInfraPolicyResp? _$v;
  ...
  AccessInfraPolicyRespBuilder() {
    AccessInfraPolicyResp._defaults(this);
  }

  AccessInfraPolicyRespBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant AccessInfraPolicyResp other) {
    _$v = other as _$AccessInfraPolicyResp;
  }

  @override
  void update(void Function(AccessInfraPolicyRespBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  AccessInfraPolicyResp build() => _build();

  _$AccessInfraPolicyResp _build() {
    _$AccessInfraPolicyResp _$result;
    try {
      _$result = _$v ??
          _$AccessInfraPolicyResp._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'AccessInfraPolicyResp', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
