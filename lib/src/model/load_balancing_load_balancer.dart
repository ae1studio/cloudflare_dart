...
part 'load_balancing_load_balancer.g.dart';
...
/// * [zoneName] 
@BuiltValue()
abstract class LoadBalancingLoadBalancer implements Built<LoadBalancingLoadBalancer, LoadBalancingLoadBalancerBuilder> {
  ...
  LoadBalancingLoadBalancer._();

  factory LoadBalancingLoadBalancer([void updates(LoadBalancingLoadBalancerBuilder b)]) = _$LoadBalancingLoadBalancer;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LoadBalancingLoadBalancerBuilder b) => b
      ..enabled = true
      ..proxied = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<LoadBalancingLoadBalancer> get serializer => _$LoadBalancingLoadBalancerSerializer();
}

class _$LoadBalancingLoadBalancerSerializer implements PrimitiveSerializer<LoadBalancingLoadBalancer> {
  @override
  final Iterable<Type> types = const [LoadBalancingLoadBalancer, _$LoadBalancingLoadBalancer];

  @override
  final String wireName = r'LoadBalancingLoadBalancer';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    LoadBalancingLoadBalancer object, {
  ...
  void _deserializeProperties(
    ...
    required LoadBalancingLoadBalancerBuilder result,
  ...
  @override
  LoadBalancingLoadBalancer deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = LoadBalancingLoadBalancerBuilder();
