...
class DevicePostureIntegrationsListDevicePostureIntegrations4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<DevicePostureIntegrationsListDevicePostureIntegrations4XXResponseResultEnum> get serializer => _$devicePostureIntegrationsListDevicePostureIntegrations4XXResponseResultSerializer;

  const DevicePostureIntegrationsListDevicePostureIntegrations4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<DevicePostureIntegrationsListDevicePostureIntegrations4XXResponseResultEnum> get values => _$devicePostureIntegrationsListDevicePostureIntegrations4XXResponseResultValues;
  static DevicePostureIntegrationsListDevicePostureIntegrations4XXResponseResultEnum valueOf(String name) => _$devicePostureIntegrationsListDevicePostureIntegrations4XXResponseResultValueOf(name);
}
