...
part of 'rulesets_set_config_rule.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const RulesetsSetConfigRuleActionEnum
    _$rulesetsSetConfigRuleActionEnum_setConfig =
    const RulesetsSetConfigRuleActionEnum._('setConfig');

RulesetsSetConfigRuleActionEnum _$rulesetsSetConfigRuleActionEnumValueOf(
    String name) {
  switch (name) {
    case 'setConfig':
      return _$rulesetsSetConfigRuleActionEnum_setConfig;
    default:
      throw ArgumentError(name);
  }
}

final BuiltSet<RulesetsSetConfigRuleActionEnum>
    _$rulesetsSetConfigRuleActionEnumValues = BuiltSet<
        RulesetsSetConfigRuleActionEnum>(const <RulesetsSetConfigRuleActionEnum>[
  _$rulesetsSetConfigRuleActionEnum_setConfig,
]);

Serializer<RulesetsSetConfigRuleActionEnum>
    _$rulesetsSetConfigRuleActionEnumSerializer =
    _$RulesetsSetConfigRuleActionEnumSerializer();

class _$RulesetsSetConfigRuleActionEnumSerializer
    implements PrimitiveSerializer<RulesetsSetConfigRuleActionEnum> {
  ...
  @override
  final Iterable<Type> types = const <Type>[RulesetsSetConfigRuleActionEnum];
  @override
  final String wireName = 'RulesetsSetConfigRuleActionEnum';

  @override
  Object serialize(
          Serializers serializers, RulesetsSetConfigRuleActionEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  RulesetsSetConfigRuleActionEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      RulesetsSetConfigRuleActionEnum.valueOf(
          _fromWire[serialized] ?? (serialized is String ? serialized : ''));
}

class _$RulesetsSetConfigRule extends RulesetsSetConfigRule {
  @override
  ...
  factory _$RulesetsSetConfigRule(
          [void Function(RulesetsSetConfigRuleBuilder)? updates]) =>
      (RulesetsSetConfigRuleBuilder()..update(updates))._build();

  _$RulesetsSetConfigRule._(
      ...
      : super._();
  @override
  RulesetsSetConfigRule rebuild(
          void Function(RulesetsSetConfigRuleBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RulesetsSetConfigRuleBuilder toBuilder() =>
      RulesetsSetConfigRuleBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RulesetsSetConfigRule &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RulesetsSetConfigRule')
...
class RulesetsSetConfigRuleBuilder
    implements
        Builder<RulesetsSetConfigRule, RulesetsSetConfigRuleBuilder>,
        RulesetsRuleBuilder {
  _$RulesetsSetConfigRule? _$v;
  ...
  RulesetsSetConfigRuleBuilder() {
    RulesetsSetConfigRule._defaults(this);
  }

  RulesetsSetConfigRuleBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant RulesetsSetConfigRule other) {
    _$v = other as _$RulesetsSetConfigRule;
  }

  @override
  void update(void Function(RulesetsSetConfigRuleBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RulesetsSetConfigRule build() => _build();

  _$RulesetsSetConfigRule _build() {
    _$RulesetsSetConfigRule _$result;
    try {
      _$result = _$v ??
          _$RulesetsSetConfigRule._(
            lastUpdated: BuiltValueNullFieldError.checkNotNull(
                lastUpdated, r'RulesetsSetConfigRule', 'lastUpdated'),
            version: BuiltValueNullFieldError.checkNotNull(
                version, r'RulesetsSetConfigRule', 'version'),
            action: action,
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'RulesetsSetConfigRule', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
