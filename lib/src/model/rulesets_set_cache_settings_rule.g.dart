...
part of 'rulesets_set_cache_settings_rule.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const RulesetsSetCacheSettingsRuleActionEnum
    _$rulesetsSetCacheSettingsRuleActionEnum_setCacheSettings =
    const RulesetsSetCacheSettingsRuleActionEnum._('setCacheSettings');

RulesetsSetCacheSettingsRuleActionEnum
    _$rulesetsSetCacheSettingsRuleActionEnumValueOf(String name) {
  switch (name) {
    case 'setCacheSettings':
      return _$rulesetsSetCacheSettingsRuleActionEnum_setCacheSettings;
    default:
      throw ArgumentError(name);
  }
}

final BuiltSet<RulesetsSetCacheSettingsRuleActionEnum>
    _$rulesetsSetCacheSettingsRuleActionEnumValues = BuiltSet<
        RulesetsSetCacheSettingsRuleActionEnum>(const <RulesetsSetCacheSettingsRuleActionEnum>[
  _$rulesetsSetCacheSettingsRuleActionEnum_setCacheSettings,
]);

Serializer<RulesetsSetCacheSettingsRuleActionEnum>
    _$rulesetsSetCacheSettingsRuleActionEnumSerializer =
    _$RulesetsSetCacheSettingsRuleActionEnumSerializer();

class _$RulesetsSetCacheSettingsRuleActionEnumSerializer
    implements PrimitiveSerializer<RulesetsSetCacheSettingsRuleActionEnum> {
  ...
  @override
  final String wireName = 'RulesetsSetCacheSettingsRuleActionEnum';

  @override
  Object serialize(Serializers serializers,
          RulesetsSetCacheSettingsRuleActionEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  RulesetsSetCacheSettingsRuleActionEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      RulesetsSetCacheSettingsRuleActionEnum.valueOf(
...
class _$RulesetsSetCacheSettingsRule extends RulesetsSetCacheSettingsRule {
  ...
  @override
  RulesetsSetCacheSettingsRuleBuilder toBuilder() =>
      RulesetsSetCacheSettingsRuleBuilder()..replace(this);
...
class RulesetsSetCacheSettingsRuleBuilder
    implements
        Builder<RulesetsSetCacheSettingsRule,
  ...
  @override
  void replace(covariant RulesetsSetCacheSettingsRule other) {
    _$v = other as _$RulesetsSetCacheSettingsRule;
  }

  @override
  void update(void Function(RulesetsSetCacheSettingsRuleBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RulesetsSetCacheSettingsRule build() => _build();

  _$RulesetsSetCacheSettingsRule _build() {
    _$RulesetsSetCacheSettingsRule _$result;
    try {
      _$result = _$v ??
          _$RulesetsSetCacheSettingsRule._(
            action: action,
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'RulesetsSetCacheSettingsRule', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
