...
class ApiShieldGlobalSettingChangeBaseValidationDefaultMitigationActionEnum extends EnumClass {
  ...
  static Serializer<ApiShieldGlobalSettingChangeBaseValidationDefaultMitigationActionEnum> get serializer => _$apiShieldGlobalSettingChangeBaseValidationDefaultMitigationActionEnumSerializer;

  const ApiShieldGlobalSettingChangeBaseValidationDefaultMitigationActionEnum._(String name): super(name);

  static BuiltSet<ApiShieldGlobalSettingChangeBaseValidationDefaultMitigationActionEnum> get values => _$apiShieldGlobalSettingChangeBaseValidationDefaultMitigationActionEnumValues;
  static ApiShieldGlobalSettingChangeBaseValidationDefaultMitigationActionEnum valueOf(String name) => _$apiShieldGlobalSettingChangeBaseValidationDefaultMitigationActionEnumValueOf(name);
}
...
class ApiShieldGlobalSettingChangeBaseValidationOverrideMitigationActionEnum extends EnumClass {
  ...
  static Serializer<ApiShieldGlobalSettingChangeBaseValidationOverrideMitigationActionEnum> get serializer => _$apiShieldGlobalSettingChangeBaseValidationOverrideMitigationActionEnumSerializer;

  const ApiShieldGlobalSettingChangeBaseValidationOverrideMitigationActionEnum._(String name): super(name);

  static BuiltSet<ApiShieldGlobalSettingChangeBaseValidationOverrideMitigationActionEnum> get values => _$apiShieldGlobalSettingChangeBaseValidationOverrideMitigationActionEnumValues;
  static ApiShieldGlobalSettingChangeBaseValidationOverrideMitigationActionEnum valueOf(String name) => _$apiShieldGlobalSettingChangeBaseValidationOverrideMitigationActionEnumValueOf(name);
}
