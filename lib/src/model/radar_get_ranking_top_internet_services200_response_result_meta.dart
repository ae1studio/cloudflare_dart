...
class RadarGetRankingTopInternetServices200ResponseResultMetaNormalizationEnum extends EnumClass {
  ...
  static Serializer<RadarGetRankingTopInternetServices200ResponseResultMetaNormalizationEnum> get serializer => _$radarGetRankingTopInternetServices200ResponseResultMetaNormalizationEnumSerializer;

  const RadarGetRankingTopInternetServices200ResponseResultMetaNormalizationEnum._(String name): super(name);

  static BuiltSet<RadarGetRankingTopInternetServices200ResponseResultMetaNormalizationEnum> get values => _$radarGetRankingTopInternetServices200ResponseResultMetaNormalizationEnumValues;
  static RadarGetRankingTopInternetServices200ResponseResultMetaNormalizationEnum valueOf(String name) => _$radarGetRankingTopInternetServices200ResponseResultMetaNormalizationEnumValueOf(name);
}
