...
part 'rulesets_redirect_rule.g.dart';
...
@BuiltValue()
abstract class RulesetsRedirectRule implements RulesetsRule, Built<RulesetsRedirectRule, RulesetsRedirectRuleBuilder> {
  RulesetsRedirectRule._();

  factory RulesetsRedirectRule([void updates(RulesetsRedirectRuleBuilder b)]) = _$RulesetsRedirectRule;
  ...
  static Serializer<RulesetsRedirectRule> get serializer => _$RulesetsRedirectRuleSerializer();
}

class _$RulesetsRedirectRuleSerializer implements PrimitiveSerializer<RulesetsRedirectRule> {
  @override
  final Iterable<Type> types = const [RulesetsRedirectRule, _$RulesetsRedirectRule];

  @override
  final String wireName = r'RulesetsRedirectRule';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RulesetsRedirectRule object, {
  ...
  void _deserializeProperties(
    ...
    required RulesetsRedirectRuleBuilder result,
  ...
  @override
  RulesetsRedirectRule deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RulesetsRedirectRuleBuilder();
...
class RulesetsRedirectRuleActionEnum extends EnumClass {
