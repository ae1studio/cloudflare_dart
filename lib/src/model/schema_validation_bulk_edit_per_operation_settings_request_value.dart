...
class SchemaValidationBulkEditPerOperationSettingsRequestValueMitigationActionEnum extends EnumClass {
  ...
  static Serializer<SchemaValidationBulkEditPerOperationSettingsRequestValueMitigationActionEnum> get serializer => _$schemaValidationBulkEditPerOperationSettingsRequestValueMitigationActionEnumSerializer;

  const SchemaValidationBulkEditPerOperationSettingsRequestValueMitigationActionEnum._(String name): super(name);

  static BuiltSet<SchemaValidationBulkEditPerOperationSettingsRequestValueMitigationActionEnum> get values => _$schemaValidationBulkEditPerOperationSettingsRequestValueMitigationActionEnumValues;
  static SchemaValidationBulkEditPerOperationSettingsRequestValueMitigationActionEnum valueOf(String name) => _$schemaValidationBulkEditPerOperationSettingsRequestValueMitigationActionEnumValueOf(name);
}
