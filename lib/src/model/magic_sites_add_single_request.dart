...
part 'magic_sites_add_single_request.g.dart';
...
abstract class MagicSitesAddSingleRequest implements Built<MagicSitesAddSingleRequest, MagicSitesAddSingleRequestBuilder> {
  ...
  MagicSitesAddSingleRequest._();

  factory MagicSitesAddSingleRequest([void updates(MagicSitesAddSingleRequestBuilder b)]) = _$MagicSitesAddSingleRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MagicSitesAddSingleRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MagicSitesAddSingleRequest> get serializer => _$MagicSitesAddSingleRequestSerializer();
}

class _$MagicSitesAddSingleRequestSerializer implements PrimitiveSerializer<MagicSitesAddSingleRequest> {
  @override
  final Iterable<Type> types = const [MagicSitesAddSingleRequest, _$MagicSitesAddSingleRequest];

  @override
  final String wireName = r'MagicSitesAddSingleRequest';
  ...
  void _deserializeProperties(
    ...
    required MagicSitesAddSingleRequestBuilder result,
  ...
  @override
  MagicSitesAddSingleRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MagicSitesAddSingleRequestBuilder();
