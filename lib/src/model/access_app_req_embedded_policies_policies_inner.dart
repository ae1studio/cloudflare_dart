...
part 'access_app_req_embedded_policies_policies_inner.g.dart';
...
abstract class AccessAppReqEmbeddedPoliciesPoliciesInner implements Built<AccessAppReqEmbeddedPoliciesPoliciesInner, AccessAppReqEmbeddedPoliciesPoliciesInnerBuilder> {
  ...
  factory AccessAppReqEmbeddedPoliciesPoliciesInner([void updates(AccessAppReqEmbeddedPoliciesPoliciesInnerBuilder b)]) = _$AccessAppReqEmbeddedPoliciesPoliciesInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AccessAppReqEmbeddedPoliciesPoliciesInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AccessAppReqEmbeddedPoliciesPoliciesInner> get serializer => _$AccessAppReqEmbeddedPoliciesPoliciesInnerSerializer();
}

class _$AccessAppReqEmbeddedPoliciesPoliciesInnerSerializer implements PrimitiveSerializer<AccessAppReqEmbeddedPoliciesPoliciesInner> {
  @override
  final Iterable<Type> types = const [AccessAppReqEmbeddedPoliciesPoliciesInner, _$AccessAppReqEmbeddedPoliciesPoliciesInner];

  @override
  final String wireName = r'AccessAppReqEmbeddedPoliciesPoliciesInner';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccessAppReqEmbeddedPoliciesPoliciesInner object, {
  ...
  @override
  AccessAppReqEmbeddedPoliciesPoliciesInner deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
