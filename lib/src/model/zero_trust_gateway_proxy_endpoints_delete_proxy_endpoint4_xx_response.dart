...
class ZeroTrustGatewayProxyEndpointsDeleteProxyEndpoint4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<ZeroTrustGatewayProxyEndpointsDeleteProxyEndpoint4XXResponseResultEnum> get serializer => _$zeroTrustGatewayProxyEndpointsDeleteProxyEndpoint4XXResponseResultSerializer;

  const ZeroTrustGatewayProxyEndpointsDeleteProxyEndpoint4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<ZeroTrustGatewayProxyEndpointsDeleteProxyEndpoint4XXResponseResultEnum> get values => _$zeroTrustGatewayProxyEndpointsDeleteProxyEndpoint4XXResponseResultValues;
  static ZeroTrustGatewayProxyEndpointsDeleteProxyEndpoint4XXResponseResultEnum valueOf(String name) => _$zeroTrustGatewayProxyEndpointsDeleteProxyEndpoint4XXResponseResultValueOf(name);
}
