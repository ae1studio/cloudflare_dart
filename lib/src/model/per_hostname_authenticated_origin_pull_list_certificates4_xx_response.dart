...
class PerHostnameAuthenticatedOriginPullListCertificates4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<PerHostnameAuthenticatedOriginPullListCertificates4XXResponseResultEnum> get serializer => _$perHostnameAuthenticatedOriginPullListCertificates4XXResponseResultSerializer;

  const PerHostnameAuthenticatedOriginPullListCertificates4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<PerHostnameAuthenticatedOriginPullListCertificates4XXResponseResultEnum> get values => _$perHostnameAuthenticatedOriginPullListCertificates4XXResponseResultValues;
  static PerHostnameAuthenticatedOriginPullListCertificates4XXResponseResultEnum valueOf(String name) => _$perHostnameAuthenticatedOriginPullListCertificates4XXResponseResultValueOf(name);
}
