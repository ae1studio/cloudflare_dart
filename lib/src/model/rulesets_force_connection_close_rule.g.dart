...
part of 'rulesets_force_connection_close_rule.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const RulesetsForceConnectionCloseRuleActionEnum
    _$rulesetsForceConnectionCloseRuleActionEnum_forceConnectionClose =
    const RulesetsForceConnectionCloseRuleActionEnum._('forceConnectionClose');

RulesetsForceConnectionCloseRuleActionEnum
    _$rulesetsForceConnectionCloseRuleActionEnumValueOf(String name) {
  switch (name) {
    case 'forceConnectionClose':
      return _$rulesetsForceConnectionCloseRuleActionEnum_forceConnectionClose;
    default:
      throw ArgumentError(name);
  }
}

final BuiltSet<RulesetsForceConnectionCloseRuleActionEnum>
    _$rulesetsForceConnectionCloseRuleActionEnumValues = BuiltSet<
        RulesetsForceConnectionCloseRuleActionEnum>(const <RulesetsForceConnectionCloseRuleActionEnum>[
  _$rulesetsForceConnectionCloseRuleActionEnum_forceConnectionClose,
]);

Serializer<RulesetsForceConnectionCloseRuleActionEnum>
    _$rulesetsForceConnectionCloseRuleActionEnumSerializer =
    _$RulesetsForceConnectionCloseRuleActionEnumSerializer();

class _$RulesetsForceConnectionCloseRuleActionEnumSerializer
    implements PrimitiveSerializer<RulesetsForceConnectionCloseRuleActionEnum> {
  ...
  @override
  final String wireName = 'RulesetsForceConnectionCloseRuleActionEnum';

  @override
  Object serialize(Serializers serializers,
          RulesetsForceConnectionCloseRuleActionEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  RulesetsForceConnectionCloseRuleActionEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      RulesetsForceConnectionCloseRuleActionEnum.valueOf(
...
class _$RulesetsForceConnectionCloseRule
  ...
  @override
  RulesetsForceConnectionCloseRuleBuilder toBuilder() =>
      RulesetsForceConnectionCloseRuleBuilder()..replace(this);
...
class RulesetsForceConnectionCloseRuleBuilder
    implements
        Builder<RulesetsForceConnectionCloseRule,
  ...
  @override
  void replace(covariant RulesetsForceConnectionCloseRule other) {
    _$v = other as _$RulesetsForceConnectionCloseRule;
  }

  @override
  void update(void Function(RulesetsForceConnectionCloseRuleBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RulesetsForceConnectionCloseRule build() => _build();

  _$RulesetsForceConnectionCloseRule _build() {
    _$RulesetsForceConnectionCloseRule _$result;
    try {
      _$result = _$v ??
          _$RulesetsForceConnectionCloseRule._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'RulesetsForceConnectionCloseRule', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
