...
class CloudflareTunnelCleanUpCloudflareTunnelConnections4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<CloudflareTunnelCleanUpCloudflareTunnelConnections4XXResponseResultEnum> get serializer => _$cloudflareTunnelCleanUpCloudflareTunnelConnections4XXResponseResultEnumSerializer;

  const CloudflareTunnelCleanUpCloudflareTunnelConnections4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<CloudflareTunnelCleanUpCloudflareTunnelConnections4XXResponseResultEnum> get values => _$cloudflareTunnelCleanUpCloudflareTunnelConnections4XXResponseResultEnumValues;
  static CloudflareTunnelCleanUpCloudflareTunnelConnections4XXResponseResultEnum valueOf(String name) => _$cloudflareTunnelCleanUpCloudflareTunnelConnections4XXResponseResultEnumValueOf(name);
}
