...
part 'dns_settings_dns_settings_account_patch.g.dart';
...
/// * [nameservers] 
@BuiltValue()
abstract class DnsSettingsDnsSettingsAccountPatch implements DnsSettingsDnsSettingsPatch, Built<DnsSettingsDnsSettingsAccountPatch, DnsSettingsDnsSettingsAccountPatchBuilder> {
  @BuiltValueField(wireName: r'nameservers')
  DnsSettingsDnsSettingsAccountPatchAllOfNameservers? get nameservers;

  DnsSettingsDnsSettingsAccountPatch._();

  factory DnsSettingsDnsSettingsAccountPatch([void updates(DnsSettingsDnsSettingsAccountPatchBuilder b)]) = _$DnsSettingsDnsSettingsAccountPatch;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DnsSettingsDnsSettingsAccountPatchBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DnsSettingsDnsSettingsAccountPatch> get serializer => _$DnsSettingsDnsSettingsAccountPatchSerializer();
}

class _$DnsSettingsDnsSettingsAccountPatchSerializer implements PrimitiveSerializer<DnsSettingsDnsSettingsAccountPatch> {
  @override
  final Iterable<Type> types = const [DnsSettingsDnsSettingsAccountPatch, _$DnsSettingsDnsSettingsAccountPatch];

  @override
  final String wireName = r'DnsSettingsDnsSettingsAccountPatch';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    DnsSettingsDnsSettingsAccountPatch object, {
    ...
    if (object.nameservers != null) {
      ...
      yield serializers.serialize(
        object.nameservers,
        specifiedType: const FullType(DnsSettingsDnsSettingsAccountPatchAllOfNameservers),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required DnsSettingsDnsSettingsAccountPatchBuilder result,
      ...
      switch (key) {
        ...
        case r'nameservers':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(DnsSettingsDnsSettingsAccountPatchAllOfNameservers),
          ) as DnsSettingsDnsSettingsAccountPatchAllOfNameservers;
  ...
  @override
  DnsSettingsDnsSettingsAccountPatch deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DnsSettingsDnsSettingsAccountPatchBuilder();
