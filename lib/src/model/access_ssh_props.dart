...
abstract class AccessSshProps implements AccessSelfHostedProps {
  @BuiltValueSerializer(custom: true)
  static Serializer<AccessSshProps> get serializer => _$AccessSshPropsSerializer();
}

class _$AccessSshPropsSerializer implements PrimitiveSerializer<AccessSshProps> {
  @override
  final Iterable<Type> types = const [AccessSshProps];

  @override
  final String wireName = r'AccessSshProps';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccessSshProps object, {
  ...
  @override
  AccessSshProps deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized, specifiedType: FullType($AccessSshProps)) as $AccessSshProps;
  }
}

/// a concrete implementation of [AccessSshProps], since [AccessSshProps] is not instantiable
@BuiltValue(instantiable: true)
abstract class $AccessSshProps implements AccessSshProps, Built<$AccessSshProps, $AccessSshPropsBuilder> {
  $AccessSshProps._();

  factory $AccessSshProps([void Function($AccessSshPropsBuilder)? updates]) = _$$AccessSshProps;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($AccessSshPropsBuilder b) => b;
...
class _$$AccessSshPropsSerializer implements PrimitiveSerializer<$AccessSshProps> {
  @override
  final Iterable<Type> types = const [$AccessSshProps, _$$AccessSshProps];
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(AccessSshProps))!;
  }
  ...
  void _deserializeProperties(
    ...
    required AccessSshPropsBuilder result,
  ...
  $AccessSshProps deserialize(
    ...
    final result = $AccessSshPropsBuilder();
