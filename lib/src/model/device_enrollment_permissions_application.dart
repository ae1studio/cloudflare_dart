...
part 'device_enrollment_permissions_application.g.dart';
...
@BuiltValue()
abstract class DeviceEnrollmentPermissionsApplication implements AccessAppReqEmbeddedPolicies, AccessWarpProps, Built<DeviceEnrollmentPermissionsApplication, DeviceEnrollmentPermissionsApplicationBuilder> {
  DeviceEnrollmentPermissionsApplication._();

  factory DeviceEnrollmentPermissionsApplication([void updates(DeviceEnrollmentPermissionsApplicationBuilder b)]) = _$DeviceEnrollmentPermissionsApplication;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DeviceEnrollmentPermissionsApplicationBuilder b) => b
      ..autoRedirectToIdentity = false
      ..name = Warp Login App
      ..sessionDuration = '24h';

  @BuiltValueSerializer(custom: true)
  static Serializer<DeviceEnrollmentPermissionsApplication> get serializer => _$DeviceEnrollmentPermissionsApplicationSerializer();
}

class _$DeviceEnrollmentPermissionsApplicationSerializer implements PrimitiveSerializer<DeviceEnrollmentPermissionsApplication> {
  @override
  final Iterable<Type> types = const [DeviceEnrollmentPermissionsApplication, _$DeviceEnrollmentPermissionsApplication];

  @override
  final String wireName = r'DeviceEnrollmentPermissionsApplication';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    DeviceEnrollmentPermissionsApplication object, {
  ...
  void _deserializeProperties(
    ...
    required DeviceEnrollmentPermissionsApplicationBuilder result,
  ...
  @override
  DeviceEnrollmentPermissionsApplication deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DeviceEnrollmentPermissionsApplicationBuilder();
