...
part 'browser_vnc_application1.g.dart';
...
/// * [policies] 
@BuiltValue()
abstract class BrowserVNCApplication1 implements AccessAppRespEmbeddedPolicies, AccessBasicAppResponseProps, AccessVncProps, Built<BrowserVNCApplication1, BrowserVNCApplication1Builder> {
  BrowserVNCApplication1._();

  factory BrowserVNCApplication1([void updates(BrowserVNCApplication1Builder b)]) = _$BrowserVNCApplication1;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BrowserVNCApplication1Builder b) => b
  ...
  static Serializer<BrowserVNCApplication1> get serializer => _$BrowserVNCApplication1Serializer();
}

class _$BrowserVNCApplication1Serializer implements PrimitiveSerializer<BrowserVNCApplication1> {
  @override
  final Iterable<Type> types = const [BrowserVNCApplication1, _$BrowserVNCApplication1];

  @override
  final String wireName = r'BrowserVNCApplication1';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BrowserVNCApplication1 object, {
  ...
  void _deserializeProperties(
    ...
    required BrowserVNCApplication1Builder result,
  ...
  @override
  BrowserVNCApplication1 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BrowserVNCApplication1Builder();
