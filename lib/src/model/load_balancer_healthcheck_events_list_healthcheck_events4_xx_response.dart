...
class LoadBalancerHealthcheckEventsListHealthcheckEvents4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<LoadBalancerHealthcheckEventsListHealthcheckEvents4XXResponseResultEnum> get serializer => _$loadBalancerHealthcheckEventsListHealthcheckEvents4XXResponseResultSerializer;

  const LoadBalancerHealthcheckEventsListHealthcheckEvents4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<LoadBalancerHealthcheckEventsListHealthcheckEvents4XXResponseResultEnum> get values => _$loadBalancerHealthcheckEventsListHealthcheckEvents4XXResponseResultValues;
  static LoadBalancerHealthcheckEventsListHealthcheckEvents4XXResponseResultEnum valueOf(String name) => _$loadBalancerHealthcheckEventsListHealthcheckEvents4XXResponseResultValueOf(name);
}
