...
class ZeroTrustAccountsGetZeroTrustCertificateConfiguration4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<ZeroTrustAccountsGetZeroTrustCertificateConfiguration4XXResponseResultEnum> get serializer => _$zeroTrustAccountsGetZeroTrustCertificateConfiguration4XXResponseResultSerializer;

  const ZeroTrustAccountsGetZeroTrustCertificateConfiguration4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<ZeroTrustAccountsGetZeroTrustCertificateConfiguration4XXResponseResultEnum> get values => _$zeroTrustAccountsGetZeroTrustCertificateConfiguration4XXResponseResultValues;
  static ZeroTrustAccountsGetZeroTrustCertificateConfiguration4XXResponseResultEnum valueOf(String name) => _$zeroTrustAccountsGetZeroTrustCertificateConfiguration4XXResponseResultValueOf(name);
}
