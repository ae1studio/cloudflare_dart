...
part of 'pages_project_object_latest_deployment.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const PagesProjectObjectLatestDeploymentEnvironmentEnum
    _$pagesProjectObjectLatestDeploymentEnvironmentEnum_preview =
    const PagesProjectObjectLatestDeploymentEnvironmentEnum._('preview');
const PagesProjectObjectLatestDeploymentEnvironmentEnum
    _$pagesProjectObjectLatestDeploymentEnvironmentEnum_production =
    const PagesProjectObjectLatestDeploymentEnvironmentEnum._('production');

PagesProjectObjectLatestDeploymentEnvironmentEnum
    _$pagesProjectObjectLatestDeploymentEnvironmentEnumValueOf(String name) {
  switch (name) {
    case 'preview':
      return _$pagesProjectObjectLatestDeploymentEnvironmentEnum_preview;
    case 'production':
      return _$pagesProjectObjectLatestDeploymentEnvironmentEnum_production;
    default:
      throw ArgumentError(name);
  }
}

final BuiltSet<PagesProjectObjectLatestDeploymentEnvironmentEnum>
    _$pagesProjectObjectLatestDeploymentEnvironmentEnumValues = BuiltSet<
        PagesProjectObjectLatestDeploymentEnvironmentEnum>(const <PagesProjectObjectLatestDeploymentEnvironmentEnum>[
  _$pagesProjectObjectLatestDeploymentEnvironmentEnum_preview,
  _$pagesProjectObjectLatestDeploymentEnvironmentEnum_production,
]);

Serializer<PagesProjectObjectLatestDeploymentEnvironmentEnum>
    _$pagesProjectObjectLatestDeploymentEnvironmentEnumSerializer =
    _$PagesProjectObjectLatestDeploymentEnvironmentEnumSerializer();

class _$PagesProjectObjectLatestDeploymentEnvironmentEnumSerializer
    implements
        PrimitiveSerializer<PagesProjectObjectLatestDeploymentEnvironmentEnum> {
  ...
  @override
  final String wireName = 'PagesProjectObjectLatestDeploymentEnvironmentEnum';

  @override
  Object serialize(Serializers serializers,
          PagesProjectObjectLatestDeploymentEnvironmentEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  PagesProjectObjectLatestDeploymentEnvironmentEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      PagesProjectObjectLatestDeploymentEnvironmentEnum.valueOf(
          _fromWire[serialized] ?? (serialized is String ? serialized : ''));
}

class _$PagesProjectObjectLatestDeployment
    extends PagesProjectObjectLatestDeployment {
  @override
  ...
  factory _$PagesProjectObjectLatestDeployment(
          [void Function(PagesProjectObjectLatestDeploymentBuilder)?
              updates]) =>
      (PagesProjectObjectLatestDeploymentBuilder()..update(updates))._build();

  _$PagesProjectObjectLatestDeployment._(
      {this.aliases,
      this.buildConfig,
      this.createdOn,
      ...
      : super._();
  @override
  PagesProjectObjectLatestDeployment rebuild(
          void Function(PagesProjectObjectLatestDeploymentBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PagesProjectObjectLatestDeploymentBuilder toBuilder() =>
      PagesProjectObjectLatestDeploymentBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PagesProjectObjectLatestDeployment &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PagesProjectObjectLatestDeployment')
          ..add('aliases', aliases)
...
class PagesProjectObjectLatestDeploymentBuilder
    implements
        Builder<PagesProjectObjectLatestDeployment,
            PagesProjectObjectLatestDeploymentBuilder>,
        PagesDeploymentsBuilder {
  _$PagesProjectObjectLatestDeployment? _$v;
  ...
  PagesProjectObjectLatestDeploymentBuilder() {
    PagesProjectObjectLatestDeployment._defaults(this);
  }

  PagesProjectObjectLatestDeploymentBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant PagesProjectObjectLatestDeployment other) {
    _$v = other as _$PagesProjectObjectLatestDeployment;
  }
  ...
  @override
  PagesProjectObjectLatestDeployment build() => _build();

  _$PagesProjectObjectLatestDeployment _build() {
    _$PagesProjectObjectLatestDeployment _$result;
    try {
      _$result = _$v ??
          _$PagesProjectObjectLatestDeployment._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'PagesProjectObjectLatestDeployment', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
