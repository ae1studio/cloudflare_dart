...
part 'zones_min_tls_version.g.dart';
...
/// * [value] 
@BuiltValue()
abstract class ZonesMinTlsVersion implements ZonesBase, Built<ZonesMinTlsVersion, ZonesMinTlsVersionBuilder> {
  ZonesMinTlsVersion._();

  factory ZonesMinTlsVersion([void updates(ZonesMinTlsVersionBuilder b)]) = _$ZonesMinTlsVersion;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ZonesMinTlsVersionBuilder b) => b
      ..editable = true;

  @BuiltValueSerializer(custom: true)
  static Serializer<ZonesMinTlsVersion> get serializer => _$ZonesMinTlsVersionSerializer();
}

class _$ZonesMinTlsVersionSerializer implements PrimitiveSerializer<ZonesMinTlsVersion> {
  @override
  final Iterable<Type> types = const [ZonesMinTlsVersion, _$ZonesMinTlsVersion];

  @override
  final String wireName = r'ZonesMinTlsVersion';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ZonesMinTlsVersion object, {
  ...
  void _deserializeProperties(
    ...
    required ZonesMinTlsVersionBuilder result,
  ...
  @override
  ZonesMinTlsVersion deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ZonesMinTlsVersionBuilder();
...
class ZonesMinTlsVersionIdEnum extends EnumClass {
