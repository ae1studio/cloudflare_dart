...
class AccountLoadBalancerMonitorGroupsListMonitorGroupReferences4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<AccountLoadBalancerMonitorGroupsListMonitorGroupReferences4XXResponseResultEnum> get serializer => _$accountLoadBalancerMonitorGroupsListMonitorGroupReferences4XXResponseResultSerializer;

  const AccountLoadBalancerMonitorGroupsListMonitorGroupReferences4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<AccountLoadBalancerMonitorGroupsListMonitorGroupReferences4XXResponseResultEnum> get values => _$accountLoadBalancerMonitorGroupsListMonitorGroupReferences4XXResponseResultValues;
  static AccountLoadBalancerMonitorGroupsListMonitorGroupReferences4XXResponseResultEnum valueOf(String name) => _$accountLoadBalancerMonitorGroupsListMonitorGroupReferences4XXResponseResultValueOf(name);
}
