...
class SchemaValidationUpdateSettingsRequestValidationDefaultMitigationActionEnum extends EnumClass {
  ...
  static Serializer<SchemaValidationUpdateSettingsRequestValidationDefaultMitigationActionEnum> get serializer => _$schemaValidationUpdateSettingsRequestValidationDefaultMitigationActionSerializer;

  const SchemaValidationUpdateSettingsRequestValidationDefaultMitigationActionEnum._(String name): super(name);

  static BuiltSet<SchemaValidationUpdateSettingsRequestValidationDefaultMitigationActionEnum> get values => _$schemaValidationUpdateSettingsRequestValidationDefaultMitigationActionValues;
  static SchemaValidationUpdateSettingsRequestValidationDefaultMitigationActionEnum valueOf(String name) => _$schemaValidationUpdateSettingsRequestValidationDefaultMitigationActionValueOf(name);
}
...
class SchemaValidationUpdateSettingsRequestValidationOverrideMitigationActionEnum extends EnumClass {
  ...
  static Serializer<SchemaValidationUpdateSettingsRequestValidationOverrideMitigationActionEnum> get serializer => _$schemaValidationUpdateSettingsRequestValidationOverrideMitigationActionSerializer;

  const SchemaValidationUpdateSettingsRequestValidationOverrideMitigationActionEnum._(String name): super(name);

  static BuiltSet<SchemaValidationUpdateSettingsRequestValidationOverrideMitigationActionEnum> get values => _$schemaValidationUpdateSettingsRequestValidationOverrideMitigationActionValues;
  static SchemaValidationUpdateSettingsRequestValidationOverrideMitigationActionEnum valueOf(String name) => _$schemaValidationUpdateSettingsRequestValidationOverrideMitigationActionValueOf(name);
}
