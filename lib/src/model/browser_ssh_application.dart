...
part 'browser_ssh_application.g.dart';
...
@BuiltValue()
abstract class BrowserSSHApplication implements AccessAppReqEmbeddedPolicies, AccessAppReqEmbeddedScimConfig, AccessSshProps, Built<BrowserSSHApplication, BrowserSSHApplicationBuilder> {
  BrowserSSHApplication._();

  factory BrowserSSHApplication([void updates(BrowserSSHApplicationBuilder b)]) = _$BrowserSSHApplication;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BrowserSSHApplicationBuilder b) => b
  ...
  static Serializer<BrowserSSHApplication> get serializer => _$BrowserSSHApplicationSerializer();
}

class _$BrowserSSHApplicationSerializer implements PrimitiveSerializer<BrowserSSHApplication> {
  @override
  final Iterable<Type> types = const [BrowserSSHApplication, _$BrowserSSHApplication];

  @override
  final String wireName = r'BrowserSSHApplication';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BrowserSSHApplication object, {
  ...
  void _deserializeProperties(
    ...
    required BrowserSSHApplicationBuilder result,
  ...
  @override
  BrowserSSHApplication deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BrowserSSHApplicationBuilder();
