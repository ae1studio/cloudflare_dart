...
class PerHostnameAuthenticatedOriginPullUploadAHostnameClientCertificate4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<PerHostnameAuthenticatedOriginPullUploadAHostnameClientCertificate4XXResponseResultEnum> get serializer => _$perHostnameAuthenticatedOriginPullUploadAHostnameClientCertificate4XXResponseResultSerializer;

  const PerHostnameAuthenticatedOriginPullUploadAHostnameClientCertificate4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<PerHostnameAuthenticatedOriginPullUploadAHostnameClientCertificate4XXResponseResultEnum> get values => _$perHostnameAuthenticatedOriginPullUploadAHostnameClientCertificate4XXResponseResultValues;
  static PerHostnameAuthenticatedOriginPullUploadAHostnameClientCertificate4XXResponseResultEnum valueOf(String name) => _$perHostnameAuthenticatedOriginPullUploadAHostnameClientCertificate4XXResponseResultValueOf(name);
}
