...
part of 'dns_settings_dns_settings_zone_patch.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DnsSettingsDnsSettingsZonePatch
    extends DnsSettingsDnsSettingsZonePatch {
  @override
  final DnsSettingsDnsSettingsZonePatchAllOfNameservers? nameservers;
  @override
  ...
  factory _$DnsSettingsDnsSettingsZonePatch(
          [void Function(DnsSettingsDnsSettingsZonePatchBuilder)? updates]) =>
      (DnsSettingsDnsSettingsZonePatchBuilder()..update(updates))._build();

  _$DnsSettingsDnsSettingsZonePatch._(
      {this.nameservers,
      ...
      : super._();
  @override
  DnsSettingsDnsSettingsZonePatch rebuild(
          void Function(DnsSettingsDnsSettingsZonePatchBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  DnsSettingsDnsSettingsZonePatchBuilder toBuilder() =>
      DnsSettingsDnsSettingsZonePatchBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DnsSettingsDnsSettingsZonePatch &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DnsSettingsDnsSettingsZonePatch')
...
class DnsSettingsDnsSettingsZonePatchBuilder
    implements
        Builder<DnsSettingsDnsSettingsZonePatch,
            DnsSettingsDnsSettingsZonePatchBuilder>,
        DnsSettingsDnsSettingsPatchBuilder {
  _$DnsSettingsDnsSettingsZonePatch? _$v;

  DnsSettingsDnsSettingsZonePatchAllOfNameserversBuilder? _nameservers;
  DnsSettingsDnsSettingsZonePatchAllOfNameserversBuilder get nameservers =>
      _$this._nameservers ??=
          DnsSettingsDnsSettingsZonePatchAllOfNameserversBuilder();
  set nameservers(
          covariant DnsSettingsDnsSettingsZonePatchAllOfNameserversBuilder?
              nameservers) =>
  ...
  DnsSettingsDnsSettingsZonePatchBuilder() {
    DnsSettingsDnsSettingsZonePatch._defaults(this);
  }

  DnsSettingsDnsSettingsZonePatchBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant DnsSettingsDnsSettingsZonePatch other) {
    _$v = other as _$DnsSettingsDnsSettingsZonePatch;
  }

  @override
  void update(void Function(DnsSettingsDnsSettingsZonePatchBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  DnsSettingsDnsSettingsZonePatch build() => _build();

  _$DnsSettingsDnsSettingsZonePatch _build() {
    _$DnsSettingsDnsSettingsZonePatch _$result;
    try {
      _$result = _$v ??
          _$DnsSettingsDnsSettingsZonePatch._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'DnsSettingsDnsSettingsZonePatch', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
