...
part 'access_self_hosted_props.g.dart';
...
abstract class AccessSelfHostedProps  {
  ...
  AccessCorsHeaders? get corsHeaders;
  ...
  @BuiltValueField(wireName: r'path_cookie_attribute')
  ...
  @BuiltValueField(wireName: r'read_service_tokens_from_header')
  ...
  @Deprecated('selfHostedDomains has been deprecated')
  @BuiltValueField(wireName: r'self_hosted_domains')
  BuiltList<String>? get selfHostedDomains;
...
class _$AccessSelfHostedPropsSerializer implements PrimitiveSerializer<AccessSelfHostedProps> {
  @override
  final Iterable<Type> types = const [AccessSelfHostedProps];

  @override
  final String wireName = r'AccessSelfHostedProps';
  ...
  @override
  AccessSelfHostedProps deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized, specifiedType: FullType($AccessSelfHostedProps)) as $AccessSelfHostedProps;
  }
}

/// a concrete implementation of [AccessSelfHostedProps], since [AccessSelfHostedProps] is not instantiable
@BuiltValue(instantiable: true)
abstract class $AccessSelfHostedProps implements AccessSelfHostedProps, Built<$AccessSelfHostedProps, $AccessSelfHostedPropsBuilder> {
  $AccessSelfHostedProps._();

  factory $AccessSelfHostedProps([void Function($AccessSelfHostedPropsBuilder)? updates]) = _$$AccessSelfHostedProps;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($AccessSelfHostedPropsBuilder b) => b;
...
class _$$AccessSelfHostedPropsSerializer implements PrimitiveSerializer<$AccessSelfHostedProps> {
  @override
  final Iterable<Type> types = const [$AccessSelfHostedProps, _$$AccessSelfHostedProps];
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(AccessSelfHostedProps))!;
  }
  ...
  void _deserializeProperties(
    ...
    required AccessSelfHostedPropsBuilder result,
  ...
  $AccessSelfHostedProps deserialize(
    ...
    final result = $AccessSelfHostedPropsBuilder();
