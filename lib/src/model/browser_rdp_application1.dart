...
part 'browser_rdp_application1.g.dart';
...
abstract class BrowserRDPApplication1 implements AccessAppRespEmbeddedPolicies, AccessBasicAppResponseProps, AccessRdpProps, Built<BrowserRDPApplication1, BrowserRDPApplication1Builder> {
  BrowserRDPApplication1._();

  factory BrowserRDPApplication1([void updates(BrowserRDPApplication1Builder b)]) = _$BrowserRDPApplication1;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BrowserRDPApplication1Builder b) => b
  ...
  static Serializer<BrowserRDPApplication1> get serializer => _$BrowserRDPApplication1Serializer();
}

class _$BrowserRDPApplication1Serializer implements PrimitiveSerializer<BrowserRDPApplication1> {
  @override
  final Iterable<Type> types = const [BrowserRDPApplication1, _$BrowserRDPApplication1];

  @override
  final String wireName = r'BrowserRDPApplication1';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BrowserRDPApplication1 object, {
  ...
  void _deserializeProperties(
    ...
    required BrowserRDPApplication1Builder result,
  ...
  @override
  BrowserRDPApplication1 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BrowserRDPApplication1Builder();
