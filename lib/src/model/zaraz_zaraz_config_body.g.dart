...
part of 'zaraz_zaraz_config_body.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ZarazZarazConfigBody extends ZarazZarazConfigBody {
  @override
  ...
  factory _$ZarazZarazConfigBody(
      ...
      (ZarazZarazConfigBodyBuilder()..update(updates))._build();
  ...
  @override
  ZarazZarazConfigBodyBuilder toBuilder() =>
      ZarazZarazConfigBodyBuilder()..replace(this);
...
class ZarazZarazConfigBodyBuilder
    implements
        Builder<ZarazZarazConfigBody, ZarazZarazConfigBodyBuilder>,
        ZarazZarazConfigBaseBuilder {
  _$ZarazZarazConfigBody? _$v;

  MapBuilder<String, ZarazZarazConfigBodyAllOfTools>? _tools;
  MapBuilder<String, ZarazZarazConfigBodyAllOfTools> get tools =>
      _$this._tools ??= MapBuilder<String, ZarazZarazConfigBodyAllOfTools>();
  set tools(
          covariant MapBuilder<String, ZarazZarazConfigBodyAllOfTools>?
              tools) =>
      _$this._tools = tools;
  ...
  ZarazZarazConfigBodyBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant ZarazZarazConfigBody other) {
    _$v = other as _$ZarazZarazConfigBody;
  }

  @override
  void update(void Function(ZarazZarazConfigBodyBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ZarazZarazConfigBody build() => _build();

  _$ZarazZarazConfigBody _build() {
    _$ZarazZarazConfigBody _$result;
    try {
      _$result = _$v ??
          _$ZarazZarazConfigBody._(
            tools: tools.build(),
