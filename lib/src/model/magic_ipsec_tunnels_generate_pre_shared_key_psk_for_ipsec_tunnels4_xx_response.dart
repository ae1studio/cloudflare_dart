...
class MagicIpsecTunnelsGeneratePreSharedKeyPskForIpsecTunnels4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<MagicIpsecTunnelsGeneratePreSharedKeyPskForIpsecTunnels4XXResponseResultEnum> get serializer => _$magicIpsecTunnelsGeneratePreSharedKeyPskForIpsecTunnels4XXResponseResultSerializer;

  const MagicIpsecTunnelsGeneratePreSharedKeyPskForIpsecTunnels4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<MagicIpsecTunnelsGeneratePreSharedKeyPskForIpsecTunnels4XXResponseResultEnum> get values => _$magicIpsecTunnelsGeneratePreSharedKeyPskForIpsecTunnels4XXResponseResultValues;
  static MagicIpsecTunnelsGeneratePreSharedKeyPskForIpsecTunnels4XXResponseResultEnum valueOf(String name) => _$magicIpsecTunnelsGeneratePreSharedKeyPskForIpsecTunnels4XXResponseResultValueOf(name);
}
