...
class AccessIdentityProvidersComponentsSchemasResponseCollectionAllOfResultTypeEnum extends EnumClass {
  ...
  static Serializer<AccessIdentityProvidersComponentsSchemasResponseCollectionAllOfResultTypeEnum> get serializer => _$accessIdentityProvidersComponentsSchemasResponseCollectionAllOfResultTypeSerializer;

  const AccessIdentityProvidersComponentsSchemasResponseCollectionAllOfResultTypeEnum._(String name): super(name);

  static BuiltSet<AccessIdentityProvidersComponentsSchemasResponseCollectionAllOfResultTypeEnum> get values => _$accessIdentityProvidersComponentsSchemasResponseCollectionAllOfResultTypeValues;
  static AccessIdentityProvidersComponentsSchemasResponseCollectionAllOfResultTypeEnum valueOf(String name) => _$accessIdentityProvidersComponentsSchemasResponseCollectionAllOfResultTypeValueOf(name);
}
