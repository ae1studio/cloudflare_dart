...
part 'rulesets_set_cache_settings_rule.g.dart';
...
@BuiltValue()
abstract class RulesetsSetCacheSettingsRule implements RulesetsRule, Built<RulesetsSetCacheSettingsRule, RulesetsSetCacheSettingsRuleBuilder> {
  RulesetsSetCacheSettingsRule._();

  factory RulesetsSetCacheSettingsRule([void updates(RulesetsSetCacheSettingsRuleBuilder b)]) = _$RulesetsSetCacheSettingsRule;
  ...
  static Serializer<RulesetsSetCacheSettingsRule> get serializer => _$RulesetsSetCacheSettingsRuleSerializer();
}

class _$RulesetsSetCacheSettingsRuleSerializer implements PrimitiveSerializer<RulesetsSetCacheSettingsRule> {
  @override
  final Iterable<Type> types = const [RulesetsSetCacheSettingsRule, _$RulesetsSetCacheSettingsRule];

  @override
  final String wireName = r'RulesetsSetCacheSettingsRule';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RulesetsSetCacheSettingsRule object, {
  ...
  void _deserializeProperties(
    ...
    required RulesetsSetCacheSettingsRuleBuilder result,
  ...
  @override
  RulesetsSetCacheSettingsRule deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RulesetsSetCacheSettingsRuleBuilder();
...
class RulesetsSetCacheSettingsRuleActionEnum extends EnumClass {
