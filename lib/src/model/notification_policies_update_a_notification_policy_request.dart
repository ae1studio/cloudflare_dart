...
part 'notification_policies_update_a_notification_policy_request.g.dart';
...
@BuiltValue()
abstract class NotificationPoliciesUpdateANotificationPolicyRequest implements Built<NotificationPoliciesUpdateANotificationPolicyRequest, NotificationPoliciesUpdateANotificationPolicyRequestBuilder> {
  ...
  NotificationPoliciesUpdateANotificationPolicyRequest._();

  factory NotificationPoliciesUpdateANotificationPolicyRequest([void updates(NotificationPoliciesUpdateANotificationPolicyRequestBuilder b)]) = _$NotificationPoliciesUpdateANotificationPolicyRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(NotificationPoliciesUpdateANotificationPolicyRequestBuilder b) => b
      ..enabled = true;

  @BuiltValueSerializer(custom: true)
  static Serializer<NotificationPoliciesUpdateANotificationPolicyRequest> get serializer => _$NotificationPoliciesUpdateANotificationPolicyRequestSerializer();
}

class _$NotificationPoliciesUpdateANotificationPolicyRequestSerializer implements PrimitiveSerializer<NotificationPoliciesUpdateANotificationPolicyRequest> {
  @override
  final Iterable<Type> types = const [NotificationPoliciesUpdateANotificationPolicyRequest, _$NotificationPoliciesUpdateANotificationPolicyRequest];

  @override
  final String wireName = r'NotificationPoliciesUpdateANotificationPolicyRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    NotificationPoliciesUpdateANotificationPolicyRequest object, {
  ...
  void _deserializeProperties(
    ...
    required NotificationPoliciesUpdateANotificationPolicyRequestBuilder result,
  ...
  @override
  NotificationPoliciesUpdateANotificationPolicyRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = NotificationPoliciesUpdateANotificationPolicyRequestBuilder();
