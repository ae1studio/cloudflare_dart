...
part of 'messages1.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$Messages1 extends Messages1 {
  @override
  ...
  factory _$Messages1([void Function(Messages1Builder)? updates]) =>
      (Messages1Builder()..update(updates))._build();
  ...
  _$Messages1._(
      ...
      : super._();
  @override
  Messages1 rebuild(void Function(Messages1Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  Messages1Builder toBuilder() => Messages1Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is Messages1 &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Messages1')
...
class Messages1Builder implements Builder<Messages1, Messages1Builder> {
  _$Messages1? _$v;
  ...
  Messages1Builder() {
    Messages1._defaults(this);
  }

  Messages1Builder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(Messages1 other) {
    _$v = other as _$Messages1;
  }

  @override
  void update(void Function(Messages1Builder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  Messages1 build() => _build();

  _$Messages1 _build() {
    _$Messages1 _$result;
    try {
      _$result = _$v ??
          _$Messages1._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'Messages1', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
