...
part of 'zero_trust_organization_update_your_zero_trust_organization_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequest
    extends ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequest {
  @override
  ...
  factory _$ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequest(
          [void Function(
                  ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequestBuilder)?
              updates]) =>
      (ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequestBuilder()
            ..update(updates))
          ._build();

  _$ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequest._(
      ...
      : super._();
  @override
  ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequest rebuild(
          void Function(
                  ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequestBuilder)
              updates) =>
  ...
  bool operator ==(Object other) {
    ...
    return other
            is ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequest &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequest')
...
class ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequestBuilder
    implements
        Builder<ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequest,
            ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequestBuilder> {
  _$ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequest? _$v;
  ...
  ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequestBuilder() {
    ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequest._defaults(this);
  }
  ...
  @override
  void replace(
      ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequest other) {
    _$v =
        other as _$ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequest;
  }
  ...
  @override
  ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequest build() =>
      _build();

  _$ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequest _build() {
    _$ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequest _$result;
    try {
      _$result = _$v ??
          _$ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequest._(
