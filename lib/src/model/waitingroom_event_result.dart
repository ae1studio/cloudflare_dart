...
part 'waitingroom_event_result.g.dart';
...
/// * [turnstileMode] 
@BuiltValue()
abstract class WaitingroomEventResult implements Built<WaitingroomEventResult, WaitingroomEventResultBuilder> {
  ...
  WaitingroomEventResult._();

  factory WaitingroomEventResult([void updates(WaitingroomEventResultBuilder b)]) = _$WaitingroomEventResult;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(WaitingroomEventResultBuilder b) => b
      ..description = ''
      ..shuffleAtEventStart = false
      ..suspended = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<WaitingroomEventResult> get serializer => _$WaitingroomEventResultSerializer();
}

class _$WaitingroomEventResultSerializer implements PrimitiveSerializer<WaitingroomEventResult> {
  @override
  final Iterable<Type> types = const [WaitingroomEventResult, _$WaitingroomEventResult];

  @override
  final String wireName = r'WaitingroomEventResult';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    WaitingroomEventResult object, {
  ...
  void _deserializeProperties(
    ...
    required WaitingroomEventResultBuilder result,
  ...
  @override
  WaitingroomEventResult deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = WaitingroomEventResultBuilder();
