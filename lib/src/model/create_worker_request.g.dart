...
part of 'create_worker_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$CreateWorkerRequest extends CreateWorkerRequest {
  @override
  ...
  factory _$CreateWorkerRequest(
          [void Function(CreateWorkerRequestBuilder)? updates]) =>
      (CreateWorkerRequestBuilder()..update(updates))._build();

  _$CreateWorkerRequest._(
      ...
      : super._();
  @override
  CreateWorkerRequest rebuild(
          void Function(CreateWorkerRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  CreateWorkerRequestBuilder toBuilder() =>
      CreateWorkerRequestBuilder()..replace(this);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'CreateWorkerRequest')
...
class CreateWorkerRequestBuilder
    implements
        Builder<CreateWorkerRequest, CreateWorkerRequestBuilder>,
        WorkersWorkerBuilder {
  _$CreateWorkerRequest? _$v;
  ...
  CreateWorkerRequestBuilder() {
    CreateWorkerRequest._defaults(this);
  }

  CreateWorkerRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant CreateWorkerRequest other) {
    _$v = other as _$CreateWorkerRequest;
  }

  @override
  void update(void Function(CreateWorkerRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  CreateWorkerRequest build() => _build();

  _$CreateWorkerRequest _build() {
    _$CreateWorkerRequest _$result;
    try {
      _$result = _$v ??
          _$CreateWorkerRequest._(
            createdOn: BuiltValueNullFieldError.checkNotNull(
                createdOn, r'CreateWorkerRequest', 'createdOn'),
            id: BuiltValueNullFieldError.checkNotNull(
                id, r'CreateWorkerRequest', 'id'),
            logpush: BuiltValueNullFieldError.checkNotNull(
                logpush, r'CreateWorkerRequest', 'logpush'),
            name: BuiltValueNullFieldError.checkNotNull(
                name, r'CreateWorkerRequest', 'name'),
            ...
            updatedOn: BuiltValueNullFieldError.checkNotNull(
                updatedOn, r'CreateWorkerRequest', 'updatedOn'),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'CreateWorkerRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
