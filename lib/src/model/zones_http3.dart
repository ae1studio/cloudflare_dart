...
abstract class ZonesHttp3 implements ZonesBase, Built<ZonesHttp3, ZonesHttp3Builder> {
  ...
  factory ZonesHttp3([void updates(ZonesHttp3Builder b)]) = _$ZonesHttp3;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ZonesHttp3Builder b) => b
      ..editable = true;

  @BuiltValueSerializer(custom: true)
  static Serializer<ZonesHttp3> get serializer => _$ZonesHttp3Serializer();
}

class _$ZonesHttp3Serializer implements PrimitiveSerializer<ZonesHttp3> {
  @override
  final Iterable<Type> types = const [ZonesHttp3, _$ZonesHttp3];

  @override
  final String wireName = r'ZonesHttp3';
  ...
  void _deserializeProperties(
    ...
    required ZonesHttp3Builder result,
  ...
  @override
  ZonesHttp3 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ZonesHttp3Builder();
...
class ZonesHttp3IdEnum extends EnumClass {
