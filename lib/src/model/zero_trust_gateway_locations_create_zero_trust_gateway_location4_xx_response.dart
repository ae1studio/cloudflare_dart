...
class ZeroTrustGatewayLocationsCreateZeroTrustGatewayLocation4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<ZeroTrustGatewayLocationsCreateZeroTrustGatewayLocation4XXResponseResultEnum> get serializer => _$zeroTrustGatewayLocationsCreateZeroTrustGatewayLocation4XXResponseResultEnumSerializer;

  const ZeroTrustGatewayLocationsCreateZeroTrustGatewayLocation4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<ZeroTrustGatewayLocationsCreateZeroTrustGatewayLocation4XXResponseResultEnum> get values => _$zeroTrustGatewayLocationsCreateZeroTrustGatewayLocation4XXResponseResultEnumValues;
  static ZeroTrustGatewayLocationsCreateZeroTrustGatewayLocation4XXResponseResultEnum valueOf(String name) => _$zeroTrustGatewayLocationsCreateZeroTrustGatewayLocation4XXResponseResultEnumValueOf(name);
}
