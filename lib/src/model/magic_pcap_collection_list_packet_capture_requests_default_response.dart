...
class MagicPcapCollectionListPacketCaptureRequestsDefaultResponseResultEnum extends EnumClass {
  ...
  static Serializer<MagicPcapCollectionListPacketCaptureRequestsDefaultResponseResultEnum> get serializer => _$magicPcapCollectionListPacketCaptureRequestsDefaultResponseResultSerializer;

  const MagicPcapCollectionListPacketCaptureRequestsDefaultResponseResultEnum._(String name): super(name);

  static BuiltSet<MagicPcapCollectionListPacketCaptureRequestsDefaultResponseResultEnum> get values => _$magicPcapCollectionListPacketCaptureRequestsDefaultResponseResultValues;
  static MagicPcapCollectionListPacketCaptureRequestsDefaultResponseResultEnum valueOf(String name) => _$magicPcapCollectionListPacketCaptureRequestsDefaultResponseResultValueOf(name);
}
