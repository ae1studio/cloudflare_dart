...
part of 'rulesets_ddo_s_dynamic_rule.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const RulesetsDDoSDynamicRuleActionEnum
    _$rulesetsDDoSDynamicRuleActionEnum_ddosDynamic =
    const RulesetsDDoSDynamicRuleActionEnum._('ddosDynamic');

RulesetsDDoSDynamicRuleActionEnum _$rulesetsDDoSDynamicRuleActionEnumValueOf(
    String name) {
  switch (name) {
    case 'ddosDynamic':
      return _$rulesetsDDoSDynamicRuleActionEnum_ddosDynamic;
    default:
      throw ArgumentError(name);
  }
}

final BuiltSet<RulesetsDDoSDynamicRuleActionEnum>
    _$rulesetsDDoSDynamicRuleActionEnumValues = BuiltSet<
        RulesetsDDoSDynamicRuleActionEnum>(const <RulesetsDDoSDynamicRuleActionEnum>[
  _$rulesetsDDoSDynamicRuleActionEnum_ddosDynamic,
]);

Serializer<RulesetsDDoSDynamicRuleActionEnum>
    _$rulesetsDDoSDynamicRuleActionEnumSerializer =
    _$RulesetsDDoSDynamicRuleActionEnumSerializer();

class _$RulesetsDDoSDynamicRuleActionEnumSerializer
    implements PrimitiveSerializer<RulesetsDDoSDynamicRuleActionEnum> {
  ...
  @override
  final Iterable<Type> types = const <Type>[RulesetsDDoSDynamicRuleActionEnum];
  @override
  final String wireName = 'RulesetsDDoSDynamicRuleActionEnum';

  @override
  Object serialize(
          Serializers serializers, RulesetsDDoSDynamicRuleActionEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  RulesetsDDoSDynamicRuleActionEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      RulesetsDDoSDynamicRuleActionEnum.valueOf(
          _fromWire[serialized] ?? (serialized is String ? serialized : ''));
}

class _$RulesetsDDoSDynamicRule extends RulesetsDDoSDynamicRule {
  @override
  final String? action;
  @override
  ...
  factory _$RulesetsDDoSDynamicRule(
          [void Function(RulesetsDDoSDynamicRuleBuilder)? updates]) =>
      (RulesetsDDoSDynamicRuleBuilder()..update(updates))._build();

  _$RulesetsDDoSDynamicRule._(
      {this.action,
      ...
      : super._();
  @override
  RulesetsDDoSDynamicRule rebuild(
          void Function(RulesetsDDoSDynamicRuleBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RulesetsDDoSDynamicRuleBuilder toBuilder() =>
      RulesetsDDoSDynamicRuleBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RulesetsDDoSDynamicRule &&
        action == other.action &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RulesetsDDoSDynamicRule')
          ..add('action', action)
...
class RulesetsDDoSDynamicRuleBuilder
    implements
        Builder<RulesetsDDoSDynamicRule, RulesetsDDoSDynamicRuleBuilder>,
        RulesetsRuleBuilder {
  _$RulesetsDDoSDynamicRule? _$v;
  ...
  RulesetsDDoSDynamicRuleBuilder() {
    RulesetsDDoSDynamicRule._defaults(this);
  }

  RulesetsDDoSDynamicRuleBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _action = $v.action;
  ...
  @override
  void replace(covariant RulesetsDDoSDynamicRule other) {
    _$v = other as _$RulesetsDDoSDynamicRule;
  }

  @override
  void update(void Function(RulesetsDDoSDynamicRuleBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RulesetsDDoSDynamicRule build() => _build();

  _$RulesetsDDoSDynamicRule _build() {
    _$RulesetsDDoSDynamicRule _$result;
    try {
      _$result = _$v ??
          _$RulesetsDDoSDynamicRule._(
            action: action,
            ...
            lastUpdated: BuiltValueNullFieldError.checkNotNull(
                lastUpdated, r'RulesetsDDoSDynamicRule', 'lastUpdated'),
            logging: _logging?.build(),
            ratelimit: _ratelimit?.build(),
            ref: ref,
            version: BuiltValueNullFieldError.checkNotNull(
                version, r'RulesetsDDoSDynamicRule', 'version'),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'RulesetsDDoSDynamicRule', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
