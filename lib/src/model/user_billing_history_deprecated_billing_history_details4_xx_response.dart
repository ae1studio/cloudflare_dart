...
class UserBillingHistoryDeprecatedBillingHistoryDetails4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<UserBillingHistoryDeprecatedBillingHistoryDetails4XXResponseResultEnum> get serializer => _$userBillingHistoryDeprecatedBillingHistoryDetails4XXResponseResultEnumSerializer;

  const UserBillingHistoryDeprecatedBillingHistoryDetails4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<UserBillingHistoryDeprecatedBillingHistoryDetails4XXResponseResultEnum> get values => _$userBillingHistoryDeprecatedBillingHistoryDetails4XXResponseResultEnumValues;
  static UserBillingHistoryDeprecatedBillingHistoryDetails4XXResponseResultEnum valueOf(String name) => _$userBillingHistoryDeprecatedBillingHistoryDetails4XXResponseResultEnumValueOf(name);
}
