...
class SecondaryDnsPrimaryZoneDisableOutgoingZoneTransfers4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<SecondaryDnsPrimaryZoneDisableOutgoingZoneTransfers4XXResponseResultEnum> get serializer => _$secondaryDnsPrimaryZoneDisableOutgoingZoneTransfers4XXResponseResultEnumSerializer;

  const SecondaryDnsPrimaryZoneDisableOutgoingZoneTransfers4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<SecondaryDnsPrimaryZoneDisableOutgoingZoneTransfers4XXResponseResultEnum> get values => _$secondaryDnsPrimaryZoneDisableOutgoingZoneTransfers4XXResponseResultEnumValues;
  static SecondaryDnsPrimaryZoneDisableOutgoingZoneTransfers4XXResponseResultEnum valueOf(String name) => _$secondaryDnsPrimaryZoneDisableOutgoingZoneTransfers4XXResponseResultEnumValueOf(name);
}
