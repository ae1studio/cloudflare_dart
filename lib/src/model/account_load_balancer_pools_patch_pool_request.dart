...
part 'account_load_balancer_pools_patch_pool_request.g.dart';
...
abstract class AccountLoadBalancerPoolsPatchPoolRequest implements Built<AccountLoadBalancerPoolsPatchPoolRequest, AccountLoadBalancerPoolsPatchPoolRequestBuilder> {
  ...
  AccountLoadBalancerPoolsPatchPoolRequest._();

  factory AccountLoadBalancerPoolsPatchPoolRequest([void updates(AccountLoadBalancerPoolsPatchPoolRequestBuilder b)]) = _$AccountLoadBalancerPoolsPatchPoolRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AccountLoadBalancerPoolsPatchPoolRequestBuilder b) => b
      ..description = ''
      ..enabled = true
      ..minimumOrigins = 1
      ..notificationEmail = '';
  ...
  static Serializer<AccountLoadBalancerPoolsPatchPoolRequest> get serializer => _$AccountLoadBalancerPoolsPatchPoolRequestSerializer();
}

class _$AccountLoadBalancerPoolsPatchPoolRequestSerializer implements PrimitiveSerializer<AccountLoadBalancerPoolsPatchPoolRequest> {
  @override
  final Iterable<Type> types = const [AccountLoadBalancerPoolsPatchPoolRequest, _$AccountLoadBalancerPoolsPatchPoolRequest];

  @override
  final String wireName = r'AccountLoadBalancerPoolsPatchPoolRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccountLoadBalancerPoolsPatchPoolRequest object, {
  ...
  void _deserializeProperties(
    ...
    required AccountLoadBalancerPoolsPatchPoolRequestBuilder result,
  ...
  @override
  AccountLoadBalancerPoolsPatchPoolRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccountLoadBalancerPoolsPatchPoolRequestBuilder();
