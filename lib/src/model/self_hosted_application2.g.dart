...
part of 'self_hosted_application2.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$SelfHostedApplication2 extends SelfHostedApplication2 {
  @override
  final String? aud;
  @override
  ...
  factory _$SelfHostedApplication2(
          [void Function(SelfHostedApplication2Builder)? updates]) =>
      (SelfHostedApplication2Builder()..update(updates))._build();

  _$SelfHostedApplication2._(
      {this.aud,
      this.createdAt,
      this.id,
      this.scimConfig,
      ...
      : super._();
  @override
  SelfHostedApplication2 rebuild(
          void Function(SelfHostedApplication2Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SelfHostedApplication2Builder toBuilder() =>
      SelfHostedApplication2Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SelfHostedApplication2 &&
        aud == other.aud &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'SelfHostedApplication2')
          ..add('aud', aud)
...
class SelfHostedApplication2Builder
    implements
        Builder<SelfHostedApplication2, SelfHostedApplication2Builder>,
        AccessSchemasBasicAppResponsePropsBuilder,
        AccessSchemasSelfHostedPropsBuilder {
  _$SelfHostedApplication2? _$v;
  ...
  SelfHostedApplication2Builder() {
    SelfHostedApplication2._defaults(this);
  }

  SelfHostedApplication2Builder get _$this {
    final $v = _$v;
    if ($v != null) {
      _aud = $v.aud;
...
// ignore: override_on_non_overriding_method
  void replace(covariant SelfHostedApplication2 other) {
    _$v = other as _$SelfHostedApplication2;
  }

  @override
  void update(void Function(SelfHostedApplication2Builder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  SelfHostedApplication2 build() => _build();

  _$SelfHostedApplication2 _build() {
    _$SelfHostedApplication2 _$result;
    try {
      _$result = _$v ??
          _$SelfHostedApplication2._(
            aud: aud,
            ...
            domain: BuiltValueNullFieldError.checkNotNull(
                domain, r'SelfHostedApplication2', 'domain'),
            ...
            type: BuiltValueNullFieldError.checkNotNull(
                type, r'SelfHostedApplication2', 'type'),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'SelfHostedApplication2', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
