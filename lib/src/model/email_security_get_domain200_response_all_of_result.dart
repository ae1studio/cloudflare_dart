...
part 'email_security_get_domain200_response_all_of_result.g.dart';
...
/// * [transport] 
@BuiltValue()
abstract class EmailSecurityGetDomain200ResponseAllOfResult implements Built<EmailSecurityGetDomain200ResponseAllOfResult, EmailSecurityGetDomain200ResponseAllOfResultBuilder> {
  ...
  EmailSecurityGetDomain200ResponseAllOfResult._();

  factory EmailSecurityGetDomain200ResponseAllOfResult([void updates(EmailSecurityGetDomain200ResponseAllOfResultBuilder b)]) = _$EmailSecurityGetDomain200ResponseAllOfResult;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(EmailSecurityGetDomain200ResponseAllOfResultBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<EmailSecurityGetDomain200ResponseAllOfResult> get serializer => _$EmailSecurityGetDomain200ResponseAllOfResultSerializer();
}

class _$EmailSecurityGetDomain200ResponseAllOfResultSerializer implements PrimitiveSerializer<EmailSecurityGetDomain200ResponseAllOfResult> {
  @override
  final Iterable<Type> types = const [EmailSecurityGetDomain200ResponseAllOfResult, _$EmailSecurityGetDomain200ResponseAllOfResult];

  @override
  final String wireName = r'EmailSecurityGetDomain200ResponseAllOfResult';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    EmailSecurityGetDomain200ResponseAllOfResult object, {
  ...
  void _deserializeProperties(
    ...
    required EmailSecurityGetDomain200ResponseAllOfResultBuilder result,
  ...
  @override
  EmailSecurityGetDomain200ResponseAllOfResult deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = EmailSecurityGetDomain200ResponseAllOfResultBuilder();
