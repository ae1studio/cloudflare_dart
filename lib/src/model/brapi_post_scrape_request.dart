...
part 'brapi_post_scrape_request.g.dart';
...
abstract class BrapiPostScrapeRequest implements Built<BrapiPostScrapeRequest, BrapiPostScrapeRequestBuilder> {
  ...
  BrapiPostScrapeRequest._();

  factory BrapiPostScrapeRequest([void updates(BrapiPostScrapeRequestBuilder b)]) = _$BrapiPostScrapeRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BrapiPostScrapeRequestBuilder b) => b
      ..userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36';

  @BuiltValueSerializer(custom: true)
  static Serializer<BrapiPostScrapeRequest> get serializer => _$BrapiPostScrapeRequestSerializer();
}

class _$BrapiPostScrapeRequestSerializer implements PrimitiveSerializer<BrapiPostScrapeRequest> {
  @override
  final Iterable<Type> types = const [BrapiPostScrapeRequest, _$BrapiPostScrapeRequest];

  @override
  final String wireName = r'BrapiPostScrapeRequest';
  ...
  void _deserializeProperties(
    ...
    required BrapiPostScrapeRequestBuilder result,
  ...
  @override
  BrapiPostScrapeRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BrapiPostScrapeRequestBuilder();
