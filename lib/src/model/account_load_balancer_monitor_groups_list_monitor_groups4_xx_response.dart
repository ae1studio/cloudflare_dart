...
class AccountLoadBalancerMonitorGroupsListMonitorGroups4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<AccountLoadBalancerMonitorGroupsListMonitorGroups4XXResponseResultEnum> get serializer => _$accountLoadBalancerMonitorGroupsListMonitorGroups4XXResponseResultSerializer;

  const AccountLoadBalancerMonitorGroupsListMonitorGroups4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<AccountLoadBalancerMonitorGroupsListMonitorGroups4XXResponseResultEnum> get values => _$accountLoadBalancerMonitorGroupsListMonitorGroups4XXResponseResultValues;
  static AccountLoadBalancerMonitorGroupsListMonitorGroups4XXResponseResultEnum valueOf(String name) => _$accountLoadBalancerMonitorGroupsListMonitorGroups4XXResponseResultValueOf(name);
}
