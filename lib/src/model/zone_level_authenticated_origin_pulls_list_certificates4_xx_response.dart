...
class ZoneLevelAuthenticatedOriginPullsListCertificates4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<ZoneLevelAuthenticatedOriginPullsListCertificates4XXResponseResultEnum> get serializer => _$zoneLevelAuthenticatedOriginPullsListCertificates4XXResponseResultSerializer;

  const ZoneLevelAuthenticatedOriginPullsListCertificates4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<ZoneLevelAuthenticatedOriginPullsListCertificates4XXResponseResultEnum> get values => _$zoneLevelAuthenticatedOriginPullsListCertificates4XXResponseResultValues;
  static ZoneLevelAuthenticatedOriginPullsListCertificates4XXResponseResultEnum valueOf(String name) => _$zoneLevelAuthenticatedOriginPullsListCertificates4XXResponseResultValueOf(name);
}
