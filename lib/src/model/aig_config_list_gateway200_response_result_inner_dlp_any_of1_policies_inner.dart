...
class AigConfigListGateway200ResponseResultInnerDlpAnyOf1PoliciesInnerActionEnum extends EnumClass {
  ...
  static Serializer<AigConfigListGateway200ResponseResultInnerDlpAnyOf1PoliciesInnerActionEnum> get serializer => _$aigConfigListGateway200ResponseResultInnerDlpAnyOf1PoliciesInnerActionSerializer;

  const AigConfigListGateway200ResponseResultInnerDlpAnyOf1PoliciesInnerActionEnum._(String name): super(name);

  static BuiltSet<AigConfigListGateway200ResponseResultInnerDlpAnyOf1PoliciesInnerActionEnum> get values => _$aigConfigListGateway200ResponseResultInnerDlpAnyOf1PoliciesInnerActionValues;
  static AigConfigListGateway200ResponseResultInnerDlpAnyOf1PoliciesInnerActionEnum valueOf(String name) => _$aigConfigListGateway200ResponseResultInnerDlpAnyOf1PoliciesInnerActionValueOf(name);
}
...
class AigConfigListGateway200ResponseResultInnerDlpAnyOf1PoliciesInnerCheckEnum extends EnumClass {
  ...
  static Serializer<AigConfigListGateway200ResponseResultInnerDlpAnyOf1PoliciesInnerCheckEnum> get serializer => _$aigConfigListGateway200ResponseResultInnerDlpAnyOf1PoliciesInnerCheckSerializer;

  const AigConfigListGateway200ResponseResultInnerDlpAnyOf1PoliciesInnerCheckEnum._(String name): super(name);

  static BuiltSet<AigConfigListGateway200ResponseResultInnerDlpAnyOf1PoliciesInnerCheckEnum> get values => _$aigConfigListGateway200ResponseResultInnerDlpAnyOf1PoliciesInnerCheckValues;
  static AigConfigListGateway200ResponseResultInnerDlpAnyOf1PoliciesInnerCheckEnum valueOf(String name) => _$aigConfigListGateway200ResponseResultInnerDlpAnyOf1PoliciesInnerCheckValueOf(name);
}
