...
part 'dns_views_for_an_account_list_internal_dns_views4_xx_response.g.dart';
...
abstract class DnsViewsForAnAccountListInternalDnsViews4XXResponse implements DnsSettingsApiResponseCommonFailure, DnsSettingsDnsViewResponseCollection, Built<DnsViewsForAnAccountListInternalDnsViews4XXResponse, DnsViewsForAnAccountListInternalDnsViews4XXResponseBuilder> {
  ...
  factory DnsViewsForAnAccountListInternalDnsViews4XXResponse([void updates(DnsViewsForAnAccountListInternalDnsViews4XXResponseBuilder b)]) = _$DnsViewsForAnAccountListInternalDnsViews4XXResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DnsViewsForAnAccountListInternalDnsViews4XXResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DnsViewsForAnAccountListInternalDnsViews4XXResponse> get serializer => _$DnsViewsForAnAccountListInternalDnsViews4XXResponseSerializer();
}

class _$DnsViewsForAnAccountListInternalDnsViews4XXResponseSerializer implements PrimitiveSerializer<DnsViewsForAnAccountListInternalDnsViews4XXResponse> {
  @override
  final Iterable<Type> types = const [DnsViewsForAnAccountListInternalDnsViews4XXResponse, _$DnsViewsForAnAccountListInternalDnsViews4XXResponse];

  @override
  final String wireName = r'DnsViewsForAnAccountListInternalDnsViews4XXResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    DnsViewsForAnAccountListInternalDnsViews4XXResponse object, {
  ...
  void _deserializeProperties(
    ...
    required DnsViewsForAnAccountListInternalDnsViews4XXResponseBuilder result,
  ...
  @override
  DnsViewsForAnAccountListInternalDnsViews4XXResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DnsViewsForAnAccountListInternalDnsViews4XXResponseBuilder();
