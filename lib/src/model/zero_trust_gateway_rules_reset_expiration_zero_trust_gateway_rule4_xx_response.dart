...
class ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRule4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRule4XXResponseResultEnum> get serializer => _$zeroTrustGatewayRulesResetExpirationZeroTrustGatewayRule4XXResponseResultSerializer;

  const ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRule4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRule4XXResponseResultEnum> get values => _$zeroTrustGatewayRulesResetExpirationZeroTrustGatewayRule4XXResponseResultValues;
  static ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRule4XXResponseResultEnum valueOf(String name) => _$zeroTrustGatewayRulesResetExpirationZeroTrustGatewayRule4XXResponseResultValueOf(name);
}
