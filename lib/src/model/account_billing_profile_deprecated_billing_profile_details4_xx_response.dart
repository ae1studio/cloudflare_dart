...
class AccountBillingProfileDeprecatedBillingProfileDetails4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<AccountBillingProfileDeprecatedBillingProfileDetails4XXResponseResultEnum> get serializer => _$accountBillingProfileDeprecatedBillingProfileDetails4XXResponseResultSerializer;

  const AccountBillingProfileDeprecatedBillingProfileDetails4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<AccountBillingProfileDeprecatedBillingProfileDetails4XXResponseResultEnum> get values => _$accountBillingProfileDeprecatedBillingProfileDetails4XXResponseResultValues;
  static AccountBillingProfileDeprecatedBillingProfileDetails4XXResponseResultEnum valueOf(String name) => _$accountBillingProfileDeprecatedBillingProfileDetails4XXResponseResultValueOf(name);
}
