...
part 'rulesets_block_rule.g.dart';
...
abstract class RulesetsBlockRule implements RulesetsRule, Built<RulesetsBlockRule, RulesetsBlockRuleBuilder> {
  ...
  factory RulesetsBlockRule([void updates(RulesetsBlockRuleBuilder b)]) = _$RulesetsBlockRule;
  ...
  static Serializer<RulesetsBlockRule> get serializer => _$RulesetsBlockRuleSerializer();
}

class _$RulesetsBlockRuleSerializer implements PrimitiveSerializer<RulesetsBlockRule> {
  @override
  final Iterable<Type> types = const [RulesetsBlockRule, _$RulesetsBlockRule];

  @override
  final String wireName = r'RulesetsBlockRule';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RulesetsBlockRule object, {
  ...
  void _deserializeProperties(
    ...
    required RulesetsBlockRuleBuilder result,
  ...
  @override
  RulesetsBlockRule deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RulesetsBlockRuleBuilder();
...
class RulesetsBlockRuleActionEnum extends EnumClass {
