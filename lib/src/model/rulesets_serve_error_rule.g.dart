...
part of 'rulesets_serve_error_rule.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const RulesetsServeErrorRuleActionEnum
    _$rulesetsServeErrorRuleActionEnum_serveError =
    const RulesetsServeErrorRuleActionEnum._('serveError');

RulesetsServeErrorRuleActionEnum _$rulesetsServeErrorRuleActionEnumValueOf(
    String name) {
  switch (name) {
    case 'serveError':
      return _$rulesetsServeErrorRuleActionEnum_serveError;
    default:
      throw ArgumentError(name);
  }
}

final BuiltSet<RulesetsServeErrorRuleActionEnum>
    _$rulesetsServeErrorRuleActionEnumValues = BuiltSet<
        RulesetsServeErrorRuleActionEnum>(const <RulesetsServeErrorRuleActionEnum>[
  _$rulesetsServeErrorRuleActionEnum_serveError,
]);

Serializer<RulesetsServeErrorRuleActionEnum>
    _$rulesetsServeErrorRuleActionEnumSerializer =
    _$RulesetsServeErrorRuleActionEnumSerializer();

class _$RulesetsServeErrorRuleActionEnumSerializer
    implements PrimitiveSerializer<RulesetsServeErrorRuleActionEnum> {
  ...
  @override
  final Iterable<Type> types = const <Type>[RulesetsServeErrorRuleActionEnum];
  @override
  final String wireName = 'RulesetsServeErrorRuleActionEnum';

  @override
  Object serialize(
          Serializers serializers, RulesetsServeErrorRuleActionEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  RulesetsServeErrorRuleActionEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      RulesetsServeErrorRuleActionEnum.valueOf(
...
class _$RulesetsServeErrorRule extends RulesetsServeErrorRule {
  ...
  @override
  RulesetsServeErrorRuleBuilder toBuilder() =>
      RulesetsServeErrorRuleBuilder()..replace(this);
...
class RulesetsServeErrorRuleBuilder
    implements
  ...
  @override
  void replace(covariant RulesetsServeErrorRule other) {
    _$v = other as _$RulesetsServeErrorRule;
  }

  @override
  void update(void Function(RulesetsServeErrorRuleBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RulesetsServeErrorRule build() => _build();

  _$RulesetsServeErrorRule _build() {
    _$RulesetsServeErrorRule _$result;
    try {
      _$result = _$v ??
          _$RulesetsServeErrorRule._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'RulesetsServeErrorRule', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
