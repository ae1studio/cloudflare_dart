...
class MagicNetworkMonitoringVpcFlowsGenerateAuthenticationToken4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<MagicNetworkMonitoringVpcFlowsGenerateAuthenticationToken4XXResponseResultEnum> get serializer => _$magicNetworkMonitoringVpcFlowsGenerateAuthenticationToken4XXResponseResultSerializer;

  const MagicNetworkMonitoringVpcFlowsGenerateAuthenticationToken4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<MagicNetworkMonitoringVpcFlowsGenerateAuthenticationToken4XXResponseResultEnum> get values => _$magicNetworkMonitoringVpcFlowsGenerateAuthenticationToken4XXResponseResultValues;
  static MagicNetworkMonitoringVpcFlowsGenerateAuthenticationToken4XXResponseResultEnum valueOf(String name) => _$magicNetworkMonitoringVpcFlowsGenerateAuthenticationToken4XXResponseResultValueOf(name);
}
