...
part 'edit_worker_request.g.dart';
...
@BuiltValue()
abstract class EditWorkerRequest implements WorkersWorker, Built<EditWorkerRequest, EditWorkerRequestBuilder> {
  EditWorkerRequest._();

  factory EditWorkerRequest([void updates(EditWorkerRequestBuilder b)]) = _$EditWorkerRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(EditWorkerRequestBuilder b) => b
      ..logpush = false
      ..tailConsumers = ListBuilder()
      ..tags = ListBuilder();

  @BuiltValueSerializer(custom: true)
  static Serializer<EditWorkerRequest> get serializer => _$EditWorkerRequestSerializer();
}

class _$EditWorkerRequestSerializer implements PrimitiveSerializer<EditWorkerRequest> {
  @override
  final Iterable<Type> types = const [EditWorkerRequest, _$EditWorkerRequest];

  @override
  final String wireName = r'EditWorkerRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    EditWorkerRequest object, {
  ...
  void _deserializeProperties(
    ...
    required EditWorkerRequestBuilder result,
  ...
  @override
  EditWorkerRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = EditWorkerRequestBuilder();
