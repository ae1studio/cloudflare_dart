...
part 'email_security_get_message200_response_all_of_result.g.dart';
...
abstract class EmailSecurityGetMessage200ResponseAllOfResult implements Built<EmailSecurityGetMessage200ResponseAllOfResult, EmailSecurityGetMessage200ResponseAllOfResultBuilder> {
  ...
  EmailSecurityGetMessage200ResponseAllOfResultAllOfFinalDisposition? get finalDisposition;

  @BuiltValueField(wireName: r'findings')
  BuiltList<EmailSecurityGetMessage200ResponseAllOfResultAllOfFindingsInner>? get findings;
  ...
  factory EmailSecurityGetMessage200ResponseAllOfResult([void updates(EmailSecurityGetMessage200ResponseAllOfResultBuilder b)]) = _$EmailSecurityGetMessage200ResponseAllOfResult;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(EmailSecurityGetMessage200ResponseAllOfResultBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<EmailSecurityGetMessage200ResponseAllOfResult> get serializer => _$EmailSecurityGetMessage200ResponseAllOfResultSerializer();
}

class _$EmailSecurityGetMessage200ResponseAllOfResultSerializer implements PrimitiveSerializer<EmailSecurityGetMessage200ResponseAllOfResult> {
  @override
  final Iterable<Type> types = const [EmailSecurityGetMessage200ResponseAllOfResult, _$EmailSecurityGetMessage200ResponseAllOfResult];

  @override
  final String wireName = r'EmailSecurityGetMessage200ResponseAllOfResult';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    EmailSecurityGetMessage200ResponseAllOfResult object, {
    ...
    if (object.finalDisposition != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(EmailSecurityGetMessage200ResponseAllOfResultAllOfFinalDisposition),
      );
    }
    if (object.findings != null) {
      ...
      yield serializers.serialize(
        object.findings,
        specifiedType: const FullType.nullable(BuiltList, [FullType(EmailSecurityGetMessage200ResponseAllOfResultAllOfFindingsInner)]),
      );
    }
    if (object.from != null) {
      yield r'from';
  ...
  void _deserializeProperties(
    ...
    required EmailSecurityGetMessage200ResponseAllOfResultBuilder result,
      ...
      switch (key) {
        ...
        case r'final_disposition':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(EmailSecurityGetMessage200ResponseAllOfResultAllOfFinalDisposition),
          ) as EmailSecurityGetMessage200ResponseAllOfResultAllOfFinalDisposition;
        ...
        case r'findings':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(BuiltList, [FullType(EmailSecurityGetMessage200ResponseAllOfResultAllOfFindingsInner)]),
          ) as BuiltList<EmailSecurityGetMessage200ResponseAllOfResultAllOfFindingsInner>?;
          if (valueDes == null) continue;
  ...
  @override
  EmailSecurityGetMessage200ResponseAllOfResult deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = EmailSecurityGetMessage200ResponseAllOfResultBuilder();
