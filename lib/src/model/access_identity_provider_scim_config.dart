...
part 'access_identity_provider_scim_config.g.dart';
...
@BuiltValue()
abstract class AccessIdentityProviderScimConfig implements Built<AccessIdentityProviderScimConfig, AccessIdentityProviderScimConfigBuilder> {
  ...
  AccessIdentityProviderScimConfigIdentityUpdateBehaviorEnum? get identityUpdateBehavior;
  ...
  AccessIdentityProviderScimConfig._();

  factory AccessIdentityProviderScimConfig([void updates(AccessIdentityProviderScimConfigBuilder b)]) = _$AccessIdentityProviderScimConfig;
  ...
  static Serializer<AccessIdentityProviderScimConfig> get serializer => _$AccessIdentityProviderScimConfigSerializer();
}

class _$AccessIdentityProviderScimConfigSerializer implements PrimitiveSerializer<AccessIdentityProviderScimConfig> {
  @override
  final Iterable<Type> types = const [AccessIdentityProviderScimConfig, _$AccessIdentityProviderScimConfig];

  @override
  final String wireName = r'AccessIdentityProviderScimConfig';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccessIdentityProviderScimConfig object, {
    ...
    if (object.identityUpdateBehavior != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(AccessIdentityProviderScimConfigIdentityUpdateBehaviorEnum),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required AccessIdentityProviderScimConfigBuilder result,
      ...
      switch (key) {
        ...
        case r'identity_update_behavior':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(AccessIdentityProviderScimConfigIdentityUpdateBehaviorEnum),
          ) as AccessIdentityProviderScimConfigIdentityUpdateBehaviorEnum;
  ...
  @override
  AccessIdentityProviderScimConfig deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccessIdentityProviderScimConfigBuilder();
...
class AccessIdentityProviderScimConfigIdentityUpdateBehaviorEnum extends EnumClass {

  /// Indicates how a SCIM event updates a user identity used for policy evaluation. Use \"automatic\" to automatically update a user's identity and augment it with fields from the SCIM user resource. Use \"reauth\" to force re-authentication on group membership updates, user identity update will only occur after successful re-authentication. With \"reauth\" identities will not contain fields from the SCIM user resource. With \"no_action\" identities will not be changed by SCIM updates in any way and users will not be prompted to reauthenticate.
  @BuiltValueEnumConst(wireName: r'automatic')
  static const AccessIdentityProviderScimConfigIdentityUpdateBehaviorEnum automatic = _$accessIdentityProviderScimConfigIdentityUpdateBehaviorEnum_automatic;
  /// Indicates how a SCIM event updates a user identity used for policy evaluation. Use \"automatic\" to automatically update a user's identity and augment it with fields from the SCIM user resource. Use \"reauth\" to force re-authentication on group membership updates, user identity update will only occur after successful re-authentication. With \"reauth\" identities will not contain fields from the SCIM user resource. With \"no_action\" identities will not be changed by SCIM updates in any way and users will not be prompted to reauthenticate.
  @BuiltValueEnumConst(wireName: r'reauth')
  static const AccessIdentityProviderScimConfigIdentityUpdateBehaviorEnum reauth = _$accessIdentityProviderScimConfigIdentityUpdateBehaviorEnum_reauth;
  /// Indicates how a SCIM event updates a user identity used for policy evaluation. Use \"automatic\" to automatically update a user's identity and augment it with fields from the SCIM user resource. Use \"reauth\" to force re-authentication on group membership updates, user identity update will only occur after successful re-authentication. With \"reauth\" identities will not contain fields from the SCIM user resource. With \"no_action\" identities will not be changed by SCIM updates in any way and users will not be prompted to reauthenticate.
