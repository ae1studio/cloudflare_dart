...
class IpAddressManagementDynamicAdvertisementGetAdvertisementStatus4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<IpAddressManagementDynamicAdvertisementGetAdvertisementStatus4XXResponseResultEnum> get serializer => _$ipAddressManagementDynamicAdvertisementGetAdvertisementStatus4XXResponseResultEnumSerializer;

  const IpAddressManagementDynamicAdvertisementGetAdvertisementStatus4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<IpAddressManagementDynamicAdvertisementGetAdvertisementStatus4XXResponseResultEnum> get values => _$ipAddressManagementDynamicAdvertisementGetAdvertisementStatus4XXResponseResultEnumValues;
  static IpAddressManagementDynamicAdvertisementGetAdvertisementStatus4XXResponseResultEnum valueOf(String name) => _$ipAddressManagementDynamicAdvertisementGetAdvertisementStatus4XXResponseResultEnumValueOf(name);
}
