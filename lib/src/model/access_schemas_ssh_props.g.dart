...
part of 'access_schemas_ssh_props.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

abstract class AccessSchemasSshPropsBuilder
...
class _$$AccessSchemasSshProps extends $AccessSchemasSshProps {
  ...
  @override
  $AccessSchemasSshPropsBuilder toBuilder() =>
      $AccessSchemasSshPropsBuilder()..replace(this);
...
class $AccessSchemasSshPropsBuilder
    implements
  ...
  @override
  void replace(covariant $AccessSchemasSshProps other) {
    _$v = other as _$$AccessSchemasSshProps;
  }
  ...
  @override
  $AccessSchemasSshProps build() => _build();

  _$$AccessSchemasSshProps _build() {
    _$$AccessSchemasSshProps _$result;
    try {
      _$result = _$v ??
          _$$AccessSchemasSshProps._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'$AccessSchemasSshProps', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
