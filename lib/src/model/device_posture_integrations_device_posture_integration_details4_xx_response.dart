...
class DevicePostureIntegrationsDevicePostureIntegrationDetails4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<DevicePostureIntegrationsDevicePostureIntegrationDetails4XXResponseResultEnum> get serializer => _$devicePostureIntegrationsDevicePostureIntegrationDetails4XXResponseResultEnumSerializer;

  const DevicePostureIntegrationsDevicePostureIntegrationDetails4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<DevicePostureIntegrationsDevicePostureIntegrationDetails4XXResponseResultEnum> get values => _$devicePostureIntegrationsDevicePostureIntegrationDetails4XXResponseResultEnumValues;
  static DevicePostureIntegrationsDevicePostureIntegrationDetails4XXResponseResultEnum valueOf(String name) => _$devicePostureIntegrationsDevicePostureIntegrationDetails4XXResponseResultEnumValueOf(name);
}
