...
class DigitalExperienceMonitoringPostCommandsResponseCommandsInnerStatusEnum extends EnumClass {
  ...
  static Serializer<DigitalExperienceMonitoringPostCommandsResponseCommandsInnerStatusEnum> get serializer => _$digitalExperienceMonitoringPostCommandsResponseCommandsInnerStatusSerializer;

  const DigitalExperienceMonitoringPostCommandsResponseCommandsInnerStatusEnum._(String name): super(name);

  static BuiltSet<DigitalExperienceMonitoringPostCommandsResponseCommandsInnerStatusEnum> get values => _$digitalExperienceMonitoringPostCommandsResponseCommandsInnerStatusValues;
  static DigitalExperienceMonitoringPostCommandsResponseCommandsInnerStatusEnum valueOf(String name) => _$digitalExperienceMonitoringPostCommandsResponseCommandsInnerStatusValueOf(name);
}
