...
class Web3HostnameIpfsUniversalPathGatewayContentListDetails4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<Web3HostnameIpfsUniversalPathGatewayContentListDetails4XXResponseResultEnum> get serializer => _$web3HostnameIpfsUniversalPathGatewayContentListDetails4XXResponseResultEnumSerializer;

  const Web3HostnameIpfsUniversalPathGatewayContentListDetails4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<Web3HostnameIpfsUniversalPathGatewayContentListDetails4XXResponseResultEnum> get values => _$web3HostnameIpfsUniversalPathGatewayContentListDetails4XXResponseResultEnumValues;
  static Web3HostnameIpfsUniversalPathGatewayContentListDetails4XXResponseResultEnum valueOf(String name) => _$web3HostnameIpfsUniversalPathGatewayContentListDetails4XXResponseResultEnumValueOf(name);
}
