...
class EmailSecurityMailsearchMessageAllOfPropertiesAllowlistedPatternTypeEnum extends EnumClass {
  ...
  static Serializer<EmailSecurityMailsearchMessageAllOfPropertiesAllowlistedPatternTypeEnum> get serializer => _$emailSecurityMailsearchMessageAllOfPropertiesAllowlistedPatternTypeSerializer;

  const EmailSecurityMailsearchMessageAllOfPropertiesAllowlistedPatternTypeEnum._(String name): super(name);

  static BuiltSet<EmailSecurityMailsearchMessageAllOfPropertiesAllowlistedPatternTypeEnum> get values => _$emailSecurityMailsearchMessageAllOfPropertiesAllowlistedPatternTypeValues;
  static EmailSecurityMailsearchMessageAllOfPropertiesAllowlistedPatternTypeEnum valueOf(String name) => _$emailSecurityMailsearchMessageAllOfPropertiesAllowlistedPatternTypeValueOf(name);
}
...
class EmailSecurityMailsearchMessageAllOfPropertiesWhitelistedPatternTypeEnum extends EnumClass {
  ...
  static Serializer<EmailSecurityMailsearchMessageAllOfPropertiesWhitelistedPatternTypeEnum> get serializer => _$emailSecurityMailsearchMessageAllOfPropertiesWhitelistedPatternTypeSerializer;

  const EmailSecurityMailsearchMessageAllOfPropertiesWhitelistedPatternTypeEnum._(String name): super(name);

  static BuiltSet<EmailSecurityMailsearchMessageAllOfPropertiesWhitelistedPatternTypeEnum> get values => _$emailSecurityMailsearchMessageAllOfPropertiesWhitelistedPatternTypeValues;
  static EmailSecurityMailsearchMessageAllOfPropertiesWhitelistedPatternTypeEnum valueOf(String name) => _$emailSecurityMailsearchMessageAllOfPropertiesWhitelistedPatternTypeValueOf(name);
}
