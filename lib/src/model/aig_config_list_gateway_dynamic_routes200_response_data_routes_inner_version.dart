...
class AigConfigListGatewayDynamicRoutes200ResponseDataRoutesInnerVersionActiveEnum extends EnumClass {
  ...
  static Serializer<AigConfigListGatewayDynamicRoutes200ResponseDataRoutesInnerVersionActiveEnum> get serializer => _$aigConfigListGatewayDynamicRoutes200ResponseDataRoutesInnerVersionActiveSerializer;

  const AigConfigListGatewayDynamicRoutes200ResponseDataRoutesInnerVersionActiveEnum._(String name): super(name);

  static BuiltSet<AigConfigListGatewayDynamicRoutes200ResponseDataRoutesInnerVersionActiveEnum> get values => _$aigConfigListGatewayDynamicRoutes200ResponseDataRoutesInnerVersionActiveValues;
  static AigConfigListGatewayDynamicRoutes200ResponseDataRoutesInnerVersionActiveEnum valueOf(String name) => _$aigConfigListGatewayDynamicRoutes200ResponseDataRoutesInnerVersionActiveValueOf(name);
}
