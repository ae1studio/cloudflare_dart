...
part of 'access_rdp_props.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

abstract class AccessRdpPropsBuilder
    implements
        AccessAppRespEmbeddedTargetCriteriaSelfHostedBuilder,
        AccessSelfHostedPropsBuilder {
  void replace(covariant AccessRdpProps other);
  void update(void Function(AccessRdpPropsBuilder) updates);
...
class _$$AccessRdpProps extends $AccessRdpProps {
  ...
  @override
  $AccessRdpPropsBuilder toBuilder() => $AccessRdpPropsBuilder()..replace(this);
...
class $AccessRdpPropsBuilder
    implements
        Builder<$AccessRdpProps, $AccessRdpPropsBuilder>,
        AccessRdpPropsBuilder {
  _$$AccessRdpProps? _$v;
  ...
  $AccessRdpPropsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  $AccessRdpProps build() => _build();

  _$$AccessRdpProps _build() {
    _$$AccessRdpProps _$result;
    try {
      _$result = _$v ??
          _$$AccessRdpProps._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'$AccessRdpProps', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
