...
part of 'zone_level_access_service_tokens_create_a_service_token_request.dart';
...
class _$ZoneLevelAccessServiceTokensCreateAServiceTokenRequest
  ...
  factory _$ZoneLevelAccessServiceTokensCreateAServiceTokenRequest(
          [void Function(
  ...
  _$ZoneLevelAccessServiceTokensCreateAServiceTokenRequest._(
      ...
      : super._();
  @override
  ZoneLevelAccessServiceTokensCreateAServiceTokenRequest rebuild(
          void Function(
                  ZoneLevelAccessServiceTokensCreateAServiceTokenRequestBuilder)
              updates) =>
  ...
  @override
  ZoneLevelAccessServiceTokensCreateAServiceTokenRequestBuilder toBuilder() =>
      ZoneLevelAccessServiceTokensCreateAServiceTokenRequestBuilder()
        ..replace(this);
...
class ZoneLevelAccessServiceTokensCreateAServiceTokenRequestBuilder
    implements
        Builder<ZoneLevelAccessServiceTokensCreateAServiceTokenRequest,
            ZoneLevelAccessServiceTokensCreateAServiceTokenRequestBuilder> {
  ...
  ZoneLevelAccessServiceTokensCreateAServiceTokenRequestBuilder() {
    ZoneLevelAccessServiceTokensCreateAServiceTokenRequest._defaults(this);
  }
  ...
  @override
  void replace(ZoneLevelAccessServiceTokensCreateAServiceTokenRequest other) {
    _$v = other as _$ZoneLevelAccessServiceTokensCreateAServiceTokenRequest;
  }
  ...
  @override
  ZoneLevelAccessServiceTokensCreateAServiceTokenRequest build() => _build();
