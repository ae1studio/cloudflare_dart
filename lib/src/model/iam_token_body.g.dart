...
part of 'iam_token_body.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$IamTokenBody extends IamTokenBody {
  @override
  ...
  factory _$IamTokenBody([void Function(IamTokenBodyBuilder)? updates]) =>
      (IamTokenBodyBuilder()..update(updates))._build();
  ...
  _$IamTokenBody._(
      ...
      : super._();
  @override
  IamTokenBody rebuild(void Function(IamTokenBodyBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  IamTokenBodyBuilder toBuilder() => IamTokenBodyBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is IamTokenBody &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'IamTokenBody')
...
class IamTokenBodyBuilder
    implements Builder<IamTokenBody, IamTokenBodyBuilder>, IamTokenBaseBuilder {
  _$IamTokenBody? _$v;
  ...
  IamTokenBodyBuilder() {
    IamTokenBody._defaults(this);
  }

  IamTokenBodyBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant IamTokenBody other) {
    _$v = other as _$IamTokenBody;
  }

  @override
  void update(void Function(IamTokenBodyBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  IamTokenBody build() => _build();

  _$IamTokenBody _build() {
    _$IamTokenBody _$result;
    try {
      _$result = _$v ??
          _$IamTokenBody._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'IamTokenBody', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
