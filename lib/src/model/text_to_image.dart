...
abstract class TextToImage implements Built<TextToImage, TextToImageBuilder> {
  ...
  factory TextToImage([void updates(TextToImageBuilder b)]) = _$TextToImage;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TextToImageBuilder b) => b
      ..guidance = 7.5
      ..numSteps = 20
      ..strength = 1;

  @BuiltValueSerializer(custom: true)
  static Serializer<TextToImage> get serializer => _$TextToImageSerializer();
}

class _$TextToImageSerializer implements PrimitiveSerializer<TextToImage> {
  @override
  final Iterable<Type> types = const [TextToImage, _$TextToImage];

  @override
  final String wireName = r'TextToImage';
  ...
  void _deserializeProperties(
    ...
    required TextToImageBuilder result,
  ...
  @override
  TextToImage deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = TextToImageBuilder();
