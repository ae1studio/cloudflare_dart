...
part 'browser_ssh_application1.g.dart';
...
/// * [policies] 
@BuiltValue()
abstract class BrowserSSHApplication1 implements AccessAppRespEmbeddedPolicies, AccessBasicAppResponseProps, AccessSshProps, Built<BrowserSSHApplication1, BrowserSSHApplication1Builder> {
  BrowserSSHApplication1._();

  factory BrowserSSHApplication1([void updates(BrowserSSHApplication1Builder b)]) = _$BrowserSSHApplication1;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BrowserSSHApplication1Builder b) => b
  ...
  static Serializer<BrowserSSHApplication1> get serializer => _$BrowserSSHApplication1Serializer();
}

class _$BrowserSSHApplication1Serializer implements PrimitiveSerializer<BrowserSSHApplication1> {
  @override
  final Iterable<Type> types = const [BrowserSSHApplication1, _$BrowserSSHApplication1];

  @override
  final String wireName = r'BrowserSSHApplication1';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BrowserSSHApplication1 object, {
  ...
  void _deserializeProperties(
    ...
    required BrowserSSHApplication1Builder result,
  ...
  @override
  BrowserSSHApplication1 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BrowserSSHApplication1Builder();
