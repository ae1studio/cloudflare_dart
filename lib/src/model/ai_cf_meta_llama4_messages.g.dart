...
part of 'ai_cf_meta_llama4_messages.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$AiCfMetaLlama4Messages extends AiCfMetaLlama4Messages {
  @override
  ...
  factory _$AiCfMetaLlama4Messages(
          [void Function(AiCfMetaLlama4MessagesBuilder)? updates]) =>
      (AiCfMetaLlama4MessagesBuilder()..update(updates))._build();

  _$AiCfMetaLlama4Messages._(
      ...
      : super._();
  @override
  AiCfMetaLlama4Messages rebuild(
          void Function(AiCfMetaLlama4MessagesBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  AiCfMetaLlama4MessagesBuilder toBuilder() =>
      AiCfMetaLlama4MessagesBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AiCfMetaLlama4Messages &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AiCfMetaLlama4Messages')
...
class AiCfMetaLlama4MessagesBuilder
    implements Builder<AiCfMetaLlama4Messages, AiCfMetaLlama4MessagesBuilder> {
  _$AiCfMetaLlama4Messages? _$v;
  ...
  AiCfMetaLlama4MessagesBuilder() {
    AiCfMetaLlama4Messages._defaults(this);
  }

  AiCfMetaLlama4MessagesBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(AiCfMetaLlama4Messages other) {
    _$v = other as _$AiCfMetaLlama4Messages;
  }

  @override
  void update(void Function(AiCfMetaLlama4MessagesBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  AiCfMetaLlama4Messages build() => _build();

  _$AiCfMetaLlama4Messages _build() {
    _$AiCfMetaLlama4Messages _$result;
    try {
      _$result = _$v ??
          _$AiCfMetaLlama4Messages._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'AiCfMetaLlama4Messages', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
