...
class SecondaryDnsSecondaryZoneDeleteSecondaryZoneConfiguration4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<SecondaryDnsSecondaryZoneDeleteSecondaryZoneConfiguration4XXResponseResultEnum> get serializer => _$secondaryDnsSecondaryZoneDeleteSecondaryZoneConfiguration4XXResponseResultSerializer;

  const SecondaryDnsSecondaryZoneDeleteSecondaryZoneConfiguration4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<SecondaryDnsSecondaryZoneDeleteSecondaryZoneConfiguration4XXResponseResultEnum> get values => _$secondaryDnsSecondaryZoneDeleteSecondaryZoneConfiguration4XXResponseResultValues;
  static SecondaryDnsSecondaryZoneDeleteSecondaryZoneConfiguration4XXResponseResultEnum valueOf(String name) => _$secondaryDnsSecondaryZoneDeleteSecondaryZoneConfiguration4XXResponseResultValueOf(name);
}
