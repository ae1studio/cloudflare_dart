...
/// * [status] 
@BuiltValue()
abstract class IamMembership implements Built<IamMembership, IamMembershipBuilder> {
  ...
  factory IamMembership([void updates(IamMembershipBuilder b)]) = _$IamMembership;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IamMembershipBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IamMembership> get serializer => _$IamMembershipSerializer();
}

class _$IamMembershipSerializer implements PrimitiveSerializer<IamMembership> {
  @override
  final Iterable<Type> types = const [IamMembership, _$IamMembership];

  @override
  final String wireName = r'IamMembership';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IamMembership object, {
  ...
  void _deserializeProperties(
    ...
    required IamMembershipBuilder result,
  ...
  @override
  IamMembership deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IamMembershipBuilder();
