...
class RadarGetAiBotsSummaryByUserAgent200ResponseResultMetaNormalizationEnum extends EnumClass {
  ...
  static Serializer<RadarGetAiBotsSummaryByUserAgent200ResponseResultMetaNormalizationEnum> get serializer => _$radarGetAiBotsSummaryByUserAgent200ResponseResultMetaNormalizationSerializer;

  const RadarGetAiBotsSummaryByUserAgent200ResponseResultMetaNormalizationEnum._(String name): super(name);

  static BuiltSet<RadarGetAiBotsSummaryByUserAgent200ResponseResultMetaNormalizationEnum> get values => _$radarGetAiBotsSummaryByUserAgent200ResponseResultMetaNormalizationValues;
  static RadarGetAiBotsSummaryByUserAgent200ResponseResultMetaNormalizationEnum valueOf(String name) => _$radarGetAiBotsSummaryByUserAgent200ResponseResultMetaNormalizationValueOf(name);
}
