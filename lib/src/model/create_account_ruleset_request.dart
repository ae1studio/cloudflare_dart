...
part 'create_account_ruleset_request.g.dart';
...
@BuiltValue()
abstract class CreateAccountRulesetRequest implements RulesetsRuleset, Built<CreateAccountRulesetRequest, CreateAccountRulesetRequestBuilder> {
  ...
  CreateAccountRulesetRequest._();

  factory CreateAccountRulesetRequest([void updates(CreateAccountRulesetRequestBuilder b)]) = _$CreateAccountRulesetRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateAccountRulesetRequestBuilder b) => b
      ..description = ''
      ..rules = ListBuilder();

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateAccountRulesetRequest> get serializer => _$CreateAccountRulesetRequestSerializer();
}

class _$CreateAccountRulesetRequestSerializer implements PrimitiveSerializer<CreateAccountRulesetRequest> {
  @override
  final Iterable<Type> types = const [CreateAccountRulesetRequest, _$CreateAccountRulesetRequest];

  @override
  final String wireName = r'CreateAccountRulesetRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CreateAccountRulesetRequest object, {
  ...
  void _deserializeProperties(
    ...
    required CreateAccountRulesetRequestBuilder result,
  ...
  @override
  CreateAccountRulesetRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CreateAccountRulesetRequestBuilder();
