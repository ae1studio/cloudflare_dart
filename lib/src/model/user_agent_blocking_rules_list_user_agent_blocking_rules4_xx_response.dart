...
class UserAgentBlockingRulesListUserAgentBlockingRules4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<UserAgentBlockingRulesListUserAgentBlockingRules4XXResponseResultEnum> get serializer => _$userAgentBlockingRulesListUserAgentBlockingRules4XXResponseResultEnumSerializer;

  const UserAgentBlockingRulesListUserAgentBlockingRules4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<UserAgentBlockingRulesListUserAgentBlockingRules4XXResponseResultEnum> get values => _$userAgentBlockingRulesListUserAgentBlockingRules4XXResponseResultEnumValues;
  static UserAgentBlockingRulesListUserAgentBlockingRules4XXResponseResultEnum valueOf(String name) => _$userAgentBlockingRulesListUserAgentBlockingRules4XXResponseResultEnumValueOf(name);
}
