...
part of 'pages_deployments.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const PagesDeploymentsEnvironmentEnum
    _$pagesDeploymentsEnvironmentEnum_preview =
    const PagesDeploymentsEnvironmentEnum._('preview');
const PagesDeploymentsEnvironmentEnum
    _$pagesDeploymentsEnvironmentEnum_production =
    const PagesDeploymentsEnvironmentEnum._('production');

PagesDeploymentsEnvironmentEnum _$pagesDeploymentsEnvironmentEnumValueOf(
    String name) {
  switch (name) {
    case 'preview':
      return _$pagesDeploymentsEnvironmentEnum_preview;
    case 'production':
      return _$pagesDeploymentsEnvironmentEnum_production;
    default:
      throw ArgumentError(name);
  }
}

final BuiltSet<PagesDeploymentsEnvironmentEnum>
    _$pagesDeploymentsEnvironmentEnumValues = BuiltSet<
        PagesDeploymentsEnvironmentEnum>(const <PagesDeploymentsEnvironmentEnum>[
  _$pagesDeploymentsEnvironmentEnum_preview,
  _$pagesDeploymentsEnvironmentEnum_production,
]);

Serializer<PagesDeploymentsEnvironmentEnum>
    _$pagesDeploymentsEnvironmentEnumSerializer =
    _$PagesDeploymentsEnvironmentEnumSerializer();

class _$PagesDeploymentsEnvironmentEnumSerializer
    implements PrimitiveSerializer<PagesDeploymentsEnvironmentEnum> {
  ...
  @override
  final Iterable<Type> types = const <Type>[PagesDeploymentsEnvironmentEnum];
  @override
  final String wireName = 'PagesDeploymentsEnvironmentEnum';

  @override
  Object serialize(
          Serializers serializers, PagesDeploymentsEnvironmentEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  PagesDeploymentsEnvironmentEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      PagesDeploymentsEnvironmentEnum.valueOf(
          _fromWire[serialized] ?? (serialized is String ? serialized : ''));
}

abstract class PagesDeploymentsBuilder {
  void replace(PagesDeployments other);
  void update(void Function(PagesDeploymentsBuilder) updates);
  ListBuilder<String> get aliases;
  set aliases(ListBuilder<String>? aliases);

  PagesBuildConfig? get buildConfig;
  set buildConfig(PagesBuildConfig? buildConfig);
  ...
  set deploymentTrigger(
      PagesDeploymentsDeploymentTriggerBuilder? deploymentTrigger);
  ...
  set environment(PagesDeploymentsEnvironmentEnum? environment);

  String? get id;
  set id(String? id);

  bool? get isSkipped;
  set isSkipped(bool? isSkipped);

  PagesStageBuilder get latestStage;
  set latestStage(PagesStageBuilder? latestStage);
  ...
  String? get shortId;
  set shortId(String? shortId);

  PagesSourceBuilder get source_;
  set source_(PagesSourceBuilder? source_);

  ListBuilder<PagesStage> get stages;
  set stages(ListBuilder<PagesStage>? stages);

  String? get url;
  set url(String? url);
}

class _$$PagesDeployments extends $PagesDeployments {
  @override
  ...
  factory _$$PagesDeployments(
          [void Function($PagesDeploymentsBuilder)? updates]) =>
      ($PagesDeploymentsBuilder()..update(updates))._build();

  _$$PagesDeployments._(
      {this.aliases,
      this.buildConfig,
      this.createdOn,
      ...
      : super._();
  @override
  $PagesDeployments rebuild(void Function($PagesDeploymentsBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  $PagesDeploymentsBuilder toBuilder() =>
      $PagesDeploymentsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is $PagesDeployments &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'$PagesDeployments')
          ..add('aliases', aliases)
...
class $PagesDeploymentsBuilder
    implements
        Builder<$PagesDeployments, $PagesDeploymentsBuilder>,
        PagesDeploymentsBuilder {
  _$$PagesDeployments? _$v;
  ...
  $PagesDeploymentsBuilder() {
    $PagesDeployments._defaults(this);
  }

  $PagesDeploymentsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant $PagesDeployments other) {
    _$v = other as _$$PagesDeployments;
  }
  ...
  @override
  $PagesDeployments build() => _build();

  _$$PagesDeployments _build() {
    _$$PagesDeployments _$result;
    try {
      _$result = _$v ??
          _$$PagesDeployments._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'$PagesDeployments', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
