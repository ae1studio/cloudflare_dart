...
part 'access_service_tokens_update_a_service_token_request.g.dart';
...
@BuiltValue()
abstract class AccessServiceTokensUpdateAServiceTokenRequest implements Built<AccessServiceTokensUpdateAServiceTokenRequest, AccessServiceTokensUpdateAServiceTokenRequestBuilder> {
  ...
  AccessServiceTokensUpdateAServiceTokenRequest._();

  factory AccessServiceTokensUpdateAServiceTokenRequest([void updates(AccessServiceTokensUpdateAServiceTokenRequestBuilder b)]) = _$AccessServiceTokensUpdateAServiceTokenRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AccessServiceTokensUpdateAServiceTokenRequestBuilder b) => b
      ..clientSecretVersion = 1
      ..duration = '8760h';

  @BuiltValueSerializer(custom: true)
  static Serializer<AccessServiceTokensUpdateAServiceTokenRequest> get serializer => _$AccessServiceTokensUpdateAServiceTokenRequestSerializer();
}

class _$AccessServiceTokensUpdateAServiceTokenRequestSerializer implements PrimitiveSerializer<AccessServiceTokensUpdateAServiceTokenRequest> {
  @override
  final Iterable<Type> types = const [AccessServiceTokensUpdateAServiceTokenRequest, _$AccessServiceTokensUpdateAServiceTokenRequest];

  @override
  final String wireName = r'AccessServiceTokensUpdateAServiceTokenRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccessServiceTokensUpdateAServiceTokenRequest object, {
  ...
  void _deserializeProperties(
    ...
    required AccessServiceTokensUpdateAServiceTokenRequestBuilder result,
  ...
  @override
  AccessServiceTokensUpdateAServiceTokenRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccessServiceTokensUpdateAServiceTokenRequestBuilder();
