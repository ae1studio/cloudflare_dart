...
part of 'dns_firewall_dns_firewall_cluster_post.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DnsFirewallDnsFirewallClusterPost
    extends DnsFirewallDnsFirewallClusterPost {
  @override
  ...
  factory _$DnsFirewallDnsFirewallClusterPost(
          [void Function(DnsFirewallDnsFirewallClusterPostBuilder)? updates]) =>
      (DnsFirewallDnsFirewallClusterPostBuilder()..update(updates))._build();

  _$DnsFirewallDnsFirewallClusterPost._(
      ...
      : super._();
  @override
  DnsFirewallDnsFirewallClusterPost rebuild(
          void Function(DnsFirewallDnsFirewallClusterPostBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  DnsFirewallDnsFirewallClusterPostBuilder toBuilder() =>
      DnsFirewallDnsFirewallClusterPostBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DnsFirewallDnsFirewallClusterPost &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DnsFirewallDnsFirewallClusterPost')
...
class DnsFirewallDnsFirewallClusterPostBuilder
    implements
        Builder<DnsFirewallDnsFirewallClusterPost,
            DnsFirewallDnsFirewallClusterPostBuilder>,
        DnsFirewallDnsFirewallClusterBuilder {
  _$DnsFirewallDnsFirewallClusterPost? _$v;
  ...
  DnsFirewallDnsFirewallClusterPostBuilder() {
    DnsFirewallDnsFirewallClusterPost._defaults(this);
  }

  DnsFirewallDnsFirewallClusterPostBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant DnsFirewallDnsFirewallClusterPost other) {
    _$v = other as _$DnsFirewallDnsFirewallClusterPost;
  }
  ...
  @override
  DnsFirewallDnsFirewallClusterPost build() => _build();

  _$DnsFirewallDnsFirewallClusterPost _build() {
    _$DnsFirewallDnsFirewallClusterPost _$result;
    try {
      _$result = _$v ??
          _$DnsFirewallDnsFirewallClusterPost._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'DnsFirewallDnsFirewallClusterPost', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
