...
@BuiltValue()
abstract class TextGeneration implements Built<TextGeneration, TextGenerationBuilder> {
  /// One Of [Messages1], [Prompt1]
  OneOf get oneOf;

  TextGeneration._();

  factory TextGeneration([void updates(TextGenerationBuilder b)]) = _$TextGeneration;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TextGenerationBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<TextGeneration> get serializer => _$TextGenerationSerializer();
}

class _$TextGenerationSerializer implements PrimitiveSerializer<TextGeneration> {
  @override
  final Iterable<Type> types = const [TextGeneration, _$TextGeneration];

  @override
  final String wireName = r'TextGeneration';
  ...
  @override
  TextGeneration deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = TextGenerationBuilder();
    Object? oneOfDataSrc;
