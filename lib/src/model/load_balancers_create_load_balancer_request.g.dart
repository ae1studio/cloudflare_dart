...
part of 'load_balancers_create_load_balancer_request.dart';
...
class _$LoadBalancersCreateLoadBalancerRequest
  ...
  factory _$LoadBalancersCreateLoadBalancerRequest(
          [void Function(LoadBalancersCreateLoadBalancerRequestBuilder)?
              updates]) =>
      (LoadBalancersCreateLoadBalancerRequestBuilder()..update(updates))
          ._build();
  ...
  _$LoadBalancersCreateLoadBalancerRequest._(
      ...
      : super._();
  @override
  LoadBalancersCreateLoadBalancerRequest rebuild(
          void Function(LoadBalancersCreateLoadBalancerRequestBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  LoadBalancersCreateLoadBalancerRequestBuilder toBuilder() =>
      LoadBalancersCreateLoadBalancerRequestBuilder()..replace(this);
...
class LoadBalancersCreateLoadBalancerRequestBuilder
    implements
        Builder<LoadBalancersCreateLoadBalancerRequest,
  ...
  LoadBalancersCreateLoadBalancerRequestBuilder() {
    LoadBalancersCreateLoadBalancerRequest._defaults(this);
  }
  ...
  @override
  void replace(LoadBalancersCreateLoadBalancerRequest other) {
    _$v = other as _$LoadBalancersCreateLoadBalancerRequest;
  }

  @override
  void update(
      void Function(LoadBalancersCreateLoadBalancerRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  LoadBalancersCreateLoadBalancerRequest build() => _build();

  _$LoadBalancersCreateLoadBalancerRequest _build() {
    _$LoadBalancersCreateLoadBalancerRequest _$result;
    try {
      _$result = _$v ??
          _$LoadBalancersCreateLoadBalancerRequest._(
