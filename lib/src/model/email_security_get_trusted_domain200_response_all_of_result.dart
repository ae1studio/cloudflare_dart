...
part 'email_security_get_trusted_domain200_response_all_of_result.g.dart';
...
abstract class EmailSecurityGetTrustedDomain200ResponseAllOfResult implements Built<EmailSecurityGetTrustedDomain200ResponseAllOfResult, EmailSecurityGetTrustedDomain200ResponseAllOfResultBuilder> {
  ...
  static void _defaults(EmailSecurityGetTrustedDomain200ResponseAllOfResultBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<EmailSecurityGetTrustedDomain200ResponseAllOfResult> get serializer => _$EmailSecurityGetTrustedDomain200ResponseAllOfResultSerializer();
}

class _$EmailSecurityGetTrustedDomain200ResponseAllOfResultSerializer implements PrimitiveSerializer<EmailSecurityGetTrustedDomain200ResponseAllOfResult> {
  @override
  final Iterable<Type> types = const [EmailSecurityGetTrustedDomain200ResponseAllOfResult, _$EmailSecurityGetTrustedDomain200ResponseAllOfResult];

  @override
  final String wireName = r'EmailSecurityGetTrustedDomain200ResponseAllOfResult';
  ...
  void _deserializeProperties(
    ...
    required EmailSecurityGetTrustedDomain200ResponseAllOfResultBuilder result,
  ...
  @override
  EmailSecurityGetTrustedDomain200ResponseAllOfResult deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = EmailSecurityGetTrustedDomain200ResponseAllOfResultBuilder();
