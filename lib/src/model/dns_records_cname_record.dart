...
part 'dns_records_cname_record.g.dart';
...
/// * [type] - Record type.
@BuiltValue()
abstract class DnsRecordsCNAMERecord implements DnsRecordsDnsRecordSharedFields, Built<DnsRecordsCNAMERecord, DnsRecordsCNAMERecordBuilder> {
  /// Record type.
  @BuiltValueField(wireName: r'type')
  DnsRecordsCNAMERecordTypeEnum? get type;
  // enum typeEnum {  CNAME,  };
  ...
  DnsRecordsCNAMERecord._();

  factory DnsRecordsCNAMERecord([void updates(DnsRecordsCNAMERecordBuilder b)]) = _$DnsRecordsCNAMERecord;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DnsRecordsCNAMERecordBuilder b) => b
      ..proxied = false
      ..tags = ListBuilder();

  @BuiltValueSerializer(custom: true)
  static Serializer<DnsRecordsCNAMERecord> get serializer => _$DnsRecordsCNAMERecordSerializer();
}

class _$DnsRecordsCNAMERecordSerializer implements PrimitiveSerializer<DnsRecordsCNAMERecord> {
  @override
  final Iterable<Type> types = const [DnsRecordsCNAMERecord, _$DnsRecordsCNAMERecord];

  @override
  final String wireName = r'DnsRecordsCNAMERecord';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    DnsRecordsCNAMERecord object, {
    ...
    if (object.type != null) {
      ...
      yield serializers.serialize(
        object.type,
        specifiedType: const FullType(DnsRecordsCNAMERecordTypeEnum),
      );
    }
    if (object.ttl != null) {
      yield r'ttl';
  ...
  void _deserializeProperties(
    ...
    required DnsRecordsCNAMERecordBuilder result,
      ...
      switch (key) {
        ...
        case r'type':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(DnsRecordsCNAMERecordTypeEnum),
          ) as DnsRecordsCNAMERecordTypeEnum;
  ...
  @override
  DnsRecordsCNAMERecord deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DnsRecordsCNAMERecordBuilder();
...
class DnsRecordsCNAMERecordTypeEnum extends EnumClass {
