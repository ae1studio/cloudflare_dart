...
class ZoneLevelAuthenticatedOriginPullsGetEnablementSettingForZone4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<ZoneLevelAuthenticatedOriginPullsGetEnablementSettingForZone4XXResponseResultEnum> get serializer => _$zoneLevelAuthenticatedOriginPullsGetEnablementSettingForZone4XXResponseResultEnumSerializer;

  const ZoneLevelAuthenticatedOriginPullsGetEnablementSettingForZone4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<ZoneLevelAuthenticatedOriginPullsGetEnablementSettingForZone4XXResponseResultEnum> get values => _$zoneLevelAuthenticatedOriginPullsGetEnablementSettingForZone4XXResponseResultEnumValues;
  static ZoneLevelAuthenticatedOriginPullsGetEnablementSettingForZone4XXResponseResultEnum valueOf(String name) => _$zoneLevelAuthenticatedOriginPullsGetEnablementSettingForZone4XXResponseResultEnumValueOf(name);
}
