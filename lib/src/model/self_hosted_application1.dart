...
part 'self_hosted_application1.g.dart';
...
/// * [policies] 
@BuiltValue()
abstract class SelfHostedApplication1 implements AccessAppRespEmbeddedPolicies, AccessBasicAppResponseProps, AccessSelfHostedProps, Built<SelfHostedApplication1, SelfHostedApplication1Builder> {
  SelfHostedApplication1._();

  factory SelfHostedApplication1([void updates(SelfHostedApplication1Builder b)]) = _$SelfHostedApplication1;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SelfHostedApplication1Builder b) => b
  ...
  static Serializer<SelfHostedApplication1> get serializer => _$SelfHostedApplication1Serializer();
}

class _$SelfHostedApplication1Serializer implements PrimitiveSerializer<SelfHostedApplication1> {
  @override
  final Iterable<Type> types = const [SelfHostedApplication1, _$SelfHostedApplication1];

  @override
  final String wireName = r'SelfHostedApplication1';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SelfHostedApplication1 object, {
  ...
  void _deserializeProperties(
    ...
    required SelfHostedApplication1Builder result,
  ...
  @override
  SelfHostedApplication1 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SelfHostedApplication1Builder();
