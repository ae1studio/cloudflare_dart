...
part of 'workers_script_response_collection_all_of_result.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$WorkersScriptResponseCollectionAllOfResult
    extends WorkersScriptResponseCollectionAllOfResult {
  @override
  final BuiltList<WorkersRoute>? routes;
  @override
  ...
  factory _$WorkersScriptResponseCollectionAllOfResult(
          [void Function(WorkersScriptResponseCollectionAllOfResultBuilder)?
              updates]) =>
      (WorkersScriptResponseCollectionAllOfResultBuilder()..update(updates))
          ._build();

  _$WorkersScriptResponseCollectionAllOfResult._(
      {this.routes,
      ...
      : super._();
  @override
  WorkersScriptResponseCollectionAllOfResult rebuild(
          void Function(WorkersScriptResponseCollectionAllOfResultBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  WorkersScriptResponseCollectionAllOfResultBuilder toBuilder() =>
      WorkersScriptResponseCollectionAllOfResultBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is WorkersScriptResponseCollectionAllOfResult &&
        routes == other.routes &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'WorkersScriptResponseCollectionAllOfResult')
          ..add('routes', routes)
...
class WorkersScriptResponseCollectionAllOfResultBuilder
    implements
        Builder<WorkersScriptResponseCollectionAllOfResult,
            WorkersScriptResponseCollectionAllOfResultBuilder>,
        WorkersScriptResponseBuilder {
  _$WorkersScriptResponseCollectionAllOfResult? _$v;

  ListBuilder<WorkersRoute>? _routes;
  ListBuilder<WorkersRoute> get routes =>
      _$this._routes ??= ListBuilder<WorkersRoute>();
  set routes(covariant ListBuilder<WorkersRoute>? routes) =>
  ...
  WorkersScriptResponseCollectionAllOfResultBuilder() {
    WorkersScriptResponseCollectionAllOfResult._defaults(this);
  }

  WorkersScriptResponseCollectionAllOfResultBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant WorkersScriptResponseCollectionAllOfResult other) {
    _$v = other as _$WorkersScriptResponseCollectionAllOfResult;
  }
  ...
  @override
  WorkersScriptResponseCollectionAllOfResult build() => _build();

  _$WorkersScriptResponseCollectionAllOfResult _build() {
    _$WorkersScriptResponseCollectionAllOfResult _$result;
    try {
      _$result = _$v ??
          _$WorkersScriptResponseCollectionAllOfResult._(
