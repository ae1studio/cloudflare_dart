...
@BuiltValue()
abstract class RulesetsLogRule implements RulesetsRule, Built<RulesetsLogRule, RulesetsLogRuleBuilder> {
  RulesetsLogRule._();

  factory RulesetsLogRule([void updates(RulesetsLogRuleBuilder b)]) = _$RulesetsLogRule;
  ...
  static Serializer<RulesetsLogRule> get serializer => _$RulesetsLogRuleSerializer();
}

class _$RulesetsLogRuleSerializer implements PrimitiveSerializer<RulesetsLogRule> {
  @override
  final Iterable<Type> types = const [RulesetsLogRule, _$RulesetsLogRule];

  @override
  final String wireName = r'RulesetsLogRule';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RulesetsLogRule object, {
  ...
  void _deserializeProperties(
    ...
    required RulesetsLogRuleBuilder result,
  ...
  @override
  RulesetsLogRule deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RulesetsLogRuleBuilder();
...
class RulesetsLogRuleActionEnum extends EnumClass {
