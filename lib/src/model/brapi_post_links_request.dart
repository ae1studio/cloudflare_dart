...
part 'brapi_post_links_request.g.dart';
...
@BuiltValue()
abstract class BrapiPostLinksRequest implements Built<BrapiPostLinksRequest, BrapiPostLinksRequestBuilder> {
  ...
  BuiltList<BrapiPostLinksRequestAllOfAllowResourceTypes>? get allowResourceTypes;
  ...
  @BuiltValueField(wireName: r'excludeExternalLinks')
  bool? get excludeExternalLinks;
  ...
  BuiltList<BrapiPostLinksRequestAllOfRejectResourceTypes>? get rejectResourceTypes;
  ...
  @BuiltValueField(wireName: r'visibleLinksOnly')
  bool? get visibleLinksOnly;
  ...
  BrapiPostLinksRequest._();

  factory BrapiPostLinksRequest([void updates(BrapiPostLinksRequestBuilder b)]) = _$BrapiPostLinksRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BrapiPostLinksRequestBuilder b) => b
      ..excludeExternalLinks = false
      ..userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36'
      ..visibleLinksOnly = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<BrapiPostLinksRequest> get serializer => _$BrapiPostLinksRequestSerializer();
}

class _$BrapiPostLinksRequestSerializer implements PrimitiveSerializer<BrapiPostLinksRequest> {
  @override
  final Iterable<Type> types = const [BrapiPostLinksRequest, _$BrapiPostLinksRequest];

  @override
  final String wireName = r'BrapiPostLinksRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BrapiPostLinksRequest object, {
    ...
    if (object.allowResourceTypes != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(BrapiPostLinksRequestAllOfAllowResourceTypes)]),
      );
    }
    ...
    if (object.excludeExternalLinks != null) {
      yield r'excludeExternalLinks';
      yield serializers.serialize(
        object.excludeExternalLinks,
        specifiedType: const FullType(bool),
      );
    }
    ...
    if (object.rejectResourceTypes != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(BrapiPostLinksRequestAllOfRejectResourceTypes)]),
      );
    }
    ...
    if (object.visibleLinksOnly != null) {
      yield r'visibleLinksOnly';
      yield serializers.serialize(
        object.visibleLinksOnly,
        specifiedType: const FullType(bool),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required BrapiPostLinksRequestBuilder result,
      ...
      switch (key) {
        ...
        case r'allowResourceTypes':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(BrapiPostLinksRequestAllOfAllowResourceTypes)]),
          ) as BuiltList<BrapiPostLinksRequestAllOfAllowResourceTypes>;
        ...
        case r'emulateMediaType':
          ...
          break;
        case r'excludeExternalLinks':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          ) as bool;
          result.excludeExternalLinks = valueDes;
          break;
        case r'gotoOptions':
          final valueDes = serializers.deserialize(
            value,
        ...
        case r'rejectResourceTypes':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(BrapiPostLinksRequestAllOfRejectResourceTypes)]),
          ) as BuiltList<BrapiPostLinksRequestAllOfRejectResourceTypes>;
        ...
        case r'viewport':
          ...
          break;
        case r'visibleLinksOnly':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          ) as bool;
          result.visibleLinksOnly = valueDes;
          break;
  ...
  @override
  BrapiPostLinksRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BrapiPostLinksRequestBuilder();
