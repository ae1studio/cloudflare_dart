...
part 'access_certificates.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class AccessCertificates implements Built<AccessCertificates, AccessCertificatesBuilder> {
  ...
  factory AccessCertificates([void updates(AccessCertificatesBuilder b)]) = _$AccessCertificates;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AccessCertificatesBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AccessCertificates> get serializer => _$AccessCertificatesSerializer();
}

class _$AccessCertificatesSerializer implements PrimitiveSerializer<AccessCertificates> {
  @override
  final Iterable<Type> types = const [AccessCertificates, _$AccessCertificates];

  @override
  final String wireName = r'AccessCertificates';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccessCertificates object, {
  ...
  void _deserializeProperties(
    ...
    required AccessCertificatesBuilder result,
  ...
  @override
  AccessCertificates deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccessCertificatesBuilder();
