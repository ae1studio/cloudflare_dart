...
part 'dos_new_dns_protection_rule.g.dart';
...
@BuiltValue()
abstract class DosNewDnsProtectionRule implements Built<DosNewDnsProtectionRule, DosNewDnsProtectionRuleBuilder> {
  ...
  DosNewDnsProtectionRule._();

  factory DosNewDnsProtectionRule([void updates(DosNewDnsProtectionRuleBuilder b)]) = _$DosNewDnsProtectionRule;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DosNewDnsProtectionRuleBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DosNewDnsProtectionRule> get serializer => _$DosNewDnsProtectionRuleSerializer();
}

class _$DosNewDnsProtectionRuleSerializer implements PrimitiveSerializer<DosNewDnsProtectionRule> {
  @override
  final Iterable<Type> types = const [DosNewDnsProtectionRule, _$DosNewDnsProtectionRule];

  @override
  final String wireName = r'DosNewDnsProtectionRule';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    DosNewDnsProtectionRule object, {
  ...
  void _deserializeProperties(
    ...
    required DosNewDnsProtectionRuleBuilder result,
  ...
  @override
  DosNewDnsProtectionRule deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DosNewDnsProtectionRuleBuilder();
