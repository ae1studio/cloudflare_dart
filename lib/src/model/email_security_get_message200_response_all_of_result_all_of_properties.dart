...
class EmailSecurityGetMessage200ResponseAllOfResultAllOfPropertiesAllowlistedPatternTypeEnum extends EnumClass {
  ...
  static Serializer<EmailSecurityGetMessage200ResponseAllOfResultAllOfPropertiesAllowlistedPatternTypeEnum> get serializer => _$emailSecurityGetMessage200ResponseAllOfResultAllOfPropertiesAllowlistedPatternTypeSerializer;

  const EmailSecurityGetMessage200ResponseAllOfResultAllOfPropertiesAllowlistedPatternTypeEnum._(String name): super(name);

  static BuiltSet<EmailSecurityGetMessage200ResponseAllOfResultAllOfPropertiesAllowlistedPatternTypeEnum> get values => _$emailSecurityGetMessage200ResponseAllOfResultAllOfPropertiesAllowlistedPatternTypeValues;
  static EmailSecurityGetMessage200ResponseAllOfResultAllOfPropertiesAllowlistedPatternTypeEnum valueOf(String name) => _$emailSecurityGetMessage200ResponseAllOfResultAllOfPropertiesAllowlistedPatternTypeValueOf(name);
}
...
class EmailSecurityGetMessage200ResponseAllOfResultAllOfPropertiesWhitelistedPatternTypeEnum extends EnumClass {
  ...
  static Serializer<EmailSecurityGetMessage200ResponseAllOfResultAllOfPropertiesWhitelistedPatternTypeEnum> get serializer => _$emailSecurityGetMessage200ResponseAllOfResultAllOfPropertiesWhitelistedPatternTypeSerializer;

  const EmailSecurityGetMessage200ResponseAllOfResultAllOfPropertiesWhitelistedPatternTypeEnum._(String name): super(name);

  static BuiltSet<EmailSecurityGetMessage200ResponseAllOfResultAllOfPropertiesWhitelistedPatternTypeEnum> get values => _$emailSecurityGetMessage200ResponseAllOfResultAllOfPropertiesWhitelistedPatternTypeValues;
  static EmailSecurityGetMessage200ResponseAllOfResultAllOfPropertiesWhitelistedPatternTypeEnum valueOf(String name) => _$emailSecurityGetMessage200ResponseAllOfResultAllOfPropertiesWhitelistedPatternTypeValueOf(name);
}
