...
part 'magic_ipsec_tunnel_update_request.g.dart';
...
@BuiltValue()
abstract class MagicIpsecTunnelUpdateRequest implements MagicIpsecTunnelAddSingleRequest, Built<MagicIpsecTunnelUpdateRequest, MagicIpsecTunnelUpdateRequestBuilder> {
  MagicIpsecTunnelUpdateRequest._();

  factory MagicIpsecTunnelUpdateRequest([void updates(MagicIpsecTunnelUpdateRequestBuilder b)]) = _$MagicIpsecTunnelUpdateRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MagicIpsecTunnelUpdateRequestBuilder b) => b
      ..automaticReturnRouting = false
      ..replayProtection = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<MagicIpsecTunnelUpdateRequest> get serializer => _$MagicIpsecTunnelUpdateRequestSerializer();
}

class _$MagicIpsecTunnelUpdateRequestSerializer implements PrimitiveSerializer<MagicIpsecTunnelUpdateRequest> {
  @override
  final Iterable<Type> types = const [MagicIpsecTunnelUpdateRequest, _$MagicIpsecTunnelUpdateRequest];

  @override
  final String wireName = r'MagicIpsecTunnelUpdateRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    MagicIpsecTunnelUpdateRequest object, {
  ...
  void _deserializeProperties(
    ...
    required MagicIpsecTunnelUpdateRequestBuilder result,
  ...
  @override
  MagicIpsecTunnelUpdateRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MagicIpsecTunnelUpdateRequestBuilder();
