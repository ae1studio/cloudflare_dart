...
part 'magic_create_gre_tunnel_request.g.dart';
...
@BuiltValue()
abstract class MagicCreateGreTunnelRequest implements Built<MagicCreateGreTunnelRequest, MagicCreateGreTunnelRequestBuilder> {
  ...
  MagicCreateGreTunnelRequest._();

  factory MagicCreateGreTunnelRequest([void updates(MagicCreateGreTunnelRequestBuilder b)]) = _$MagicCreateGreTunnelRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MagicCreateGreTunnelRequestBuilder b) => b
      ..automaticReturnRouting = false
      ..mtu = 1476
      ..ttl = 64;

  @BuiltValueSerializer(custom: true)
  static Serializer<MagicCreateGreTunnelRequest> get serializer => _$MagicCreateGreTunnelRequestSerializer();
}

class _$MagicCreateGreTunnelRequestSerializer implements PrimitiveSerializer<MagicCreateGreTunnelRequest> {
  @override
  final Iterable<Type> types = const [MagicCreateGreTunnelRequest, _$MagicCreateGreTunnelRequest];

  @override
  final String wireName = r'MagicCreateGreTunnelRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    MagicCreateGreTunnelRequest object, {
  ...
  void _deserializeProperties(
    ...
    required MagicCreateGreTunnelRequestBuilder result,
  ...
  @override
  MagicCreateGreTunnelRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MagicCreateGreTunnelRequestBuilder();
