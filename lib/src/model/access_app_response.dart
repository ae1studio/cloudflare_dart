...
part 'access_app_response.g.dart';
...
abstract class AccessAppResponse implements Built<AccessAppResponse, AccessAppResponseBuilder> {
  ...
  factory AccessAppResponse([void updates(AccessAppResponseBuilder b)]) = _$AccessAppResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AccessAppResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AccessAppResponse> get serializer => _$AccessAppResponseSerializer();
}

class _$AccessAppResponseSerializer implements PrimitiveSerializer<AccessAppResponse> {
  @override
  final Iterable<Type> types = const [AccessAppResponse, _$AccessAppResponse];

  @override
  final String wireName = r'AccessAppResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccessAppResponse object, {
  ...
  @override
  AccessAppResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccessAppResponseBuilder();
    Object? anyOfDataSrc;
    final targetType = const FullType(AnyOf, [FullType(SelfHostedApplication1), FullType(SaaSApplication1), FullType(BrowserSSHApplication1), FullType(BrowserVNCApplication1), FullType(AppLauncherApplication1), FullType(DeviceEnrollmentPermissionsApplication1), FullType(BrowserIsolationPermissionsApplication1), FullType(BookmarkApplication), FullType(InfrastructureApplication1), FullType(BrowserRDPApplication1), ]);
