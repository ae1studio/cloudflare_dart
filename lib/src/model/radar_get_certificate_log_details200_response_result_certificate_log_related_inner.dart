...
class RadarGetCertificateLogDetails200ResponseResultCertificateLogRelatedInnerStateEnum extends EnumClass {
  ...
  static Serializer<RadarGetCertificateLogDetails200ResponseResultCertificateLogRelatedInnerStateEnum> get serializer => _$radarGetCertificateLogDetails200ResponseResultCertificateLogRelatedInnerStateSerializer;

  const RadarGetCertificateLogDetails200ResponseResultCertificateLogRelatedInnerStateEnum._(String name): super(name);

  static BuiltSet<RadarGetCertificateLogDetails200ResponseResultCertificateLogRelatedInnerStateEnum> get values => _$radarGetCertificateLogDetails200ResponseResultCertificateLogRelatedInnerStateValues;
  static RadarGetCertificateLogDetails200ResponseResultCertificateLogRelatedInnerStateEnum valueOf(String name) => _$radarGetCertificateLogDetails200ResponseResultCertificateLogRelatedInnerStateValueOf(name);
}
