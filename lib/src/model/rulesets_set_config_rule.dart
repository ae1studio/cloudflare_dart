...
part 'rulesets_set_config_rule.g.dart';
...
@BuiltValue()
abstract class RulesetsSetConfigRule implements RulesetsRule, Built<RulesetsSetConfigRule, RulesetsSetConfigRuleBuilder> {
  RulesetsSetConfigRule._();

  factory RulesetsSetConfigRule([void updates(RulesetsSetConfigRuleBuilder b)]) = _$RulesetsSetConfigRule;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RulesetsSetConfigRuleBuilder b) => b
      ..description = ''
      ..enabled = true
      ..actionParameters = {};

  @BuiltValueSerializer(custom: true)
  static Serializer<RulesetsSetConfigRule> get serializer => _$RulesetsSetConfigRuleSerializer();
}

class _$RulesetsSetConfigRuleSerializer implements PrimitiveSerializer<RulesetsSetConfigRule> {
  @override
  final Iterable<Type> types = const [RulesetsSetConfigRule, _$RulesetsSetConfigRule];

  @override
  final String wireName = r'RulesetsSetConfigRule';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RulesetsSetConfigRule object, {
  ...
  void _deserializeProperties(
    ...
    required RulesetsSetConfigRuleBuilder result,
  ...
  @override
  RulesetsSetConfigRule deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RulesetsSetConfigRuleBuilder();
...
class RulesetsSetConfigRuleActionEnum extends EnumClass {

  @BuiltValueEnumConst(wireName: r'set_config')
  static const RulesetsSetConfigRuleActionEnum setConfig = _$rulesetsSetConfigRuleActionEnum_setConfig;

  static Serializer<RulesetsSetConfigRuleActionEnum> get serializer => _$rulesetsSetConfigRuleActionEnumSerializer;

  const RulesetsSetConfigRuleActionEnum._(String name): super(name);

  static BuiltSet<RulesetsSetConfigRuleActionEnum> get values => _$rulesetsSetConfigRuleActionEnumValues;
  static RulesetsSetConfigRuleActionEnum valueOf(String name) => _$rulesetsSetConfigRuleActionEnumValueOf(name);
}
