...
class ZoneAnalyticsDeprecatedGetAnalyticsByCoLocations4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<ZoneAnalyticsDeprecatedGetAnalyticsByCoLocations4XXResponseResultEnum> get serializer => _$zoneAnalyticsDeprecatedGetAnalyticsByCoLocations4XXResponseResultEnumSerializer;

  const ZoneAnalyticsDeprecatedGetAnalyticsByCoLocations4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<ZoneAnalyticsDeprecatedGetAnalyticsByCoLocations4XXResponseResultEnum> get values => _$zoneAnalyticsDeprecatedGetAnalyticsByCoLocations4XXResponseResultEnumValues;
  static ZoneAnalyticsDeprecatedGetAnalyticsByCoLocations4XXResponseResultEnum valueOf(String name) => _$zoneAnalyticsDeprecatedGetAnalyticsByCoLocations4XXResponseResultEnumValueOf(name);
}
