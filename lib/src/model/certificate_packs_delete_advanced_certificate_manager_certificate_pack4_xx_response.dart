...
class CertificatePacksDeleteAdvancedCertificateManagerCertificatePack4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<CertificatePacksDeleteAdvancedCertificateManagerCertificatePack4XXResponseResultEnum> get serializer => _$certificatePacksDeleteAdvancedCertificateManagerCertificatePack4XXResponseResultEnumSerializer;

  const CertificatePacksDeleteAdvancedCertificateManagerCertificatePack4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<CertificatePacksDeleteAdvancedCertificateManagerCertificatePack4XXResponseResultEnum> get values => _$certificatePacksDeleteAdvancedCertificateManagerCertificatePack4XXResponseResultEnumValues;
  static CertificatePacksDeleteAdvancedCertificateManagerCertificatePack4XXResponseResultEnum valueOf(String name) => _$certificatePacksDeleteAdvancedCertificateManagerCertificatePack4XXResponseResultEnumValueOf(name);
}
