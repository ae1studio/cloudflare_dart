...
class PutV4AccountsByAccountIdPipelinesByPipelineNameDeprecatedRequestDestinationFormatEnum extends EnumClass {
  ...
  static Serializer<PutV4AccountsByAccountIdPipelinesByPipelineNameDeprecatedRequestDestinationFormatEnum> get serializer => _$putV4AccountsByAccountIdPipelinesByPipelineNameDeprecatedRequestDestinationFormatSerializer;

  const PutV4AccountsByAccountIdPipelinesByPipelineNameDeprecatedRequestDestinationFormatEnum._(String name): super(name);

  static BuiltSet<PutV4AccountsByAccountIdPipelinesByPipelineNameDeprecatedRequestDestinationFormatEnum> get values => _$putV4AccountsByAccountIdPipelinesByPipelineNameDeprecatedRequestDestinationFormatValues;
  static PutV4AccountsByAccountIdPipelinesByPipelineNameDeprecatedRequestDestinationFormatEnum valueOf(String name) => _$putV4AccountsByAccountIdPipelinesByPipelineNameDeprecatedRequestDestinationFormatValueOf(name);
}
...
class PutV4AccountsByAccountIdPipelinesByPipelineNameDeprecatedRequestDestinationTypeEnum extends EnumClass {
  ...
  static Serializer<PutV4AccountsByAccountIdPipelinesByPipelineNameDeprecatedRequestDestinationTypeEnum> get serializer => _$putV4AccountsByAccountIdPipelinesByPipelineNameDeprecatedRequestDestinationTypeSerializer;

  const PutV4AccountsByAccountIdPipelinesByPipelineNameDeprecatedRequestDestinationTypeEnum._(String name): super(name);

  static BuiltSet<PutV4AccountsByAccountIdPipelinesByPipelineNameDeprecatedRequestDestinationTypeEnum> get values => _$putV4AccountsByAccountIdPipelinesByPipelineNameDeprecatedRequestDestinationTypeValues;
  static PutV4AccountsByAccountIdPipelinesByPipelineNameDeprecatedRequestDestinationTypeEnum valueOf(String name) => _$putV4AccountsByAccountIdPipelinesByPipelineNameDeprecatedRequestDestinationTypeValueOf(name);
}
