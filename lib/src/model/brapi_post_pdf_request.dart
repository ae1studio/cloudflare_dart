...
part 'brapi_post_pdf_request.g.dart';
...
@BuiltValue()
abstract class BrapiPostPdfRequest implements Built<BrapiPostPdfRequest, BrapiPostPdfRequestBuilder> {
  ...
  BuiltList<BrapiPostPdfRequestAllOfAllowResourceTypes>? get allowResourceTypes;
  ...
  @BuiltValueField(wireName: r'pdfOptions')
  BrapiPostPdfRequestAllOfPdfOptions? get pdfOptions;
  ...
  BuiltList<BrapiPostPdfRequestAllOfRejectResourceTypes>? get rejectResourceTypes;
  ...
  BrapiPostPdfRequest._();

  factory BrapiPostPdfRequest([void updates(BrapiPostPdfRequestBuilder b)]) = _$BrapiPostPdfRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BrapiPostPdfRequestBuilder b) => b
      ..userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36';

  @BuiltValueSerializer(custom: true)
  static Serializer<BrapiPostPdfRequest> get serializer => _$BrapiPostPdfRequestSerializer();
}

class _$BrapiPostPdfRequestSerializer implements PrimitiveSerializer<BrapiPostPdfRequest> {
  @override
  final Iterable<Type> types = const [BrapiPostPdfRequest, _$BrapiPostPdfRequest];

  @override
  final String wireName = r'BrapiPostPdfRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BrapiPostPdfRequest object, {
    ...
    if (object.allowResourceTypes != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(BrapiPostPdfRequestAllOfAllowResourceTypes)]),
      );
    }
    ...
    if (object.pdfOptions != null) {
      yield r'pdfOptions';
      yield serializers.serialize(
        object.pdfOptions,
        specifiedType: const FullType(BrapiPostPdfRequestAllOfPdfOptions),
      );
    }
    ...
    if (object.rejectResourceTypes != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(BrapiPostPdfRequestAllOfRejectResourceTypes)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required BrapiPostPdfRequestBuilder result,
      ...
      switch (key) {
        ...
        case r'allowResourceTypes':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(BrapiPostPdfRequestAllOfAllowResourceTypes)]),
          ) as BuiltList<BrapiPostPdfRequestAllOfAllowResourceTypes>;
        ...
        case r'pdfOptions':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BrapiPostPdfRequestAllOfPdfOptions),
          ) as BrapiPostPdfRequestAllOfPdfOptions;
          result.pdfOptions.replace(valueDes);
          break;
        ...
        case r'rejectResourceTypes':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(BrapiPostPdfRequestAllOfRejectResourceTypes)]),
          ) as BuiltList<BrapiPostPdfRequestAllOfRejectResourceTypes>;
  ...
  @override
  BrapiPostPdfRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BrapiPostPdfRequestBuilder();
