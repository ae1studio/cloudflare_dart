...
part 'notification_policies_create_a_notification_policy_request.g.dart';
...
abstract class NotificationPoliciesCreateANotificationPolicyRequest implements Built<NotificationPoliciesCreateANotificationPolicyRequest, NotificationPoliciesCreateANotificationPolicyRequestBuilder> {
  ...
  factory NotificationPoliciesCreateANotificationPolicyRequest([void updates(NotificationPoliciesCreateANotificationPolicyRequestBuilder b)]) = _$NotificationPoliciesCreateANotificationPolicyRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(NotificationPoliciesCreateANotificationPolicyRequestBuilder b) => b
      ..enabled = true;

  @BuiltValueSerializer(custom: true)
  static Serializer<NotificationPoliciesCreateANotificationPolicyRequest> get serializer => _$NotificationPoliciesCreateANotificationPolicyRequestSerializer();
}

class _$NotificationPoliciesCreateANotificationPolicyRequestSerializer implements PrimitiveSerializer<NotificationPoliciesCreateANotificationPolicyRequest> {
  @override
  final Iterable<Type> types = const [NotificationPoliciesCreateANotificationPolicyRequest, _$NotificationPoliciesCreateANotificationPolicyRequest];

  @override
  final String wireName = r'NotificationPoliciesCreateANotificationPolicyRequest';
  ...
  void _deserializeProperties(
    ...
    required NotificationPoliciesCreateANotificationPolicyRequestBuilder result,
  ...
  @override
  NotificationPoliciesCreateANotificationPolicyRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = NotificationPoliciesCreateANotificationPolicyRequestBuilder();
