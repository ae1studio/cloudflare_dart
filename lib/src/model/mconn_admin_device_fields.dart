...
part 'mconn_admin_device_fields.g.dart';
...
/// * [serialNumber] 
@BuiltValue()
abstract class MconnAdminDeviceFields implements Built<MconnAdminDeviceFields, MconnAdminDeviceFieldsBuilder> {
  ...
  MconnAdminDeviceFields._();

  factory MconnAdminDeviceFields([void updates(MconnAdminDeviceFieldsBuilder b)]) = _$MconnAdminDeviceFields;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MconnAdminDeviceFieldsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MconnAdminDeviceFields> get serializer => _$MconnAdminDeviceFieldsSerializer();
}

class _$MconnAdminDeviceFieldsSerializer implements PrimitiveSerializer<MconnAdminDeviceFields> {
  @override
  final Iterable<Type> types = const [MconnAdminDeviceFields, _$MconnAdminDeviceFields];

  @override
  final String wireName = r'MconnAdminDeviceFields';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    MconnAdminDeviceFields object, {
    FullType specifiedType = FullType.unspecified,
  }) sync* {
    if (object.cryptKey != null) {
      yield r'crypt_key';
  ...
  void _deserializeProperties(
    ...
    required MconnAdminDeviceFieldsBuilder result,
  ...
  @override
  MconnAdminDeviceFields deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MconnAdminDeviceFieldsBuilder();
