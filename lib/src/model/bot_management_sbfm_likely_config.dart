...
part 'bot_management_sbfm_likely_config.g.dart';
...
@BuiltValue()
abstract class BotManagementSbfmLikelyConfig implements BotManagementBaseConfig, Built<BotManagementSbfmLikelyConfig, BotManagementSbfmLikelyConfigBuilder> {
  @BuiltValueField(wireName: r'sbfm_likely_automated')
  BotManagementSbfmLikelyAutomated? get sbfmLikelyAutomated;
  // enum sbfmLikelyAutomatedEnum {  allow,  block,  managed_challenge,  };
  ...
  StaleZoneConfiguration3? get staleZoneConfiguration;
  ...
  BotManagementSbfmLikelyConfig._();

  factory BotManagementSbfmLikelyConfig([void updates(BotManagementSbfmLikelyConfigBuilder b)]) = _$BotManagementSbfmLikelyConfig;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BotManagementSbfmLikelyConfigBuilder b) => b
      ..isRobotsTxtManaged = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<BotManagementSbfmLikelyConfig> get serializer => _$BotManagementSbfmLikelyConfigSerializer();
}

class _$BotManagementSbfmLikelyConfigSerializer implements PrimitiveSerializer<BotManagementSbfmLikelyConfig> {
  @override
  final Iterable<Type> types = const [BotManagementSbfmLikelyConfig, _$BotManagementSbfmLikelyConfig];

  @override
  final String wireName = r'BotManagementSbfmLikelyConfig';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BotManagementSbfmLikelyConfig object, {
    ...
    if (object.sbfmLikelyAutomated != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BotManagementSbfmLikelyAutomated),
      );
    }
    ...
    if (object.staleZoneConfiguration != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(StaleZoneConfiguration3),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required BotManagementSbfmLikelyConfigBuilder result,
      ...
      switch (key) {
        case r'sbfm_likely_automated':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BotManagementSbfmLikelyAutomated),
          ) as BotManagementSbfmLikelyAutomated;
  ...
  @override
  BotManagementSbfmLikelyConfig deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BotManagementSbfmLikelyConfigBuilder();
