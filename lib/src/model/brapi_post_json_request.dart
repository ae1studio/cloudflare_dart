...
part 'brapi_post_json_request.g.dart';
...
/// * [customAi] - Optional list of custom AI models to use for the request. The models will be tried in the order provided, and in case a model returns an error, the next one will be used as fallback.
/// * [emulateMediaType] 
/// * [gotoOptions] 
...
@BuiltValue()
abstract class BrapiPostJsonRequest implements Built<BrapiPostJsonRequest, BrapiPostJsonRequestBuilder> {
  ...
  @BuiltValueField(wireName: r'custom_ai')
  BuiltList<BrapiPostJsonRequestAllOfCustomAiInner>? get customAi;
  ...
  BrapiPostJsonRequest._();

  factory BrapiPostJsonRequest([void updates(BrapiPostJsonRequestBuilder b)]) = _$BrapiPostJsonRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BrapiPostJsonRequestBuilder b) => b
      ..userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36';

  @BuiltValueSerializer(custom: true)
  static Serializer<BrapiPostJsonRequest> get serializer => _$BrapiPostJsonRequestSerializer();
}

class _$BrapiPostJsonRequestSerializer implements PrimitiveSerializer<BrapiPostJsonRequest> {
  @override
  final Iterable<Type> types = const [BrapiPostJsonRequest, _$BrapiPostJsonRequest];

  @override
  final String wireName = r'BrapiPostJsonRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BrapiPostJsonRequest object, {
    ...
    if (object.customAi != null) {
      yield r'custom_ai';
      yield serializers.serialize(
        object.customAi,
        specifiedType: const FullType(BuiltList, [FullType(BrapiPostJsonRequestAllOfCustomAiInner)]),
      );
    }
    ...
    if (object.responseFormat != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BrapiPostJsonRequestAllOfResponseFormat),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required BrapiPostJsonRequestBuilder result,
      ...
      switch (key) {
        ...
        case r'custom_ai':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(BrapiPostJsonRequestAllOfCustomAiInner)]),
          ) as BuiltList<BrapiPostJsonRequestAllOfCustomAiInner>;
          result.customAi.replace(valueDes);
          break;
        ...
        case r'response_format':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BrapiPostJsonRequestAllOfResponseFormat),
          ) as BrapiPostJsonRequestAllOfResponseFormat;
  ...
  @override
  BrapiPostJsonRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BrapiPostJsonRequestBuilder();
