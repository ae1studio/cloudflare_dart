...
class ZeroTrustGatewayProxyEndpointsListProxyEndpoints4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<ZeroTrustGatewayProxyEndpointsListProxyEndpoints4XXResponseResultEnum> get serializer => _$zeroTrustGatewayProxyEndpointsListProxyEndpoints4XXResponseResultEnumSerializer;

  const ZeroTrustGatewayProxyEndpointsListProxyEndpoints4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<ZeroTrustGatewayProxyEndpointsListProxyEndpoints4XXResponseResultEnum> get values => _$zeroTrustGatewayProxyEndpointsListProxyEndpoints4XXResponseResultEnumValues;
  static ZeroTrustGatewayProxyEndpointsListProxyEndpoints4XXResponseResultEnum valueOf(String name) => _$zeroTrustGatewayProxyEndpointsListProxyEndpoints4XXResponseResultEnumValueOf(name);
}
