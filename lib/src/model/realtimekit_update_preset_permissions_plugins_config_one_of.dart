...
class RealtimekitUpdatePresetPermissionsPluginsConfigOneOfAccessControlEnum extends EnumClass {
  ...
  static Serializer<RealtimekitUpdatePresetPermissionsPluginsConfigOneOfAccessControlEnum> get serializer => _$realtimekitUpdatePresetPermissionsPluginsConfigOneOfAccessControlSerializer;

  const RealtimekitUpdatePresetPermissionsPluginsConfigOneOfAccessControlEnum._(String name): super(name);

  static BuiltSet<RealtimekitUpdatePresetPermissionsPluginsConfigOneOfAccessControlEnum> get values => _$realtimekitUpdatePresetPermissionsPluginsConfigOneOfAccessControlValues;
  static RealtimekitUpdatePresetPermissionsPluginsConfigOneOfAccessControlEnum valueOf(String name) => _$realtimekitUpdatePresetPermissionsPluginsConfigOneOfAccessControlValueOf(name);
}
