...
abstract class AccessVncProps implements AccessSelfHostedProps {
  @BuiltValueSerializer(custom: true)
  static Serializer<AccessVncProps> get serializer => _$AccessVncPropsSerializer();
}

class _$AccessVncPropsSerializer implements PrimitiveSerializer<AccessVncProps> {
  @override
  final Iterable<Type> types = const [AccessVncProps];

  @override
  final String wireName = r'AccessVncProps';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccessVncProps object, {
  ...
  @override
  AccessVncProps deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized, specifiedType: FullType($AccessVncProps)) as $AccessVncProps;
  }
}

/// a concrete implementation of [AccessVncProps], since [AccessVncProps] is not instantiable
@BuiltValue(instantiable: true)
abstract class $AccessVncProps implements AccessVncProps, Built<$AccessVncProps, $AccessVncPropsBuilder> {
  $AccessVncProps._();

  factory $AccessVncProps([void Function($AccessVncPropsBuilder)? updates]) = _$$AccessVncProps;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($AccessVncPropsBuilder b) => b;
...
class _$$AccessVncPropsSerializer implements PrimitiveSerializer<$AccessVncProps> {
  @override
  final Iterable<Type> types = const [$AccessVncProps, _$$AccessVncProps];
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(AccessVncProps))!;
  }
  ...
  void _deserializeProperties(
    ...
    required AccessVncPropsBuilder result,
  ...
  $AccessVncProps deserialize(
    ...
    final result = $AccessVncPropsBuilder();
