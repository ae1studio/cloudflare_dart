...
class SslVerificationEditSslCertificatePackValidationMethod4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<SslVerificationEditSslCertificatePackValidationMethod4XXResponseResultEnum> get serializer => _$sslVerificationEditSslCertificatePackValidationMethod4XXResponseResultSerializer;

  const SslVerificationEditSslCertificatePackValidationMethod4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<SslVerificationEditSslCertificatePackValidationMethod4XXResponseResultEnum> get values => _$sslVerificationEditSslCertificatePackValidationMethod4XXResponseResultValues;
  static SslVerificationEditSslCertificatePackValidationMethod4XXResponseResultEnum valueOf(String name) => _$sslVerificationEditSslCertificatePackValidationMethod4XXResponseResultValueOf(name);
}
