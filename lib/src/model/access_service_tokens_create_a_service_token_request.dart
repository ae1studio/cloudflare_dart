...
part 'access_service_tokens_create_a_service_token_request.g.dart';
...
@BuiltValue()
abstract class AccessServiceTokensCreateAServiceTokenRequest implements Built<AccessServiceTokensCreateAServiceTokenRequest, AccessServiceTokensCreateAServiceTokenRequestBuilder> {
  ...
  AccessServiceTokensCreateAServiceTokenRequest._();

  factory AccessServiceTokensCreateAServiceTokenRequest([void updates(AccessServiceTokensCreateAServiceTokenRequestBuilder b)]) = _$AccessServiceTokensCreateAServiceTokenRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AccessServiceTokensCreateAServiceTokenRequestBuilder b) => b
      ..clientSecretVersion = 1
      ..duration = '8760h';

  @BuiltValueSerializer(custom: true)
  static Serializer<AccessServiceTokensCreateAServiceTokenRequest> get serializer => _$AccessServiceTokensCreateAServiceTokenRequestSerializer();
}

class _$AccessServiceTokensCreateAServiceTokenRequestSerializer implements PrimitiveSerializer<AccessServiceTokensCreateAServiceTokenRequest> {
  @override
  final Iterable<Type> types = const [AccessServiceTokensCreateAServiceTokenRequest, _$AccessServiceTokensCreateAServiceTokenRequest];

  @override
  final String wireName = r'AccessServiceTokensCreateAServiceTokenRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccessServiceTokensCreateAServiceTokenRequest object, {
  ...
  void _deserializeProperties(
    ...
    required AccessServiceTokensCreateAServiceTokenRequestBuilder result,
  ...
  @override
  AccessServiceTokensCreateAServiceTokenRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccessServiceTokensCreateAServiceTokenRequestBuilder();
