...
class Web3HostnameCreateIpfsUniversalPathGatewayContentListEntry4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<Web3HostnameCreateIpfsUniversalPathGatewayContentListEntry4XXResponseResultEnum> get serializer => _$web3HostnameCreateIpfsUniversalPathGatewayContentListEntry4XXResponseResultEnumSerializer;

  const Web3HostnameCreateIpfsUniversalPathGatewayContentListEntry4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<Web3HostnameCreateIpfsUniversalPathGatewayContentListEntry4XXResponseResultEnum> get values => _$web3HostnameCreateIpfsUniversalPathGatewayContentListEntry4XXResponseResultEnumValues;
  static Web3HostnameCreateIpfsUniversalPathGatewayContentListEntry4XXResponseResultEnum valueOf(String name) => _$web3HostnameCreateIpfsUniversalPathGatewayContentListEntry4XXResponseResultEnumValueOf(name);
}
