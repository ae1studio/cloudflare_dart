...
part 'ai_cf_meta_llama4_prompt_inner.g.dart';
...
@BuiltValue()
abstract class AiCfMetaLlama4PromptInner implements Built<AiCfMetaLlama4PromptInner, AiCfMetaLlama4PromptInnerBuilder> {
  ...
  AiCfMetaLlama4PromptInner._();

  factory AiCfMetaLlama4PromptInner([void updates(AiCfMetaLlama4PromptInnerBuilder b)]) = _$AiCfMetaLlama4PromptInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AiCfMetaLlama4PromptInnerBuilder b) => b
      ..maxTokens = 256
      ..raw = false
      ..stream = false
      ..temperature = 0.15;
  ...
  static Serializer<AiCfMetaLlama4PromptInner> get serializer => _$AiCfMetaLlama4PromptInnerSerializer();
}

class _$AiCfMetaLlama4PromptInnerSerializer implements PrimitiveSerializer<AiCfMetaLlama4PromptInner> {
  @override
  final Iterable<Type> types = const [AiCfMetaLlama4PromptInner, _$AiCfMetaLlama4PromptInner];

  @override
  final String wireName = r'AiCfMetaLlama4PromptInner';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AiCfMetaLlama4PromptInner object, {
  ...
  void _deserializeProperties(
    ...
    required AiCfMetaLlama4PromptInnerBuilder result,
  ...
  @override
  AiCfMetaLlama4PromptInner deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AiCfMetaLlama4PromptInnerBuilder();
