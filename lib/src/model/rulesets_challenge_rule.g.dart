...
part of 'rulesets_challenge_rule.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const RulesetsChallengeRuleActionEnum
    _$rulesetsChallengeRuleActionEnum_challenge =
    const RulesetsChallengeRuleActionEnum._('challenge');

RulesetsChallengeRuleActionEnum _$rulesetsChallengeRuleActionEnumValueOf(
    String name) {
  switch (name) {
    case 'challenge':
      return _$rulesetsChallengeRuleActionEnum_challenge;
    default:
      throw ArgumentError(name);
  }
}

final BuiltSet<RulesetsChallengeRuleActionEnum>
    _$rulesetsChallengeRuleActionEnumValues = BuiltSet<
        RulesetsChallengeRuleActionEnum>(const <RulesetsChallengeRuleActionEnum>[
  _$rulesetsChallengeRuleActionEnum_challenge,
]);

Serializer<RulesetsChallengeRuleActionEnum>
    _$rulesetsChallengeRuleActionEnumSerializer =
    _$RulesetsChallengeRuleActionEnumSerializer();

class _$RulesetsChallengeRuleActionEnumSerializer
    implements PrimitiveSerializer<RulesetsChallengeRuleActionEnum> {
  ...
  @override
  final Iterable<Type> types = const <Type>[RulesetsChallengeRuleActionEnum];
  @override
  final String wireName = 'RulesetsChallengeRuleActionEnum';

  @override
  Object serialize(
          Serializers serializers, RulesetsChallengeRuleActionEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  RulesetsChallengeRuleActionEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      RulesetsChallengeRuleActionEnum.valueOf(
          _fromWire[serialized] ?? (serialized is String ? serialized : ''));
}

class _$RulesetsChallengeRule extends RulesetsChallengeRule {
  @override
  ...
  factory _$RulesetsChallengeRule(
          [void Function(RulesetsChallengeRuleBuilder)? updates]) =>
      (RulesetsChallengeRuleBuilder()..update(updates))._build();

  _$RulesetsChallengeRule._(
      ...
      : super._();
  @override
  RulesetsChallengeRule rebuild(
          void Function(RulesetsChallengeRuleBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RulesetsChallengeRuleBuilder toBuilder() =>
      RulesetsChallengeRuleBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RulesetsChallengeRule &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RulesetsChallengeRule')
...
class RulesetsChallengeRuleBuilder
    implements
        Builder<RulesetsChallengeRule, RulesetsChallengeRuleBuilder>,
        RulesetsRuleBuilder {
  _$RulesetsChallengeRule? _$v;
  ...
  RulesetsChallengeRuleBuilder() {
    RulesetsChallengeRule._defaults(this);
  }

  RulesetsChallengeRuleBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant RulesetsChallengeRule other) {
    _$v = other as _$RulesetsChallengeRule;
  }

  @override
  void update(void Function(RulesetsChallengeRuleBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RulesetsChallengeRule build() => _build();

  _$RulesetsChallengeRule _build() {
    _$RulesetsChallengeRule _$result;
    try {
      _$result = _$v ??
          _$RulesetsChallengeRule._(
            lastUpdated: BuiltValueNullFieldError.checkNotNull(
                lastUpdated, r'RulesetsChallengeRule', 'lastUpdated'),
            version: BuiltValueNullFieldError.checkNotNull(
                version, r'RulesetsChallengeRule', 'version'),
            action: action,
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'RulesetsChallengeRule', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
