...
part 'dns_records_dns_record_batch_patch.g.dart';
...
abstract class DnsRecordsDnsRecordBatchPatch implements DnsRecordsDnsRecordPatch, Built<DnsRecordsDnsRecordBatchPatch, DnsRecordsDnsRecordBatchPatchBuilder> {
  ...
  DnsRecordsDnsRecordBatchPatch._();

  factory DnsRecordsDnsRecordBatchPatch([void updates(DnsRecordsDnsRecordBatchPatchBuilder b)]) = _$DnsRecordsDnsRecordBatchPatch;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DnsRecordsDnsRecordBatchPatchBuilder b) => b
      ..proxied = false
      ..tags = ListBuilder();

  @BuiltValueSerializer(custom: true)
  static Serializer<DnsRecordsDnsRecordBatchPatch> get serializer => _$DnsRecordsDnsRecordBatchPatchSerializer();
}

class _$DnsRecordsDnsRecordBatchPatchSerializer implements PrimitiveSerializer<DnsRecordsDnsRecordBatchPatch> {
  @override
  final Iterable<Type> types = const [DnsRecordsDnsRecordBatchPatch, _$DnsRecordsDnsRecordBatchPatch];

  @override
  final String wireName = r'DnsRecordsDnsRecordBatchPatch';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    DnsRecordsDnsRecordBatchPatch object, {
  ...
  void _deserializeProperties(
    ...
    required DnsRecordsDnsRecordBatchPatchBuilder result,
  ...
  @override
  DnsRecordsDnsRecordBatchPatch deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DnsRecordsDnsRecordBatchPatchBuilder();
...
class DnsRecordsDnsRecordBatchPatchTypeEnum extends EnumClass {

  /// Record type.
  @BuiltValueEnumConst(wireName: r'URI')
  static const DnsRecordsDnsRecordBatchPatchTypeEnum URI = _$dnsRecordsDnsRecordBatchPatchTypeEnum_URI;

  static Serializer<DnsRecordsDnsRecordBatchPatchTypeEnum> get serializer => _$dnsRecordsDnsRecordBatchPatchTypeEnumSerializer;

  const DnsRecordsDnsRecordBatchPatchTypeEnum._(String name): super(name);

  static BuiltSet<DnsRecordsDnsRecordBatchPatchTypeEnum> get values => _$dnsRecordsDnsRecordBatchPatchTypeEnumValues;
  static DnsRecordsDnsRecordBatchPatchTypeEnum valueOf(String name) => _$dnsRecordsDnsRecordBatchPatchTypeEnumValueOf(name);
}
