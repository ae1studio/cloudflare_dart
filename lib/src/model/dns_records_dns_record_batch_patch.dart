...
class DnsRecordsDnsRecordBatchPatchTypeEnum extends EnumClass {
  ...
  static Serializer<DnsRecordsDnsRecordBatchPatchTypeEnum> get serializer => _$dnsRecordsDnsRecordBatchPatchTypeSerializer;

  const DnsRecordsDnsRecordBatchPatchTypeEnum._(String name): super(name);

  static BuiltSet<DnsRecordsDnsRecordBatchPatchTypeEnum> get values => _$dnsRecordsDnsRecordBatchPatchTypeValues;
  static DnsRecordsDnsRecordBatchPatchTypeEnum valueOf(String name) => _$dnsRecordsDnsRecordBatchPatchTypeValueOf(name);
}
