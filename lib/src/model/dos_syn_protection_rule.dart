...
part 'dos_syn_protection_rule.g.dart';

/// DosSynProtectionRule
///
/// Properties:
/// * [burstSensitivity] - The burst sensitivity. Must be one of 'low', 'medium', 'high'.
/// * [createdOn] - The creation timestamp of the SYN Protection rule.
/// * [id] - The unique ID of the SYN Protection rule.
/// * [mitigationType] - The type of mitigation for SYN Protection. Must be one of 'challenge' or 'retransmit'.
/// * [mode] - The mode for SYN Protection. Must be one of 'enabled', 'disabled', 'monitoring'.
/// * [modifiedOn] - The last modification timestamp of the SYN Protection rule.
...
@BuiltValue()
abstract class DosSynProtectionRule implements Built<DosSynProtectionRule, DosSynProtectionRuleBuilder> {
  ...
  DosSynProtectionRule._();

  factory DosSynProtectionRule([void updates(DosSynProtectionRuleBuilder b)]) = _$DosSynProtectionRule;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DosSynProtectionRuleBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DosSynProtectionRule> get serializer => _$DosSynProtectionRuleSerializer();
}

class _$DosSynProtectionRuleSerializer implements PrimitiveSerializer<DosSynProtectionRule> {
  @override
  final Iterable<Type> types = const [DosSynProtectionRule, _$DosSynProtectionRule];

  @override
  final String wireName = r'DosSynProtectionRule';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    DosSynProtectionRule object, {
  ...
  void _deserializeProperties(
    ...
    required DosSynProtectionRuleBuilder result,
  ...
  @override
  DosSynProtectionRule deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DosSynProtectionRuleBuilder();
