...
class ZeroTrustGatewayRulesZeroTrustGatewayRuleDetails4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<ZeroTrustGatewayRulesZeroTrustGatewayRuleDetails4XXResponseResultEnum> get serializer => _$zeroTrustGatewayRulesZeroTrustGatewayRuleDetails4XXResponseResultEnumSerializer;

  const ZeroTrustGatewayRulesZeroTrustGatewayRuleDetails4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<ZeroTrustGatewayRulesZeroTrustGatewayRuleDetails4XXResponseResultEnum> get values => _$zeroTrustGatewayRulesZeroTrustGatewayRuleDetails4XXResponseResultEnumValues;
  static ZeroTrustGatewayRulesZeroTrustGatewayRuleDetails4XXResponseResultEnum valueOf(String name) => _$zeroTrustGatewayRulesZeroTrustGatewayRuleDetails4XXResponseResultEnumValueOf(name);
}
