...
part 'email_security_create_allow_policy201_response_all_of_result.g.dart';
...
/// * [isSpoof] 
@BuiltValue()
abstract class EmailSecurityCreateAllowPolicy201ResponseAllOfResult implements Built<EmailSecurityCreateAllowPolicy201ResponseAllOfResult, EmailSecurityCreateAllowPolicy201ResponseAllOfResultBuilder> {
  ...
  EmailSecurityCreateAllowPolicy201ResponseAllOfResult._();

  factory EmailSecurityCreateAllowPolicy201ResponseAllOfResult([void updates(EmailSecurityCreateAllowPolicy201ResponseAllOfResultBuilder b)]) = _$EmailSecurityCreateAllowPolicy201ResponseAllOfResult;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(EmailSecurityCreateAllowPolicy201ResponseAllOfResultBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<EmailSecurityCreateAllowPolicy201ResponseAllOfResult> get serializer => _$EmailSecurityCreateAllowPolicy201ResponseAllOfResultSerializer();
}

class _$EmailSecurityCreateAllowPolicy201ResponseAllOfResultSerializer implements PrimitiveSerializer<EmailSecurityCreateAllowPolicy201ResponseAllOfResult> {
  @override
  final Iterable<Type> types = const [EmailSecurityCreateAllowPolicy201ResponseAllOfResult, _$EmailSecurityCreateAllowPolicy201ResponseAllOfResult];

  @override
  final String wireName = r'EmailSecurityCreateAllowPolicy201ResponseAllOfResult';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    EmailSecurityCreateAllowPolicy201ResponseAllOfResult object, {
  ...
  void _deserializeProperties(
    ...
    required EmailSecurityCreateAllowPolicy201ResponseAllOfResultBuilder result,
  ...
  @override
  EmailSecurityCreateAllowPolicy201ResponseAllOfResult deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = EmailSecurityCreateAllowPolicy201ResponseAllOfResultBuilder();
