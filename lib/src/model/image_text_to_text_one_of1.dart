...
part 'image_text_to_text_one_of1.g.dart';
...
abstract class ImageTextToTextOneOf1 implements Built<ImageTextToTextOneOf1, ImageTextToTextOneOf1Builder> {
  ...
  ImageTextToTextOneOf1._();

  factory ImageTextToTextOneOf1([void updates(ImageTextToTextOneOf1Builder b)]) = _$ImageTextToTextOneOf1;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ImageTextToTextOneOf1Builder b) => b
      ..maxTokens = 512;

  @BuiltValueSerializer(custom: true)
  static Serializer<ImageTextToTextOneOf1> get serializer => _$ImageTextToTextOneOf1Serializer();
}

class _$ImageTextToTextOneOf1Serializer implements PrimitiveSerializer<ImageTextToTextOneOf1> {
  @override
  final Iterable<Type> types = const [ImageTextToTextOneOf1, _$ImageTextToTextOneOf1];

  @override
  final String wireName = r'ImageTextToTextOneOf1';
  ...
  void _deserializeProperties(
    ...
    required ImageTextToTextOneOf1Builder result,
  ...
  @override
  ImageTextToTextOneOf1 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ImageTextToTextOneOf1Builder();
