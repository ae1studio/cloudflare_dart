...
abstract class MagicGreTunnel implements Built<MagicGreTunnel, MagicGreTunnelBuilder> {
  ...
  factory MagicGreTunnel([void updates(MagicGreTunnelBuilder b)]) = _$MagicGreTunnel;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MagicGreTunnelBuilder b) => b
      ..automaticReturnRouting = false
      ..mtu = 1476
      ..ttl = 64;

  @BuiltValueSerializer(custom: true)
  static Serializer<MagicGreTunnel> get serializer => _$MagicGreTunnelSerializer();
}

class _$MagicGreTunnelSerializer implements PrimitiveSerializer<MagicGreTunnel> {
  @override
  final Iterable<Type> types = const [MagicGreTunnel, _$MagicGreTunnel];

  @override
  final String wireName = r'MagicGreTunnel';
  ...
  void _deserializeProperties(
    ...
    required MagicGreTunnelBuilder result,
  ...
  @override
  MagicGreTunnel deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MagicGreTunnelBuilder();
