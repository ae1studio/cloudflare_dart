...
class CloudflareTunnelGetACloudflareTunnelManagementToken4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<CloudflareTunnelGetACloudflareTunnelManagementToken4XXResponseResultEnum> get serializer => _$cloudflareTunnelGetACloudflareTunnelManagementToken4XXResponseResultEnumSerializer;

  const CloudflareTunnelGetACloudflareTunnelManagementToken4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<CloudflareTunnelGetACloudflareTunnelManagementToken4XXResponseResultEnum> get values => _$cloudflareTunnelGetACloudflareTunnelManagementToken4XXResponseResultEnumValues;
  static CloudflareTunnelGetACloudflareTunnelManagementToken4XXResponseResultEnum valueOf(String name) => _$cloudflareTunnelGetACloudflareTunnelManagementToken4XXResponseResultEnumValueOf(name);
}
