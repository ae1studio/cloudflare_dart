...
part 'account_load_balancer_pools_create_pool_request.g.dart';
...
@BuiltValue()
abstract class AccountLoadBalancerPoolsCreatePoolRequest implements Built<AccountLoadBalancerPoolsCreatePoolRequest, AccountLoadBalancerPoolsCreatePoolRequestBuilder> {
  ...
  AccountLoadBalancerPoolsCreatePoolRequest._();

  factory AccountLoadBalancerPoolsCreatePoolRequest([void updates(AccountLoadBalancerPoolsCreatePoolRequestBuilder b)]) = _$AccountLoadBalancerPoolsCreatePoolRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AccountLoadBalancerPoolsCreatePoolRequestBuilder b) => b
      ..description = ''
      ..enabled = true
      ..minimumOrigins = 1
      ..notificationEmail = '';
  ...
  static Serializer<AccountLoadBalancerPoolsCreatePoolRequest> get serializer => _$AccountLoadBalancerPoolsCreatePoolRequestSerializer();
}

class _$AccountLoadBalancerPoolsCreatePoolRequestSerializer implements PrimitiveSerializer<AccountLoadBalancerPoolsCreatePoolRequest> {
  @override
  final Iterable<Type> types = const [AccountLoadBalancerPoolsCreatePoolRequest, _$AccountLoadBalancerPoolsCreatePoolRequest];

  @override
  final String wireName = r'AccountLoadBalancerPoolsCreatePoolRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccountLoadBalancerPoolsCreatePoolRequest object, {
  ...
  void _deserializeProperties(
    ...
    required AccountLoadBalancerPoolsCreatePoolRequestBuilder result,
  ...
  @override
  AccountLoadBalancerPoolsCreatePoolRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccountLoadBalancerPoolsCreatePoolRequestBuilder();
