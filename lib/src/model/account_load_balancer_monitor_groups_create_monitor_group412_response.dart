...
class AccountLoadBalancerMonitorGroupsCreateMonitorGroup412ResponseResultEnum extends EnumClass {
  ...
  static Serializer<AccountLoadBalancerMonitorGroupsCreateMonitorGroup412ResponseResultEnum> get serializer => _$accountLoadBalancerMonitorGroupsCreateMonitorGroup412ResponseResultEnumSerializer;

  const AccountLoadBalancerMonitorGroupsCreateMonitorGroup412ResponseResultEnum._(String name): super(name);

  static BuiltSet<AccountLoadBalancerMonitorGroupsCreateMonitorGroup412ResponseResultEnum> get values => _$accountLoadBalancerMonitorGroupsCreateMonitorGroup412ResponseResultEnumValues;
  static AccountLoadBalancerMonitorGroupsCreateMonitorGroup412ResponseResultEnum valueOf(String name) => _$accountLoadBalancerMonitorGroupsCreateMonitorGroup412ResponseResultEnumValueOf(name);
}
