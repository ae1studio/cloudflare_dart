...
part 'ai_cf_meta_llama4_prompt.g.dart';
...
abstract class AiCfMetaLlama4Prompt implements Built<AiCfMetaLlama4Prompt, AiCfMetaLlama4PromptBuilder> {
  ...
  AiCfMetaLlama4Prompt._();

  factory AiCfMetaLlama4Prompt([void updates(AiCfMetaLlama4PromptBuilder b)]) = _$AiCfMetaLlama4Prompt;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AiCfMetaLlama4PromptBuilder b) => b
      ..maxTokens = 256
      ..raw = false
      ..stream = false
      ..temperature = 0.15;
  ...
  static Serializer<AiCfMetaLlama4Prompt> get serializer => _$AiCfMetaLlama4PromptSerializer();
}

class _$AiCfMetaLlama4PromptSerializer implements PrimitiveSerializer<AiCfMetaLlama4Prompt> {
  @override
  final Iterable<Type> types = const [AiCfMetaLlama4Prompt, _$AiCfMetaLlama4Prompt];

  @override
  final String wireName = r'AiCfMetaLlama4Prompt';
  ...
  void _deserializeProperties(
    ...
    required AiCfMetaLlama4PromptBuilder result,
  ...
  @override
  AiCfMetaLlama4Prompt deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AiCfMetaLlama4PromptBuilder();
