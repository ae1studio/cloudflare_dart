...
class ZeroTrustGatewayProxyEndpointsCreateProxyEndpoint4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<ZeroTrustGatewayProxyEndpointsCreateProxyEndpoint4XXResponseResultEnum> get serializer => _$zeroTrustGatewayProxyEndpointsCreateProxyEndpoint4XXResponseResultSerializer;

  const ZeroTrustGatewayProxyEndpointsCreateProxyEndpoint4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<ZeroTrustGatewayProxyEndpointsCreateProxyEndpoint4XXResponseResultEnum> get values => _$zeroTrustGatewayProxyEndpointsCreateProxyEndpoint4XXResponseResultValues;
  static ZeroTrustGatewayProxyEndpointsCreateProxyEndpoint4XXResponseResultEnum valueOf(String name) => _$zeroTrustGatewayProxyEndpointsCreateProxyEndpoint4XXResponseResultValueOf(name);
}
