...
class PostV4AccountsByAccountIdPipelinesDeprecatedRequestDestinationFormatEnum extends EnumClass {
  ...
  static Serializer<PostV4AccountsByAccountIdPipelinesDeprecatedRequestDestinationFormatEnum> get serializer => _$postV4AccountsByAccountIdPipelinesDeprecatedRequestDestinationFormatSerializer;

  const PostV4AccountsByAccountIdPipelinesDeprecatedRequestDestinationFormatEnum._(String name): super(name);

  static BuiltSet<PostV4AccountsByAccountIdPipelinesDeprecatedRequestDestinationFormatEnum> get values => _$postV4AccountsByAccountIdPipelinesDeprecatedRequestDestinationFormatValues;
  static PostV4AccountsByAccountIdPipelinesDeprecatedRequestDestinationFormatEnum valueOf(String name) => _$postV4AccountsByAccountIdPipelinesDeprecatedRequestDestinationFormatValueOf(name);
}
...
class PostV4AccountsByAccountIdPipelinesDeprecatedRequestDestinationTypeEnum extends EnumClass {
  ...
  static Serializer<PostV4AccountsByAccountIdPipelinesDeprecatedRequestDestinationTypeEnum> get serializer => _$postV4AccountsByAccountIdPipelinesDeprecatedRequestDestinationTypeSerializer;

  const PostV4AccountsByAccountIdPipelinesDeprecatedRequestDestinationTypeEnum._(String name): super(name);

  static BuiltSet<PostV4AccountsByAccountIdPipelinesDeprecatedRequestDestinationTypeEnum> get values => _$postV4AccountsByAccountIdPipelinesDeprecatedRequestDestinationTypeValues;
  static PostV4AccountsByAccountIdPipelinesDeprecatedRequestDestinationTypeEnum valueOf(String name) => _$postV4AccountsByAccountIdPipelinesDeprecatedRequestDestinationTypeValueOf(name);
}
