...
class ZeroTrustAccountsGetLoggingSettingsForTheZeroTrustAccount4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<ZeroTrustAccountsGetLoggingSettingsForTheZeroTrustAccount4XXResponseResultEnum> get serializer => _$zeroTrustAccountsGetLoggingSettingsForTheZeroTrustAccount4XXResponseResultSerializer;

  const ZeroTrustAccountsGetLoggingSettingsForTheZeroTrustAccount4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<ZeroTrustAccountsGetLoggingSettingsForTheZeroTrustAccount4XXResponseResultEnum> get values => _$zeroTrustAccountsGetLoggingSettingsForTheZeroTrustAccount4XXResponseResultValues;
  static ZeroTrustAccountsGetLoggingSettingsForTheZeroTrustAccount4XXResponseResultEnum valueOf(String name) => _$zeroTrustAccountsGetLoggingSettingsForTheZeroTrustAccount4XXResponseResultValueOf(name);
}
