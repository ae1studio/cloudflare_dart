...
class DigitalExperienceMonitoringTracerouteTestNetworkPathResponseNetworkPathSamplingUnitEnum extends EnumClass {
  ...
  static Serializer<DigitalExperienceMonitoringTracerouteTestNetworkPathResponseNetworkPathSamplingUnitEnum> get serializer => _$digitalExperienceMonitoringTracerouteTestNetworkPathResponseNetworkPathSamplingUnitEnumSerializer;

  const DigitalExperienceMonitoringTracerouteTestNetworkPathResponseNetworkPathSamplingUnitEnum._(String name): super(name);

  static BuiltSet<DigitalExperienceMonitoringTracerouteTestNetworkPathResponseNetworkPathSamplingUnitEnum> get values => _$digitalExperienceMonitoringTracerouteTestNetworkPathResponseNetworkPathSamplingUnitEnumValues;
  static DigitalExperienceMonitoringTracerouteTestNetworkPathResponseNetworkPathSamplingUnitEnum valueOf(String name) => _$digitalExperienceMonitoringTracerouteTestNetworkPathResponseNetworkPathSamplingUnitEnumValueOf(name);
}
