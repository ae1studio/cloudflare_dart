...
part 'brapi_post_snapshot_request.g.dart';
...
@BuiltValue()
abstract class BrapiPostSnapshotRequest implements Built<BrapiPostSnapshotRequest, BrapiPostSnapshotRequestBuilder> {
  ...
  BuiltList<BrapiPostSnapshotRequestAllOfAllowResourceTypes>? get allowResourceTypes;
  ...
  BuiltList<BrapiPostSnapshotRequestAllOfRejectResourceTypes>? get rejectResourceTypes;

  @BuiltValueField(wireName: r'screenshotOptions')
  BrapiPostSnapshotRequestAllOfScreenshotOptions? get screenshotOptions;
  ...
  BrapiPostSnapshotRequest._();

  factory BrapiPostSnapshotRequest([void updates(BrapiPostSnapshotRequestBuilder b)]) = _$BrapiPostSnapshotRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BrapiPostSnapshotRequestBuilder b) => b
      ..userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36';

  @BuiltValueSerializer(custom: true)
  static Serializer<BrapiPostSnapshotRequest> get serializer => _$BrapiPostSnapshotRequestSerializer();
}

class _$BrapiPostSnapshotRequestSerializer implements PrimitiveSerializer<BrapiPostSnapshotRequest> {
  @override
  final Iterable<Type> types = const [BrapiPostSnapshotRequest, _$BrapiPostSnapshotRequest];

  @override
  final String wireName = r'BrapiPostSnapshotRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BrapiPostSnapshotRequest object, {
    ...
    if (object.allowResourceTypes != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(BrapiPostSnapshotRequestAllOfAllowResourceTypes)]),
      );
    }
    ...
    if (object.rejectResourceTypes != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(BrapiPostSnapshotRequestAllOfRejectResourceTypes)]),
      );
    }
    if (object.screenshotOptions != null) {
      yield r'screenshotOptions';
      yield serializers.serialize(
        object.screenshotOptions,
        specifiedType: const FullType(BrapiPostSnapshotRequestAllOfScreenshotOptions),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required BrapiPostSnapshotRequestBuilder result,
      ...
      switch (key) {
        ...
        case r'allowResourceTypes':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(BrapiPostSnapshotRequestAllOfAllowResourceTypes)]),
          ) as BuiltList<BrapiPostSnapshotRequestAllOfAllowResourceTypes>;
        ...
        case r'rejectResourceTypes':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(BrapiPostSnapshotRequestAllOfRejectResourceTypes)]),
          ) as BuiltList<BrapiPostSnapshotRequestAllOfRejectResourceTypes>;
        ...
        case r'screenshotOptions':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BrapiPostSnapshotRequestAllOfScreenshotOptions),
          ) as BrapiPostSnapshotRequestAllOfScreenshotOptions;
          result.screenshotOptions.replace(valueDes);
          break;
  ...
  @override
  BrapiPostSnapshotRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BrapiPostSnapshotRequestBuilder();
