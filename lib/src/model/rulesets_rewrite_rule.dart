...
part 'rulesets_rewrite_rule.g.dart';
...
@BuiltValue()
abstract class RulesetsRewriteRule implements RulesetsRule, Built<RulesetsRewriteRule, RulesetsRewriteRuleBuilder> {
  RulesetsRewriteRule._();

  factory RulesetsRewriteRule([void updates(RulesetsRewriteRuleBuilder b)]) = _$RulesetsRewriteRule;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RulesetsRewriteRuleBuilder b) => b
      ..description = ''
      ..enabled = true
      ..actionParameters = {};

  @BuiltValueSerializer(custom: true)
  static Serializer<RulesetsRewriteRule> get serializer => _$RulesetsRewriteRuleSerializer();
}

class _$RulesetsRewriteRuleSerializer implements PrimitiveSerializer<RulesetsRewriteRule> {
  @override
  final Iterable<Type> types = const [RulesetsRewriteRule, _$RulesetsRewriteRule];

  @override
  final String wireName = r'RulesetsRewriteRule';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RulesetsRewriteRule object, {
  ...
  void _deserializeProperties(
    ...
    required RulesetsRewriteRuleBuilder result,
  ...
  @override
  RulesetsRewriteRule deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RulesetsRewriteRuleBuilder();
...
class RulesetsRewriteRuleActionEnum extends EnumClass {

  @BuiltValueEnumConst(wireName: r'rewrite')
  static const RulesetsRewriteRuleActionEnum rewrite = _$rulesetsRewriteRuleActionEnum_rewrite;

  static Serializer<RulesetsRewriteRuleActionEnum> get serializer => _$rulesetsRewriteRuleActionEnumSerializer;

  const RulesetsRewriteRuleActionEnum._(String name): super(name);

  static BuiltSet<RulesetsRewriteRuleActionEnum> get values => _$rulesetsRewriteRuleActionEnumValues;
  static RulesetsRewriteRuleActionEnum valueOf(String name) => _$rulesetsRewriteRuleActionEnumValueOf(name);
}
