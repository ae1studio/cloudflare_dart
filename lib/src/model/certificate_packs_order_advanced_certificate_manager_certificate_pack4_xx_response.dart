...
class CertificatePacksOrderAdvancedCertificateManagerCertificatePack4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<CertificatePacksOrderAdvancedCertificateManagerCertificatePack4XXResponseResultEnum> get serializer => _$certificatePacksOrderAdvancedCertificateManagerCertificatePack4XXResponseResultEnumSerializer;

  const CertificatePacksOrderAdvancedCertificateManagerCertificatePack4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<CertificatePacksOrderAdvancedCertificateManagerCertificatePack4XXResponseResultEnum> get values => _$certificatePacksOrderAdvancedCertificateManagerCertificatePack4XXResponseResultEnumValues;
  static CertificatePacksOrderAdvancedCertificateManagerCertificatePack4XXResponseResultEnum valueOf(String name) => _$certificatePacksOrderAdvancedCertificateManagerCertificatePack4XXResponseResultEnumValueOf(name);
}
