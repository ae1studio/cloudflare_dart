...
part 'access_app_policy_request.g.dart';
...
abstract class AccessAppPolicyRequest implements AccessPolicyReq {
  /// The order of execution for this policy. Must be unique for each policy within an app. 
  @BuiltValueField(wireName: r'precedence')
  int? get precedence;

  @BuiltValueSerializer(custom: true)
  static Serializer<AccessAppPolicyRequest> get serializer => _$AccessAppPolicyRequestSerializer();
}

class _$AccessAppPolicyRequestSerializer implements PrimitiveSerializer<AccessAppPolicyRequest> {
  @override
  final Iterable<Type> types = const [AccessAppPolicyRequest];

  @override
  final String wireName = r'AccessAppPolicyRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccessAppPolicyRequest object, {
  ...
  @override
  AccessAppPolicyRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized, specifiedType: FullType($AccessAppPolicyRequest)) as $AccessAppPolicyRequest;
  }
}

/// a concrete implementation of [AccessAppPolicyRequest], since [AccessAppPolicyRequest] is not instantiable
@BuiltValue(instantiable: true)
abstract class $AccessAppPolicyRequest implements AccessAppPolicyRequest, Built<$AccessAppPolicyRequest, $AccessAppPolicyRequestBuilder> {
  $AccessAppPolicyRequest._();

  factory $AccessAppPolicyRequest([void Function($AccessAppPolicyRequestBuilder)? updates]) = _$$AccessAppPolicyRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($AccessAppPolicyRequestBuilder b) => b;
...
class _$$AccessAppPolicyRequestSerializer implements PrimitiveSerializer<$AccessAppPolicyRequest> {
  @override
  final Iterable<Type> types = const [$AccessAppPolicyRequest, _$$AccessAppPolicyRequest];
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(AccessAppPolicyRequest))!;
  }
  ...
  void _deserializeProperties(
    ...
    required AccessAppPolicyRequestBuilder result,
  ...
  $AccessAppPolicyRequest deserialize(
    ...
    final result = $AccessAppPolicyRequestBuilder();
