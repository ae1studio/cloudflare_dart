...
class ClientCertificateForAZoneCreateClientCertificate4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<ClientCertificateForAZoneCreateClientCertificate4XXResponseResultEnum> get serializer => _$clientCertificateForAZoneCreateClientCertificate4XXResponseResultEnumSerializer;

  const ClientCertificateForAZoneCreateClientCertificate4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<ClientCertificateForAZoneCreateClientCertificate4XXResponseResultEnum> get values => _$clientCertificateForAZoneCreateClientCertificate4XXResponseResultEnumValues;
  static ClientCertificateForAZoneCreateClientCertificate4XXResponseResultEnum valueOf(String name) => _$clientCertificateForAZoneCreateClientCertificate4XXResponseResultEnumValueOf(name);
}
