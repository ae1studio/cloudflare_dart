...
part of 'access_self_hosted_props.dart';
...
abstract class AccessSelfHostedPropsBuilder {
  ...
  set corsHeaders(AccessCorsHeadersBuilder? corsHeaders);
  ...
  set customNonIdentityDenyUrl(String? customNonIdentityDenyUrl);
  ...
  set pathCookieAttribute(bool? pathCookieAttribute);

  String? get readServiceTokensFromHeader;
  set readServiceTokensFromHeader(String? readServiceTokensFromHeader);
  ...
  set selfHostedDomains(ListBuilder<String>? selfHostedDomains);
...
class _$$AccessSelfHostedProps extends $AccessSelfHostedProps {
  ...
  @override
  $AccessSelfHostedPropsBuilder toBuilder() =>
      $AccessSelfHostedPropsBuilder()..replace(this);
...
class $AccessSelfHostedPropsBuilder
    implements
  ...
  @override
  void replace(covariant $AccessSelfHostedProps other) {
    _$v = other as _$$AccessSelfHostedProps;
  }
  ...
  @override
  $AccessSelfHostedProps build() => _build();

  _$$AccessSelfHostedProps _build() {
    _$$AccessSelfHostedProps _$result;
    try {
      _$result = _$v ??
          _$$AccessSelfHostedProps._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'$AccessSelfHostedProps', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
