...
class MagicPcapCollectionAddBucketsForFullPacketCapturesDefaultResponseResultEnum extends EnumClass {
  ...
  static Serializer<MagicPcapCollectionAddBucketsForFullPacketCapturesDefaultResponseResultEnum> get serializer => _$magicPcapCollectionAddBucketsForFullPacketCapturesDefaultResponseResultEnumSerializer;

  const MagicPcapCollectionAddBucketsForFullPacketCapturesDefaultResponseResultEnum._(String name): super(name);

  static BuiltSet<MagicPcapCollectionAddBucketsForFullPacketCapturesDefaultResponseResultEnum> get values => _$magicPcapCollectionAddBucketsForFullPacketCapturesDefaultResponseResultEnumValues;
  static MagicPcapCollectionAddBucketsForFullPacketCapturesDefaultResponseResultEnum valueOf(String name) => _$magicPcapCollectionAddBucketsForFullPacketCapturesDefaultResponseResultEnumValueOf(name);
}
