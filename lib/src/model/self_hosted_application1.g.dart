...
part of 'self_hosted_application1.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$SelfHostedApplication1 extends SelfHostedApplication1 {
  @override
  ...
  factory _$SelfHostedApplication1(
          [void Function(SelfHostedApplication1Builder)? updates]) =>
      (SelfHostedApplication1Builder()..update(updates))._build();

  _$SelfHostedApplication1._(
      {this.policies,
      this.aud,
      this.createdAt,
      this.id,
      ...
      : super._();
  @override
  SelfHostedApplication1 rebuild(
          void Function(SelfHostedApplication1Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SelfHostedApplication1Builder toBuilder() =>
      SelfHostedApplication1Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SelfHostedApplication1 &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'SelfHostedApplication1')
...
class SelfHostedApplication1Builder
    implements
        Builder<SelfHostedApplication1, SelfHostedApplication1Builder>,
        AccessAppRespEmbeddedPoliciesBuilder,
        AccessBasicAppResponsePropsBuilder,
        AccessSelfHostedPropsBuilder {
  _$SelfHostedApplication1? _$v;
  ...
  SelfHostedApplication1Builder() {
    SelfHostedApplication1._defaults(this);
  }

  SelfHostedApplication1Builder get _$this {
    final $v = _$v;
    if ($v != null) {
...
// ignore: override_on_non_overriding_method
  void replace(covariant SelfHostedApplication1 other) {
    _$v = other as _$SelfHostedApplication1;
  }

  @override
  void update(void Function(SelfHostedApplication1Builder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  SelfHostedApplication1 build() => _build();

  _$SelfHostedApplication1 _build() {
    _$SelfHostedApplication1 _$result;
    try {
      _$result = _$v ??
          _$SelfHostedApplication1._(
            ...
            domain: BuiltValueNullFieldError.checkNotNull(
                domain, r'SelfHostedApplication1', 'domain'),
            type: BuiltValueNullFieldError.checkNotNull(
                type, r'SelfHostedApplication1', 'type'),
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'SelfHostedApplication1', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
