...
class ZeroTrustAccountsGetZeroTrustAccountConfiguration4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<ZeroTrustAccountsGetZeroTrustAccountConfiguration4XXResponseResultEnum> get serializer => _$zeroTrustAccountsGetZeroTrustAccountConfiguration4XXResponseResultSerializer;

  const ZeroTrustAccountsGetZeroTrustAccountConfiguration4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<ZeroTrustAccountsGetZeroTrustAccountConfiguration4XXResponseResultEnum> get values => _$zeroTrustAccountsGetZeroTrustAccountConfiguration4XXResponseResultValues;
  static ZeroTrustAccountsGetZeroTrustAccountConfiguration4XXResponseResultEnum valueOf(String name) => _$zeroTrustAccountsGetZeroTrustAccountConfiguration4XXResponseResultValueOf(name);
}
