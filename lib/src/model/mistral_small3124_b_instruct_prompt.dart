...
part 'mistral_small3124_b_instruct_prompt.g.dart';
...
@BuiltValue()
abstract class MistralSmall3124BInstructPrompt implements Built<MistralSmall3124BInstructPrompt, MistralSmall3124BInstructPromptBuilder> {
  ...
  MistralSmall3124BInstructPrompt._();

  factory MistralSmall3124BInstructPrompt([void updates(MistralSmall3124BInstructPromptBuilder b)]) = _$MistralSmall3124BInstructPrompt;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MistralSmall3124BInstructPromptBuilder b) => b
      ..maxTokens = 256
      ..raw = false
      ..stream = false
      ..temperature = 0.15;
  ...
  static Serializer<MistralSmall3124BInstructPrompt> get serializer => _$MistralSmall3124BInstructPromptSerializer();
}

class _$MistralSmall3124BInstructPromptSerializer implements PrimitiveSerializer<MistralSmall3124BInstructPrompt> {
  @override
  final Iterable<Type> types = const [MistralSmall3124BInstructPrompt, _$MistralSmall3124BInstructPrompt];

  @override
  final String wireName = r'MistralSmall3124BInstructPrompt';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    MistralSmall3124BInstructPrompt object, {
  ...
  void _deserializeProperties(
    ...
    required MistralSmall3124BInstructPromptBuilder result,
  ...
  @override
  MistralSmall3124BInstructPrompt deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MistralSmall3124BInstructPromptBuilder();
