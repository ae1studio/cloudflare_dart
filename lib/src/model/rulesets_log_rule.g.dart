...
part of 'rulesets_log_rule.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const RulesetsLogRuleActionEnum _$rulesetsLogRuleActionEnum_log =
    const RulesetsLogRuleActionEnum._('log');

RulesetsLogRuleActionEnum _$rulesetsLogRuleActionEnumValueOf(String name) {
  switch (name) {
    case 'log':
      return _$rulesetsLogRuleActionEnum_log;
    default:
      throw ArgumentError(name);
  }
}

final BuiltSet<RulesetsLogRuleActionEnum> _$rulesetsLogRuleActionEnumValues =
    BuiltSet<RulesetsLogRuleActionEnum>(const <RulesetsLogRuleActionEnum>[
  _$rulesetsLogRuleActionEnum_log,
]);

Serializer<RulesetsLogRuleActionEnum> _$rulesetsLogRuleActionEnumSerializer =
    _$RulesetsLogRuleActionEnumSerializer();

class _$RulesetsLogRuleActionEnumSerializer
    implements PrimitiveSerializer<RulesetsLogRuleActionEnum> {
  ...
  @override
  final Iterable<Type> types = const <Type>[RulesetsLogRuleActionEnum];
  @override
  final String wireName = 'RulesetsLogRuleActionEnum';

  @override
  Object serialize(Serializers serializers, RulesetsLogRuleActionEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  RulesetsLogRuleActionEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      RulesetsLogRuleActionEnum.valueOf(
          _fromWire[serialized] ?? (serialized is String ? serialized : ''));
}

class _$RulesetsLogRule extends RulesetsLogRule {
  @override
  final String? action;
  @override
  ...
  factory _$RulesetsLogRule([void Function(RulesetsLogRuleBuilder)? updates]) =>
      (RulesetsLogRuleBuilder()..update(updates))._build();
  ...
  _$RulesetsLogRule._(
      ...
      : super._();
  @override
  RulesetsLogRule rebuild(void Function(RulesetsLogRuleBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RulesetsLogRuleBuilder toBuilder() => RulesetsLogRuleBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RulesetsLogRule &&
        action == other.action &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RulesetsLogRule')
          ..add('action', action)
...
class RulesetsLogRuleBuilder
    implements
        Builder<RulesetsLogRule, RulesetsLogRuleBuilder>,
        RulesetsRuleBuilder {
  _$RulesetsLogRule? _$v;
  ...
  RulesetsLogRuleBuilder() {
    RulesetsLogRule._defaults(this);
  }

  RulesetsLogRuleBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _action = $v.action;
  ...
  @override
  void replace(covariant RulesetsLogRule other) {
    _$v = other as _$RulesetsLogRule;
  }

  @override
  void update(void Function(RulesetsLogRuleBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RulesetsLogRule build() => _build();

  _$RulesetsLogRule _build() {
    _$RulesetsLogRule _$result;
    try {
      _$result = _$v ??
          _$RulesetsLogRule._(
            action: action,
            ...
            lastUpdated: BuiltValueNullFieldError.checkNotNull(
                lastUpdated, r'RulesetsLogRule', 'lastUpdated'),
            logging: _logging?.build(),
            ratelimit: _ratelimit?.build(),
            ref: ref,
            version: BuiltValueNullFieldError.checkNotNull(
                version, r'RulesetsLogRule', 'version'),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'RulesetsLogRule', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
