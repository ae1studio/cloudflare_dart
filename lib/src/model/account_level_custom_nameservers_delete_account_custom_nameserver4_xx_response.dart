...
class AccountLevelCustomNameserversDeleteAccountCustomNameserver4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<AccountLevelCustomNameserversDeleteAccountCustomNameserver4XXResponseResultEnum> get serializer => _$accountLevelCustomNameserversDeleteAccountCustomNameserver4XXResponseResultEnumSerializer;

  const AccountLevelCustomNameserversDeleteAccountCustomNameserver4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<AccountLevelCustomNameserversDeleteAccountCustomNameserver4XXResponseResultEnum> get values => _$accountLevelCustomNameserversDeleteAccountCustomNameserver4XXResponseResultEnumValues;
  static AccountLevelCustomNameserversDeleteAccountCustomNameserver4XXResponseResultEnum valueOf(String name) => _$accountLevelCustomNameserversDeleteAccountCustomNameserver4XXResponseResultEnumValueOf(name);
}
