...
class MagicNetworkMonitoringRulesUpdateAdvertisementForRule4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<MagicNetworkMonitoringRulesUpdateAdvertisementForRule4XXResponseResultEnum> get serializer => _$magicNetworkMonitoringRulesUpdateAdvertisementForRule4XXResponseResultEnumSerializer;

  const MagicNetworkMonitoringRulesUpdateAdvertisementForRule4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<MagicNetworkMonitoringRulesUpdateAdvertisementForRule4XXResponseResultEnum> get values => _$magicNetworkMonitoringRulesUpdateAdvertisementForRule4XXResponseResultEnumValues;
  static MagicNetworkMonitoringRulesUpdateAdvertisementForRule4XXResponseResultEnum valueOf(String name) => _$magicNetworkMonitoringRulesUpdateAdvertisementForRule4XXResponseResultEnumValueOf(name);
}
