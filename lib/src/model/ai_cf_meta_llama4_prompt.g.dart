...
part of 'ai_cf_meta_llama4_prompt.dart';
...
class _$AiCfMetaLlama4Prompt extends AiCfMetaLlama4Prompt {
  ...
  factory _$AiCfMetaLlama4Prompt(
          [void Function(AiCfMetaLlama4PromptBuilder)? updates]) =>
  ...
  _$AiCfMetaLlama4Prompt._(
      ...
      : super._();
  @override
  AiCfMetaLlama4Prompt rebuild(
          void Function(AiCfMetaLlama4PromptBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  AiCfMetaLlama4PromptBuilder toBuilder() =>
      AiCfMetaLlama4PromptBuilder()..replace(this);
...
class AiCfMetaLlama4PromptBuilder
  ...
  AiCfMetaLlama4PromptBuilder() {
    AiCfMetaLlama4Prompt._defaults(this);
  }
  ...
  @override
  void replace(AiCfMetaLlama4Prompt other) {
    _$v = other as _$AiCfMetaLlama4Prompt;
  }

  @override
  void update(void Function(AiCfMetaLlama4PromptBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  AiCfMetaLlama4Prompt build() => _build();

  _$AiCfMetaLlama4Prompt _build() {
    _$AiCfMetaLlama4Prompt _$result;
    try {
      _$result = _$v ??
          _$AiCfMetaLlama4Prompt._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'AiCfMetaLlama4Prompt', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
