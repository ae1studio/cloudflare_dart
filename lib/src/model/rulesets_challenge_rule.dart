...
part 'rulesets_challenge_rule.g.dart';
...
@BuiltValue()
abstract class RulesetsChallengeRule implements RulesetsRule, Built<RulesetsChallengeRule, RulesetsChallengeRuleBuilder> {
  RulesetsChallengeRule._();

  factory RulesetsChallengeRule([void updates(RulesetsChallengeRuleBuilder b)]) = _$RulesetsChallengeRule;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RulesetsChallengeRuleBuilder b) => b
      ..description = ''
      ..enabled = true
      ..actionParameters = {};

  @BuiltValueSerializer(custom: true)
  static Serializer<RulesetsChallengeRule> get serializer => _$RulesetsChallengeRuleSerializer();
}

class _$RulesetsChallengeRuleSerializer implements PrimitiveSerializer<RulesetsChallengeRule> {
  @override
  final Iterable<Type> types = const [RulesetsChallengeRule, _$RulesetsChallengeRule];

  @override
  final String wireName = r'RulesetsChallengeRule';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RulesetsChallengeRule object, {
  ...
  void _deserializeProperties(
    ...
    required RulesetsChallengeRuleBuilder result,
  ...
  @override
  RulesetsChallengeRule deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RulesetsChallengeRuleBuilder();
...
class RulesetsChallengeRuleActionEnum extends EnumClass {

  @BuiltValueEnumConst(wireName: r'challenge')
  static const RulesetsChallengeRuleActionEnum challenge = _$rulesetsChallengeRuleActionEnum_challenge;

  static Serializer<RulesetsChallengeRuleActionEnum> get serializer => _$rulesetsChallengeRuleActionEnumSerializer;

  const RulesetsChallengeRuleActionEnum._(String name): super(name);

  static BuiltSet<RulesetsChallengeRuleActionEnum> get values => _$rulesetsChallengeRuleActionEnumValues;
  static RulesetsChallengeRuleActionEnum valueOf(String name) => _$rulesetsChallengeRuleActionEnumValueOf(name);
}
