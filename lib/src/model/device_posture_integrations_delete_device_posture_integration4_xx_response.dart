...
class DevicePostureIntegrationsDeleteDevicePostureIntegration4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<DevicePostureIntegrationsDeleteDevicePostureIntegration4XXResponseResultEnum> get serializer => _$devicePostureIntegrationsDeleteDevicePostureIntegration4XXResponseResultEnumSerializer;

  const DevicePostureIntegrationsDeleteDevicePostureIntegration4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<DevicePostureIntegrationsDeleteDevicePostureIntegration4XXResponseResultEnum> get values => _$devicePostureIntegrationsDeleteDevicePostureIntegration4XXResponseResultEnumValues;
  static DevicePostureIntegrationsDeleteDevicePostureIntegration4XXResponseResultEnum valueOf(String name) => _$devicePostureIntegrationsDeleteDevicePostureIntegration4XXResponseResultEnumValueOf(name);
}
