...
part of 'device_enrollment_permissions_application2.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DeviceEnrollmentPermissionsApplication2
    extends DeviceEnrollmentPermissionsApplication2 {
  @override
  final String? aud;
  @override
  ...
  factory _$DeviceEnrollmentPermissionsApplication2(
          [void Function(DeviceEnrollmentPermissionsApplication2Builder)?
              updates]) =>
      (DeviceEnrollmentPermissionsApplication2Builder()..update(updates))
          ._build();

  _$DeviceEnrollmentPermissionsApplication2._(
      {this.aud,
      this.createdAt,
      this.id,
      this.scimConfig,
  ...
  @override
  DeviceEnrollmentPermissionsApplication2Builder toBuilder() =>
      DeviceEnrollmentPermissionsApplication2Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DeviceEnrollmentPermissionsApplication2 &&
        aud == other.aud &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'DeviceEnrollmentPermissionsApplication2')
          ..add('aud', aud)
...
class DeviceEnrollmentPermissionsApplication2Builder
    implements
        Builder<DeviceEnrollmentPermissionsApplication2,
            DeviceEnrollmentPermissionsApplication2Builder>,
        AccessSchemasBasicAppResponsePropsBuilder,
        AccessSchemasWarpPropsBuilder {
  _$DeviceEnrollmentPermissionsApplication2? _$v;
  ...
  DeviceEnrollmentPermissionsApplication2Builder get _$this {
    final $v = _$v;
    if ($v != null) {
      _aud = $v.aud;
...
// ignore: override_on_non_overriding_method
  void replace(covariant DeviceEnrollmentPermissionsApplication2 other) {
    _$v = other as _$DeviceEnrollmentPermissionsApplication2;
  }

  @override
  void update(
      void Function(DeviceEnrollmentPermissionsApplication2Builder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  DeviceEnrollmentPermissionsApplication2 build() => _build();

  _$DeviceEnrollmentPermissionsApplication2 _build() {
    _$DeviceEnrollmentPermissionsApplication2 _$result;
    try {
      _$result = _$v ??
          _$DeviceEnrollmentPermissionsApplication2._(
            aud: aud,
