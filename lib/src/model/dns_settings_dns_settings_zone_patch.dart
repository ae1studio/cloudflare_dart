...
part 'dns_settings_dns_settings_zone_patch.g.dart';
...
/// * [nameservers] 
@BuiltValue()
abstract class DnsSettingsDnsSettingsZonePatch implements DnsSettingsDnsSettingsPatch, Built<DnsSettingsDnsSettingsZonePatch, DnsSettingsDnsSettingsZonePatchBuilder> {
  @BuiltValueField(wireName: r'nameservers')
  DnsSettingsDnsSettingsZonePatchAllOfNameservers? get nameservers;

  DnsSettingsDnsSettingsZonePatch._();

  factory DnsSettingsDnsSettingsZonePatch([void updates(DnsSettingsDnsSettingsZonePatchBuilder b)]) = _$DnsSettingsDnsSettingsZonePatch;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DnsSettingsDnsSettingsZonePatchBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DnsSettingsDnsSettingsZonePatch> get serializer => _$DnsSettingsDnsSettingsZonePatchSerializer();
}

class _$DnsSettingsDnsSettingsZonePatchSerializer implements PrimitiveSerializer<DnsSettingsDnsSettingsZonePatch> {
  @override
  final Iterable<Type> types = const [DnsSettingsDnsSettingsZonePatch, _$DnsSettingsDnsSettingsZonePatch];

  @override
  final String wireName = r'DnsSettingsDnsSettingsZonePatch';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    DnsSettingsDnsSettingsZonePatch object, {
    ...
    if (object.nameservers != null) {
      ...
      yield serializers.serialize(
        object.nameservers,
        specifiedType: const FullType(DnsSettingsDnsSettingsZonePatchAllOfNameservers),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required DnsSettingsDnsSettingsZonePatchBuilder result,
      ...
      switch (key) {
        ...
        case r'nameservers':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(DnsSettingsDnsSettingsZonePatchAllOfNameservers),
          ) as DnsSettingsDnsSettingsZonePatchAllOfNameservers;
  ...
  @override
  DnsSettingsDnsSettingsZonePatch deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DnsSettingsDnsSettingsZonePatchBuilder();
