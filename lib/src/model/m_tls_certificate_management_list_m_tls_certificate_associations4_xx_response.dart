...
class MTlsCertificateManagementListMTlsCertificateAssociations4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<MTlsCertificateManagementListMTlsCertificateAssociations4XXResponseResultEnum> get serializer => _$mTlsCertificateManagementListMTlsCertificateAssociations4XXResponseResultSerializer;

  const MTlsCertificateManagementListMTlsCertificateAssociations4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<MTlsCertificateManagementListMTlsCertificateAssociations4XXResponseResultEnum> get values => _$mTlsCertificateManagementListMTlsCertificateAssociations4XXResponseResultValues;
  static MTlsCertificateManagementListMTlsCertificateAssociations4XXResponseResultEnum valueOf(String name) => _$mTlsCertificateManagementListMTlsCertificateAssociations4XXResponseResultValueOf(name);
}
