...
part 'ai_cf_meta_llama4_messages_inner.g.dart';
...
@BuiltValue()
abstract class AiCfMetaLlama4MessagesInner implements Built<AiCfMetaLlama4MessagesInner, AiCfMetaLlama4MessagesInnerBuilder> {
  ...
  AiCfMetaLlama4MessagesInner._();

  factory AiCfMetaLlama4MessagesInner([void updates(AiCfMetaLlama4MessagesInnerBuilder b)]) = _$AiCfMetaLlama4MessagesInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AiCfMetaLlama4MessagesInnerBuilder b) => b
      ..maxTokens = 256
      ..raw = false
      ..stream = false
      ..temperature = 0.15;
  ...
  static Serializer<AiCfMetaLlama4MessagesInner> get serializer => _$AiCfMetaLlama4MessagesInnerSerializer();
}

class _$AiCfMetaLlama4MessagesInnerSerializer implements PrimitiveSerializer<AiCfMetaLlama4MessagesInner> {
  @override
  final Iterable<Type> types = const [AiCfMetaLlama4MessagesInner, _$AiCfMetaLlama4MessagesInner];

  @override
  final String wireName = r'AiCfMetaLlama4MessagesInner';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AiCfMetaLlama4MessagesInner object, {
  ...
  void _deserializeProperties(
    ...
    required AiCfMetaLlama4MessagesInnerBuilder result,
  ...
  @override
  AiCfMetaLlama4MessagesInner deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AiCfMetaLlama4MessagesInnerBuilder();
