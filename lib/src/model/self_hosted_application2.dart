...
part 'self_hosted_application2.g.dart';
...
abstract class SelfHostedApplication2 implements AccessSchemasBasicAppResponseProps, AccessSchemasSelfHostedProps, Built<SelfHostedApplication2, SelfHostedApplication2Builder> {
  ...
  factory SelfHostedApplication2([void updates(SelfHostedApplication2Builder b)]) = _$SelfHostedApplication2;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SelfHostedApplication2Builder b) => b
  ...
  static Serializer<SelfHostedApplication2> get serializer => _$SelfHostedApplication2Serializer();
}

class _$SelfHostedApplication2Serializer implements PrimitiveSerializer<SelfHostedApplication2> {
  @override
  final Iterable<Type> types = const [SelfHostedApplication2, _$SelfHostedApplication2];

  @override
  final String wireName = r'SelfHostedApplication2';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SelfHostedApplication2 object, {
  ...
  void _deserializeProperties(
    ...
    required SelfHostedApplication2Builder result,
  ...
  @override
  SelfHostedApplication2 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SelfHostedApplication2Builder();
