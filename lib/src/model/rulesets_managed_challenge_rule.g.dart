...
part of 'rulesets_managed_challenge_rule.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const RulesetsManagedChallengeRuleActionEnum
    _$rulesetsManagedChallengeRuleActionEnum_managedChallenge =
    const RulesetsManagedChallengeRuleActionEnum._('managedChallenge');

RulesetsManagedChallengeRuleActionEnum
    _$rulesetsManagedChallengeRuleActionEnumValueOf(String name) {
  switch (name) {
    case 'managedChallenge':
      return _$rulesetsManagedChallengeRuleActionEnum_managedChallenge;
    default:
      throw ArgumentError(name);
  }
}

final BuiltSet<RulesetsManagedChallengeRuleActionEnum>
    _$rulesetsManagedChallengeRuleActionEnumValues = BuiltSet<
        RulesetsManagedChallengeRuleActionEnum>(const <RulesetsManagedChallengeRuleActionEnum>[
  _$rulesetsManagedChallengeRuleActionEnum_managedChallenge,
]);

Serializer<RulesetsManagedChallengeRuleActionEnum>
    _$rulesetsManagedChallengeRuleActionEnumSerializer =
    _$RulesetsManagedChallengeRuleActionEnumSerializer();

class _$RulesetsManagedChallengeRuleActionEnumSerializer
    implements PrimitiveSerializer<RulesetsManagedChallengeRuleActionEnum> {
  ...
  @override
  final String wireName = 'RulesetsManagedChallengeRuleActionEnum';

  @override
  Object serialize(Serializers serializers,
          RulesetsManagedChallengeRuleActionEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  RulesetsManagedChallengeRuleActionEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      RulesetsManagedChallengeRuleActionEnum.valueOf(
          _fromWire[serialized] ?? (serialized is String ? serialized : ''));
}

class _$RulesetsManagedChallengeRule extends RulesetsManagedChallengeRule {
  @override
  ...
  factory _$RulesetsManagedChallengeRule(
          [void Function(RulesetsManagedChallengeRuleBuilder)? updates]) =>
      (RulesetsManagedChallengeRuleBuilder()..update(updates))._build();

  _$RulesetsManagedChallengeRule._(
      ...
      : super._();
  @override
  RulesetsManagedChallengeRule rebuild(
          void Function(RulesetsManagedChallengeRuleBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RulesetsManagedChallengeRuleBuilder toBuilder() =>
      RulesetsManagedChallengeRuleBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RulesetsManagedChallengeRule &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RulesetsManagedChallengeRule')
...
class RulesetsManagedChallengeRuleBuilder
    implements
        Builder<RulesetsManagedChallengeRule,
            RulesetsManagedChallengeRuleBuilder>,
        RulesetsRuleBuilder {
  _$RulesetsManagedChallengeRule? _$v;
  ...
  RulesetsManagedChallengeRuleBuilder() {
    RulesetsManagedChallengeRule._defaults(this);
  }

  RulesetsManagedChallengeRuleBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant RulesetsManagedChallengeRule other) {
    _$v = other as _$RulesetsManagedChallengeRule;
  }

  @override
  void update(void Function(RulesetsManagedChallengeRuleBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RulesetsManagedChallengeRule build() => _build();

  _$RulesetsManagedChallengeRule _build() {
    _$RulesetsManagedChallengeRule _$result;
    try {
      _$result = _$v ??
          _$RulesetsManagedChallengeRule._(
            lastUpdated: BuiltValueNullFieldError.checkNotNull(
                lastUpdated, r'RulesetsManagedChallengeRule', 'lastUpdated'),
            version: BuiltValueNullFieldError.checkNotNull(
                version, r'RulesetsManagedChallengeRule', 'version'),
            action: action,
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'RulesetsManagedChallengeRule', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
