...
part of 'access_reusable_policy_resp.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$AccessReusablePolicyResp extends AccessReusablePolicyResp {
  @override
  final int? appCount;
  @override
  final bool? reusable;
  ...
  factory _$AccessReusablePolicyResp(
          [void Function(AccessReusablePolicyRespBuilder)? updates]) =>
      (AccessReusablePolicyRespBuilder()..update(updates))._build();

  _$AccessReusablePolicyResp._(
      {this.appCount,
      this.reusable,
      ...
      : super._();
  @override
  AccessReusablePolicyResp rebuild(
          void Function(AccessReusablePolicyRespBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  AccessReusablePolicyRespBuilder toBuilder() =>
      AccessReusablePolicyRespBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AccessReusablePolicyResp &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AccessReusablePolicyResp')
...
class AccessReusablePolicyRespBuilder
    implements
        Builder<AccessReusablePolicyResp, AccessReusablePolicyRespBuilder>,
        AccessPolicyRespBuilder {
  _$AccessReusablePolicyResp? _$v;

  int? _appCount;
  int? get appCount => _$this._appCount;
  set appCount(covariant int? appCount) => _$this._appCount = appCount;

  bool? _reusable;
  bool? get reusable => _$this._reusable;
  set reusable(covariant bool? reusable) => _$this._reusable = reusable;
  ...
  AccessReusablePolicyRespBuilder() {
    AccessReusablePolicyResp._defaults(this);
  }

  AccessReusablePolicyRespBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant AccessReusablePolicyResp other) {
    _$v = other as _$AccessReusablePolicyResp;
  }

  @override
  void update(void Function(AccessReusablePolicyRespBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  AccessReusablePolicyResp build() => _build();

  _$AccessReusablePolicyResp _build() {
    _$AccessReusablePolicyResp _$result;
    try {
      _$result = _$v ??
          _$AccessReusablePolicyResp._(
            appCount: appCount,
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'AccessReusablePolicyResp', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
