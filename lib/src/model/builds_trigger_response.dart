...
part 'builds_trigger_response.g.dart';
...
/// * [triggerUuid] 
@BuiltValue()
abstract class BuildsTriggerResponse implements Built<BuildsTriggerResponse, BuildsTriggerResponseBuilder> {
  ...
  BuildsTriggerResponse._();

  factory BuildsTriggerResponse([void updates(BuildsTriggerResponseBuilder b)]) = _$BuildsTriggerResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BuildsTriggerResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<BuildsTriggerResponse> get serializer => _$BuildsTriggerResponseSerializer();
}

class _$BuildsTriggerResponseSerializer implements PrimitiveSerializer<BuildsTriggerResponse> {
  @override
  final Iterable<Type> types = const [BuildsTriggerResponse, _$BuildsTriggerResponse];

  @override
  final String wireName = r'BuildsTriggerResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BuildsTriggerResponse object, {
  ...
  void _deserializeProperties(
    ...
    required BuildsTriggerResponseBuilder result,
  ...
  @override
  BuildsTriggerResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BuildsTriggerResponseBuilder();
