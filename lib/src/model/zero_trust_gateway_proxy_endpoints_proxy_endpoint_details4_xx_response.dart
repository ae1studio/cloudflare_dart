...
class ZeroTrustGatewayProxyEndpointsProxyEndpointDetails4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<ZeroTrustGatewayProxyEndpointsProxyEndpointDetails4XXResponseResultEnum> get serializer => _$zeroTrustGatewayProxyEndpointsProxyEndpointDetails4XXResponseResultSerializer;

  const ZeroTrustGatewayProxyEndpointsProxyEndpointDetails4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<ZeroTrustGatewayProxyEndpointsProxyEndpointDetails4XXResponseResultEnum> get values => _$zeroTrustGatewayProxyEndpointsProxyEndpointDetails4XXResponseResultValues;
  static ZeroTrustGatewayProxyEndpointsProxyEndpointDetails4XXResponseResultEnum valueOf(String name) => _$zeroTrustGatewayProxyEndpointsProxyEndpointDetails4XXResponseResultValueOf(name);
}
