...
part of 'edit_worker_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$EditWorkerRequest extends EditWorkerRequest {
  @override
  ...
  factory _$EditWorkerRequest(
          [void Function(EditWorkerRequestBuilder)? updates]) =>
      (EditWorkerRequestBuilder()..update(updates))._build();

  _$EditWorkerRequest._(
      ...
      : super._();
  @override
  EditWorkerRequest rebuild(void Function(EditWorkerRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  EditWorkerRequestBuilder toBuilder() =>
      EditWorkerRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is EditWorkerRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'EditWorkerRequest')
...
class EditWorkerRequestBuilder
    implements
        Builder<EditWorkerRequest, EditWorkerRequestBuilder>,
        WorkersWorkerBuilder {
  _$EditWorkerRequest? _$v;
  ...
  EditWorkerRequestBuilder() {
    EditWorkerRequest._defaults(this);
  }

  EditWorkerRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant EditWorkerRequest other) {
    _$v = other as _$EditWorkerRequest;
  }

  @override
  void update(void Function(EditWorkerRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  EditWorkerRequest build() => _build();

  _$EditWorkerRequest _build() {
    _$EditWorkerRequest _$result;
    try {
      _$result = _$v ??
          _$EditWorkerRequest._(
            createdOn: BuiltValueNullFieldError.checkNotNull(
                createdOn, r'EditWorkerRequest', 'createdOn'),
            id: BuiltValueNullFieldError.checkNotNull(
                id, r'EditWorkerRequest', 'id'),
            logpush: BuiltValueNullFieldError.checkNotNull(
                logpush, r'EditWorkerRequest', 'logpush'),
            name: BuiltValueNullFieldError.checkNotNull(
                name, r'EditWorkerRequest', 'name'),
            ...
            updatedOn: BuiltValueNullFieldError.checkNotNull(
                updatedOn, r'EditWorkerRequest', 'updatedOn'),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'EditWorkerRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
