...
part 'browser_vnc_application2.g.dart';
...
@BuiltValue()
abstract class BrowserVNCApplication2 implements AccessSchemasBasicAppResponseProps, AccessSchemasVncProps, Built<BrowserVNCApplication2, BrowserVNCApplication2Builder> {
  BrowserVNCApplication2._();

  factory BrowserVNCApplication2([void updates(BrowserVNCApplication2Builder b)]) = _$BrowserVNCApplication2;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BrowserVNCApplication2Builder b) => b
  ...
  static Serializer<BrowserVNCApplication2> get serializer => _$BrowserVNCApplication2Serializer();
}

class _$BrowserVNCApplication2Serializer implements PrimitiveSerializer<BrowserVNCApplication2> {
  @override
  final Iterable<Type> types = const [BrowserVNCApplication2, _$BrowserVNCApplication2];

  @override
  final String wireName = r'BrowserVNCApplication2';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BrowserVNCApplication2 object, {
  ...
  void _deserializeProperties(
    ...
    required BrowserVNCApplication2Builder result,
  ...
  @override
  BrowserVNCApplication2 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BrowserVNCApplication2Builder();
