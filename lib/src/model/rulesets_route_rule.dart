...
part 'rulesets_route_rule.g.dart';
...
@BuiltValue()
abstract class RulesetsRouteRule implements RulesetsRule, Built<RulesetsRouteRule, RulesetsRouteRuleBuilder> {
  RulesetsRouteRule._();

  factory RulesetsRouteRule([void updates(RulesetsRouteRuleBuilder b)]) = _$RulesetsRouteRule;
  ...
  static Serializer<RulesetsRouteRule> get serializer => _$RulesetsRouteRuleSerializer();
}

class _$RulesetsRouteRuleSerializer implements PrimitiveSerializer<RulesetsRouteRule> {
  @override
  final Iterable<Type> types = const [RulesetsRouteRule, _$RulesetsRouteRule];

  @override
  final String wireName = r'RulesetsRouteRule';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RulesetsRouteRule object, {
  ...
  void _deserializeProperties(
    ...
    required RulesetsRouteRuleBuilder result,
  ...
  @override
  RulesetsRouteRule deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RulesetsRouteRuleBuilder();
...
class RulesetsRouteRuleActionEnum extends EnumClass {
