...
class RadarGetGeolocations200ResponseResultGeolocationsInnerParentParentTypeEnum extends EnumClass {
  ...
  static Serializer<RadarGetGeolocations200ResponseResultGeolocationsInnerParentParentTypeEnum> get serializer => _$radarGetGeolocations200ResponseResultGeolocationsInnerParentParentTypeSerializer;

  const RadarGetGeolocations200ResponseResultGeolocationsInnerParentParentTypeEnum._(String name): super(name);

  static BuiltSet<RadarGetGeolocations200ResponseResultGeolocationsInnerParentParentTypeEnum> get values => _$radarGetGeolocations200ResponseResultGeolocationsInnerParentParentTypeValues;
  static RadarGetGeolocations200ResponseResultGeolocationsInnerParentParentTypeEnum valueOf(String name) => _$radarGetGeolocations200ResponseResultGeolocationsInnerParentParentTypeValueOf(name);
}
