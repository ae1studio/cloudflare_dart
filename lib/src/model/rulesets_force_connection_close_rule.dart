...
part 'rulesets_force_connection_close_rule.g.dart';
...
abstract class RulesetsForceConnectionCloseRule implements RulesetsRule, Built<RulesetsForceConnectionCloseRule, RulesetsForceConnectionCloseRuleBuilder> {
  ...
  factory RulesetsForceConnectionCloseRule([void updates(RulesetsForceConnectionCloseRuleBuilder b)]) = _$RulesetsForceConnectionCloseRule;
  ...
  static Serializer<RulesetsForceConnectionCloseRule> get serializer => _$RulesetsForceConnectionCloseRuleSerializer();
}

class _$RulesetsForceConnectionCloseRuleSerializer implements PrimitiveSerializer<RulesetsForceConnectionCloseRule> {
  @override
  final Iterable<Type> types = const [RulesetsForceConnectionCloseRule, _$RulesetsForceConnectionCloseRule];

  @override
  final String wireName = r'RulesetsForceConnectionCloseRule';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RulesetsForceConnectionCloseRule object, {
  ...
  void _deserializeProperties(
    ...
    required RulesetsForceConnectionCloseRuleBuilder result,
  ...
  @override
  RulesetsForceConnectionCloseRule deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RulesetsForceConnectionCloseRuleBuilder();
...
class RulesetsForceConnectionCloseRuleActionEnum extends EnumClass {
