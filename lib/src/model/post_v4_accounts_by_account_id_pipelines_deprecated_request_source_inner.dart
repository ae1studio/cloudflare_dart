...
class PostV4AccountsByAccountIdPipelinesDeprecatedRequestSourceInnerFormatEnum extends EnumClass {
  ...
  static Serializer<PostV4AccountsByAccountIdPipelinesDeprecatedRequestSourceInnerFormatEnum> get serializer => _$postV4AccountsByAccountIdPipelinesDeprecatedRequestSourceInnerFormatEnumSerializer;

  const PostV4AccountsByAccountIdPipelinesDeprecatedRequestSourceInnerFormatEnum._(String name): super(name);

  static BuiltSet<PostV4AccountsByAccountIdPipelinesDeprecatedRequestSourceInnerFormatEnum> get values => _$postV4AccountsByAccountIdPipelinesDeprecatedRequestSourceInnerFormatEnumValues;
  static PostV4AccountsByAccountIdPipelinesDeprecatedRequestSourceInnerFormatEnum valueOf(String name) => _$postV4AccountsByAccountIdPipelinesDeprecatedRequestSourceInnerFormatEnumValueOf(name);
}
