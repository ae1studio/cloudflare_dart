...
part 'rulesets_skip_rule.g.dart';
...
@BuiltValue()
abstract class RulesetsSkipRule implements RulesetsRule, Built<RulesetsSkipRule, RulesetsSkipRuleBuilder> {
  RulesetsSkipRule._();

  factory RulesetsSkipRule([void updates(RulesetsSkipRuleBuilder b)]) = _$RulesetsSkipRule;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RulesetsSkipRuleBuilder b) => b
      ..description = ''
      ..enabled = true
      ..actionParameters = {};

  @BuiltValueSerializer(custom: true)
  static Serializer<RulesetsSkipRule> get serializer => _$RulesetsSkipRuleSerializer();
}

class _$RulesetsSkipRuleSerializer implements PrimitiveSerializer<RulesetsSkipRule> {
  @override
  final Iterable<Type> types = const [RulesetsSkipRule, _$RulesetsSkipRule];

  @override
  final String wireName = r'RulesetsSkipRule';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RulesetsSkipRule object, {
  ...
  void _deserializeProperties(
    ...
    required RulesetsSkipRuleBuilder result,
  ...
  @override
  RulesetsSkipRule deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RulesetsSkipRuleBuilder();
...
class RulesetsSkipRuleActionEnum extends EnumClass {

  @BuiltValueEnumConst(wireName: r'skip')
  static const RulesetsSkipRuleActionEnum skip = _$rulesetsSkipRuleActionEnum_skip;

  static Serializer<RulesetsSkipRuleActionEnum> get serializer => _$rulesetsSkipRuleActionEnumSerializer;

  const RulesetsSkipRuleActionEnum._(String name): super(name);

  static BuiltSet<RulesetsSkipRuleActionEnum> get values => _$rulesetsSkipRuleActionEnumValues;
  static RulesetsSkipRuleActionEnum valueOf(String name) => _$rulesetsSkipRuleActionEnumValueOf(name);
}
