...
part 'access_schemas_saml_all_of_config.g.dart';
...
@BuiltValue()
abstract class AccessSchemasSamlAllOfConfig implements Built<AccessSchemasSamlAllOfConfig, AccessSchemasSamlAllOfConfigBuilder> {
  ...
  AccessSchemasSamlAllOfConfig._();

  factory AccessSchemasSamlAllOfConfig([void updates(AccessSchemasSamlAllOfConfigBuilder b)]) = _$AccessSchemasSamlAllOfConfig;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AccessSchemasSamlAllOfConfigBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AccessSchemasSamlAllOfConfig> get serializer => _$AccessSchemasSamlAllOfConfigSerializer();
}

class _$AccessSchemasSamlAllOfConfigSerializer implements PrimitiveSerializer<AccessSchemasSamlAllOfConfig> {
  @override
  final Iterable<Type> types = const [AccessSchemasSamlAllOfConfig, _$AccessSchemasSamlAllOfConfig];

  @override
  final String wireName = r'AccessSchemasSamlAllOfConfig';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccessSchemasSamlAllOfConfig object, {
  ...
  void _deserializeProperties(
    ...
    required AccessSchemasSamlAllOfConfigBuilder result,
  ...
  @override
  AccessSchemasSamlAllOfConfig deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccessSchemasSamlAllOfConfigBuilder();
