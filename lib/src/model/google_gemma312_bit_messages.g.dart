...
part of 'google_gemma312_bit_messages.dart';
...
class _$GoogleGemma312BItMessages extends GoogleGemma312BItMessages {
  ...
  factory _$GoogleGemma312BItMessages(
          [void Function(GoogleGemma312BItMessagesBuilder)? updates]) =>
  ...
  _$GoogleGemma312BItMessages._(
      ...
      : super._();
  @override
  GoogleGemma312BItMessages rebuild(
          void Function(GoogleGemma312BItMessagesBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GoogleGemma312BItMessagesBuilder toBuilder() =>
      GoogleGemma312BItMessagesBuilder()..replace(this);
...
class GoogleGemma312BItMessagesBuilder
    implements
  ...
  GoogleGemma312BItMessagesBuilder() {
    GoogleGemma312BItMessages._defaults(this);
  }
  ...
  @override
  void replace(GoogleGemma312BItMessages other) {
    _$v = other as _$GoogleGemma312BItMessages;
  }

  @override
  void update(void Function(GoogleGemma312BItMessagesBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GoogleGemma312BItMessages build() => _build();

  _$GoogleGemma312BItMessages _build() {
    _$GoogleGemma312BItMessages _$result;
    try {
      _$result = _$v ??
          _$GoogleGemma312BItMessages._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'GoogleGemma312BItMessages', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
