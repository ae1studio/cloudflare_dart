...
part 'magic_gre_tunnel_add_single_request.g.dart';
...
abstract class MagicGreTunnelAddSingleRequest  {
  ...
  static Serializer<MagicGreTunnelAddSingleRequest> get serializer => _$MagicGreTunnelAddSingleRequestSerializer();
}

class _$MagicGreTunnelAddSingleRequestSerializer implements PrimitiveSerializer<MagicGreTunnelAddSingleRequest> {
  @override
  final Iterable<Type> types = const [MagicGreTunnelAddSingleRequest];

  @override
  final String wireName = r'MagicGreTunnelAddSingleRequest';
  ...
  @override
  MagicGreTunnelAddSingleRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized, specifiedType: FullType($MagicGreTunnelAddSingleRequest)) as $MagicGreTunnelAddSingleRequest;
  }
}

/// a concrete implementation of [MagicGreTunnelAddSingleRequest], since [MagicGreTunnelAddSingleRequest] is not instantiable
@BuiltValue(instantiable: true)
abstract class $MagicGreTunnelAddSingleRequest implements MagicGreTunnelAddSingleRequest, Built<$MagicGreTunnelAddSingleRequest, $MagicGreTunnelAddSingleRequestBuilder> {
  $MagicGreTunnelAddSingleRequest._();

  factory $MagicGreTunnelAddSingleRequest([void Function($MagicGreTunnelAddSingleRequestBuilder)? updates]) = _$$MagicGreTunnelAddSingleRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($MagicGreTunnelAddSingleRequestBuilder b) => b;
...
class _$$MagicGreTunnelAddSingleRequestSerializer implements PrimitiveSerializer<$MagicGreTunnelAddSingleRequest> {
  @override
  final Iterable<Type> types = const [$MagicGreTunnelAddSingleRequest, _$$MagicGreTunnelAddSingleRequest];
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(MagicGreTunnelAddSingleRequest))!;
  }
  ...
  void _deserializeProperties(
    ...
    required MagicGreTunnelAddSingleRequestBuilder result,
  ...
  $MagicGreTunnelAddSingleRequest deserialize(
    ...
    final result = $MagicGreTunnelAddSingleRequestBuilder();
