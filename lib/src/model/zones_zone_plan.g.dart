...
part of 'zones_zone_plan.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ZonesZonePlan extends ZonesZonePlan {
  @override
  ...
  factory _$ZonesZonePlan([void Function(ZonesZonePlanBuilder)? updates]) =>
      (ZonesZonePlanBuilder()..update(updates))._build();
  ...
  _$ZonesZonePlan._(
      ...
      : super._();
  @override
  ZonesZonePlan rebuild(void Function(ZonesZonePlanBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ZonesZonePlanBuilder toBuilder() => ZonesZonePlanBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ZonesZonePlan &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ZonesZonePlan')
...
class ZonesZonePlanBuilder
    implements Builder<ZonesZonePlan, ZonesZonePlanBuilder> {
  _$ZonesZonePlan? _$v;
  ...
  ZonesZonePlanBuilder() {
    ZonesZonePlan._defaults(this);
  }

  ZonesZonePlanBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(ZonesZonePlan other) {
    _$v = other as _$ZonesZonePlan;
  }

  @override
  void update(void Function(ZonesZonePlanBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ZonesZonePlan build() => _build();

  _$ZonesZonePlan _build() {
    final _$result = _$v ??
        _$ZonesZonePlan._(
