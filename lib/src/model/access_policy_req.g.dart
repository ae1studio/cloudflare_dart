...
part of 'access_policy_req.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

abstract class AccessPolicyReqBuilder implements AccessBasePolicyReqBuilder {
  void replace(covariant AccessPolicyReq other);
  void update(void Function(AccessPolicyReqBuilder) updates);
...
class _$$AccessPolicyReq extends $AccessPolicyReq {
  @override
  ...
  factory _$$AccessPolicyReq(
          [void Function($AccessPolicyReqBuilder)? updates]) =>
      ($AccessPolicyReqBuilder()..update(updates))._build();
  ...
  _$$AccessPolicyReq._(
      ...
      : super._();
  @override
  $AccessPolicyReq rebuild(void Function($AccessPolicyReqBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  $AccessPolicyReqBuilder toBuilder() =>
      $AccessPolicyReqBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is $AccessPolicyReq &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'$AccessPolicyReq')
...
class $AccessPolicyReqBuilder
    implements
        Builder<$AccessPolicyReq, $AccessPolicyReqBuilder>,
        AccessPolicyReqBuilder {
  _$$AccessPolicyReq? _$v;
  ...
  $AccessPolicyReqBuilder() {
    $AccessPolicyReq._defaults(this);
  }

  $AccessPolicyReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant $AccessPolicyReq other) {
    _$v = other as _$$AccessPolicyReq;
  }
  ...
  @override
  $AccessPolicyReq build() => _build();

  _$$AccessPolicyReq _build() {
    _$$AccessPolicyReq _$result;
    try {
      _$result = _$v ??
          _$$AccessPolicyReq._(
            ...
            decision: BuiltValueNullFieldError.checkNotNull(
                decision, r'$AccessPolicyReq', 'decision'),
            include: include.build(),
            name: BuiltValueNullFieldError.checkNotNull(
                name, r'$AccessPolicyReq', 'name'),
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'$AccessPolicyReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
