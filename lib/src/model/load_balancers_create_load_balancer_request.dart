...
part 'load_balancers_create_load_balancer_request.g.dart';
...
abstract class LoadBalancersCreateLoadBalancerRequest implements Built<LoadBalancersCreateLoadBalancerRequest, LoadBalancersCreateLoadBalancerRequestBuilder> {
  ...
  LoadBalancersCreateLoadBalancerRequest._();

  factory LoadBalancersCreateLoadBalancerRequest([void updates(LoadBalancersCreateLoadBalancerRequestBuilder b)]) = _$LoadBalancersCreateLoadBalancerRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LoadBalancersCreateLoadBalancerRequestBuilder b) => b
      ..proxied = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<LoadBalancersCreateLoadBalancerRequest> get serializer => _$LoadBalancersCreateLoadBalancerRequestSerializer();
}

class _$LoadBalancersCreateLoadBalancerRequestSerializer implements PrimitiveSerializer<LoadBalancersCreateLoadBalancerRequest> {
  @override
  final Iterable<Type> types = const [LoadBalancersCreateLoadBalancerRequest, _$LoadBalancersCreateLoadBalancerRequest];

  @override
  final String wireName = r'LoadBalancersCreateLoadBalancerRequest';
  ...
  void _deserializeProperties(
    ...
    required LoadBalancersCreateLoadBalancerRequestBuilder result,
  ...
  @override
  LoadBalancersCreateLoadBalancerRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = LoadBalancersCreateLoadBalancerRequestBuilder();
