...
part 'rulesets_compress_response_rule.g.dart';
...
@BuiltValue()
abstract class RulesetsCompressResponseRule implements RulesetsRule, Built<RulesetsCompressResponseRule, RulesetsCompressResponseRuleBuilder> {
  RulesetsCompressResponseRule._();

  factory RulesetsCompressResponseRule([void updates(RulesetsCompressResponseRuleBuilder b)]) = _$RulesetsCompressResponseRule;
  ...
  static Serializer<RulesetsCompressResponseRule> get serializer => _$RulesetsCompressResponseRuleSerializer();
}

class _$RulesetsCompressResponseRuleSerializer implements PrimitiveSerializer<RulesetsCompressResponseRule> {
  @override
  final Iterable<Type> types = const [RulesetsCompressResponseRule, _$RulesetsCompressResponseRule];

  @override
  final String wireName = r'RulesetsCompressResponseRule';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RulesetsCompressResponseRule object, {
  ...
  void _deserializeProperties(
    ...
    required RulesetsCompressResponseRuleBuilder result,
  ...
  @override
  RulesetsCompressResponseRule deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RulesetsCompressResponseRuleBuilder();
...
class RulesetsCompressResponseRuleActionEnum extends EnumClass {
