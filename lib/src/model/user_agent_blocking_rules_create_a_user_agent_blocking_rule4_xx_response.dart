...
class UserAgentBlockingRulesCreateAUserAgentBlockingRule4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<UserAgentBlockingRulesCreateAUserAgentBlockingRule4XXResponseResultEnum> get serializer => _$userAgentBlockingRulesCreateAUserAgentBlockingRule4XXResponseResultEnumSerializer;

  const UserAgentBlockingRulesCreateAUserAgentBlockingRule4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<UserAgentBlockingRulesCreateAUserAgentBlockingRule4XXResponseResultEnum> get values => _$userAgentBlockingRulesCreateAUserAgentBlockingRule4XXResponseResultEnumValues;
  static UserAgentBlockingRulesCreateAUserAgentBlockingRule4XXResponseResultEnum valueOf(String name) => _$userAgentBlockingRulesCreateAUserAgentBlockingRule4XXResponseResultEnumValueOf(name);
}
