...
part 'workers_script_response_collection_all_of_result.g.dart';
...
@BuiltValue()
abstract class WorkersScriptResponseCollectionAllOfResult implements WorkersScriptResponse, Built<WorkersScriptResponseCollectionAllOfResult, WorkersScriptResponseCollectionAllOfResultBuilder> {
  /// Routes associated with the Worker.
  @BuiltValueField(wireName: r'routes')
  BuiltList<WorkersRoute>? get routes;

  WorkersScriptResponseCollectionAllOfResult._();

  factory WorkersScriptResponseCollectionAllOfResult([void updates(WorkersScriptResponseCollectionAllOfResultBuilder b)]) = _$WorkersScriptResponseCollectionAllOfResult;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(WorkersScriptResponseCollectionAllOfResultBuilder b) => b
      ..compatibilityFlags = ListBuilder()
      ..logpush = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<WorkersScriptResponseCollectionAllOfResult> get serializer => _$WorkersScriptResponseCollectionAllOfResultSerializer();
}

class _$WorkersScriptResponseCollectionAllOfResultSerializer implements PrimitiveSerializer<WorkersScriptResponseCollectionAllOfResult> {
  @override
  final Iterable<Type> types = const [WorkersScriptResponseCollectionAllOfResult, _$WorkersScriptResponseCollectionAllOfResult];

  @override
  final String wireName = r'WorkersScriptResponseCollectionAllOfResult';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    WorkersScriptResponseCollectionAllOfResult object, {
    ...
    if (object.routes != null) {
      ...
      yield serializers.serialize(
        object.routes,
        specifiedType: const FullType.nullable(BuiltList, [FullType(WorkersRoute)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required WorkersScriptResponseCollectionAllOfResultBuilder result,
  ...
  @override
  WorkersScriptResponseCollectionAllOfResult deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = WorkersScriptResponseCollectionAllOfResultBuilder();
