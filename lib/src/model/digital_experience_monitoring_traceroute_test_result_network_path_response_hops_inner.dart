...
class DigitalExperienceMonitoringTracerouteTestResultNetworkPathResponseHopsInnerMileEnum extends EnumClass {
  ...
  static Serializer<DigitalExperienceMonitoringTracerouteTestResultNetworkPathResponseHopsInnerMileEnum> get serializer => _$digitalExperienceMonitoringTracerouteTestResultNetworkPathResponseHopsInnerMileSerializer;

  const DigitalExperienceMonitoringTracerouteTestResultNetworkPathResponseHopsInnerMileEnum._(String name): super(name);

  static BuiltSet<DigitalExperienceMonitoringTracerouteTestResultNetworkPathResponseHopsInnerMileEnum> get values => _$digitalExperienceMonitoringTracerouteTestResultNetworkPathResponseHopsInnerMileValues;
  static DigitalExperienceMonitoringTracerouteTestResultNetworkPathResponseHopsInnerMileEnum valueOf(String name) => _$digitalExperienceMonitoringTracerouteTestResultNetworkPathResponseHopsInnerMileValueOf(name);
}
