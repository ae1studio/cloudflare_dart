...
part of 'access_schemas_feature_app_props.dart';
...
class _$$AccessSchemasFeatureAppProps extends $AccessSchemasFeatureAppProps {
  ...
  @override
  $AccessSchemasFeatureAppPropsBuilder toBuilder() =>
      $AccessSchemasFeatureAppPropsBuilder()..replace(this);
...
class $AccessSchemasFeatureAppPropsBuilder
    implements
        Builder<$AccessSchemasFeatureAppProps,
  ...
  @override
  void replace(covariant $AccessSchemasFeatureAppProps other) {
    _$v = other as _$$AccessSchemasFeatureAppProps;
  }
  ...
  @override
  $AccessSchemasFeatureAppProps build() => _build();

  _$$AccessSchemasFeatureAppProps _build() {
    _$$AccessSchemasFeatureAppProps _$result;
    try {
      _$result = _$v ??
          _$$AccessSchemasFeatureAppProps._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'$AccessSchemasFeatureAppProps', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
