...
part of 'rulesets_skip_rule.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const RulesetsSkipRuleActionEnum _$rulesetsSkipRuleActionEnum_skip =
    const RulesetsSkipRuleActionEnum._('skip');

RulesetsSkipRuleActionEnum _$rulesetsSkipRuleActionEnumValueOf(String name) {
  switch (name) {
    case 'skip':
      return _$rulesetsSkipRuleActionEnum_skip;
    default:
      throw ArgumentError(name);
  }
}

final BuiltSet<RulesetsSkipRuleActionEnum> _$rulesetsSkipRuleActionEnumValues =
    BuiltSet<RulesetsSkipRuleActionEnum>(const <RulesetsSkipRuleActionEnum>[
  _$rulesetsSkipRuleActionEnum_skip,
]);

Serializer<RulesetsSkipRuleActionEnum> _$rulesetsSkipRuleActionEnumSerializer =
    _$RulesetsSkipRuleActionEnumSerializer();

class _$RulesetsSkipRuleActionEnumSerializer
    implements PrimitiveSerializer<RulesetsSkipRuleActionEnum> {
  ...
  @override
  final Iterable<Type> types = const <Type>[RulesetsSkipRuleActionEnum];
  @override
  final String wireName = 'RulesetsSkipRuleActionEnum';

  @override
  Object serialize(Serializers serializers, RulesetsSkipRuleActionEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  RulesetsSkipRuleActionEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      RulesetsSkipRuleActionEnum.valueOf(
...
class _$RulesetsSkipRule extends RulesetsSkipRule {
  ...
  @override
  RulesetsSkipRuleBuilder toBuilder() =>
      RulesetsSkipRuleBuilder()..replace(this);
...
class RulesetsSkipRuleBuilder
  ...
  @override
  void replace(covariant RulesetsSkipRule other) {
    _$v = other as _$RulesetsSkipRule;
  }

  @override
  void update(void Function(RulesetsSkipRuleBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RulesetsSkipRule build() => _build();

  _$RulesetsSkipRule _build() {
    _$RulesetsSkipRule _$result;
    try {
      _$result = _$v ??
          _$RulesetsSkipRule._(
            action: action,
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'RulesetsSkipRule', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
