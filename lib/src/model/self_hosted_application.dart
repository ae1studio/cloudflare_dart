...
part 'self_hosted_application.g.dart';
...
@BuiltValue()
abstract class SelfHostedApplication implements AccessAppReqEmbeddedPolicies, AccessAppReqEmbeddedScimConfig, AccessSelfHostedProps, Built<SelfHostedApplication, SelfHostedApplicationBuilder> {
  SelfHostedApplication._();

  factory SelfHostedApplication([void updates(SelfHostedApplicationBuilder b)]) = _$SelfHostedApplication;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SelfHostedApplicationBuilder b) => b
  ...
  static Serializer<SelfHostedApplication> get serializer => _$SelfHostedApplicationSerializer();
}

class _$SelfHostedApplicationSerializer implements PrimitiveSerializer<SelfHostedApplication> {
  @override
  final Iterable<Type> types = const [SelfHostedApplication, _$SelfHostedApplication];

  @override
  final String wireName = r'SelfHostedApplication';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SelfHostedApplication object, {
  ...
  void _deserializeProperties(
    ...
    required SelfHostedApplicationBuilder result,
  ...
  @override
  SelfHostedApplication deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SelfHostedApplicationBuilder();
