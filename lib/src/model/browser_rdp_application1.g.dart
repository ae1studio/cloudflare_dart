...
part of 'browser_rdp_application1.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$BrowserRDPApplication1 extends BrowserRDPApplication1 {
  @override
  ...
  factory _$BrowserRDPApplication1(
      ...
      (BrowserRDPApplication1Builder()..update(updates))._build();
  ...
  @override
  BrowserRDPApplication1Builder toBuilder() =>
      BrowserRDPApplication1Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is BrowserRDPApplication1 &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'BrowserRDPApplication1')
...
class BrowserRDPApplication1Builder
    implements
        Builder<BrowserRDPApplication1, BrowserRDPApplication1Builder>,
        AccessAppRespEmbeddedPoliciesBuilder,
        AccessBasicAppResponsePropsBuilder,
        AccessRdpPropsBuilder {
  _$BrowserRDPApplication1? _$v;
  ...
  BrowserRDPApplication1Builder get _$this {
    final $v = _$v;
    if ($v != null) {
...
// ignore: override_on_non_overriding_method
  void replace(covariant BrowserRDPApplication1 other) {
    _$v = other as _$BrowserRDPApplication1;
  }

  @override
  void update(void Function(BrowserRDPApplication1Builder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  BrowserRDPApplication1 build() => _build();

  _$BrowserRDPApplication1 _build() {
    _$BrowserRDPApplication1 _$result;
    try {
      _$result = _$v ??
          _$BrowserRDPApplication1._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'BrowserRDPApplication1', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
