...
part 'google_gemma312_bit_messages.g.dart';
...
@BuiltValue()
abstract class GoogleGemma312BItMessages implements Built<GoogleGemma312BItMessages, GoogleGemma312BItMessagesBuilder> {
  /// An array of message objects representing the conversation history.
  @BuiltValueField(wireName: r'messages')
  BuiltList<GoogleGemma312BItMessagesMessagesInner> get messages;
  ...
  GoogleGemma312BItMessages._();

  factory GoogleGemma312BItMessages([void updates(GoogleGemma312BItMessagesBuilder b)]) = _$GoogleGemma312BItMessages;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GoogleGemma312BItMessagesBuilder b) => b
      ..maxTokens = 256
      ..raw = false
      ..stream = false
      ..temperature = 0.6;
  ...
  static Serializer<GoogleGemma312BItMessages> get serializer => _$GoogleGemma312BItMessagesSerializer();
}

class _$GoogleGemma312BItMessagesSerializer implements PrimitiveSerializer<GoogleGemma312BItMessages> {
  @override
  final Iterable<Type> types = const [GoogleGemma312BItMessages, _$GoogleGemma312BItMessages];

  @override
  final String wireName = r'GoogleGemma312BItMessages';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    GoogleGemma312BItMessages object, {
    FullType specifiedType = FullType.unspecified,
  }) sync* {
    yield r'messages';
    yield serializers.serialize(
      object.messages,
      specifiedType: const FullType(BuiltList, [FullType(GoogleGemma312BItMessagesMessagesInner)]),
    );
  ...
  void _deserializeProperties(
    ...
    required GoogleGemma312BItMessagesBuilder result,
      ...
      switch (key) {
        case r'messages':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(GoogleGemma312BItMessagesMessagesInner)]),
          ) as BuiltList<GoogleGemma312BItMessagesMessagesInner>;
  ...
  @override
  GoogleGemma312BItMessages deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = GoogleGemma312BItMessagesBuilder();
