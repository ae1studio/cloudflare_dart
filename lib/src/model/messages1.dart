...
@BuiltValue()
abstract class Messages1 implements Built<Messages1, Messages1Builder> {
  ...
  factory Messages1([void updates(Messages1Builder b)]) = _$Messages1;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(Messages1Builder b) => b
      ..maxTokens = 256
      ..raw = false
      ..stream = false
      ..temperature = 0.6;
  ...
  static Serializer<Messages1> get serializer => _$Messages1Serializer();
}

class _$Messages1Serializer implements PrimitiveSerializer<Messages1> {
  @override
  final Iterable<Type> types = const [Messages1, _$Messages1];

  @override
  final String wireName = r'Messages1';
  ...
  void _deserializeProperties(
    ...
    required Messages1Builder result,
  ...
  @override
  Messages1 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = Messages1Builder();
