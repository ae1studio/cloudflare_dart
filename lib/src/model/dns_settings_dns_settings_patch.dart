...
part 'dns_settings_dns_settings_patch.g.dart';

/// DnsSettingsDnsSettingsPatch
///
/// Properties:
...
abstract class DnsSettingsDnsSettingsPatch implements DnsSettingsDnsSettingsBase {
  @BuiltValueSerializer(custom: true)
  static Serializer<DnsSettingsDnsSettingsPatch> get serializer => _$DnsSettingsDnsSettingsPatchSerializer();
}

class _$DnsSettingsDnsSettingsPatchSerializer implements PrimitiveSerializer<DnsSettingsDnsSettingsPatch> {
  @override
  final Iterable<Type> types = const [DnsSettingsDnsSettingsPatch];

  @override
  final String wireName = r'DnsSettingsDnsSettingsPatch';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    DnsSettingsDnsSettingsPatch object, {
  ...
  @override
  DnsSettingsDnsSettingsPatch deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized, specifiedType: FullType($DnsSettingsDnsSettingsPatch)) as $DnsSettingsDnsSettingsPatch;
  }
}

/// a concrete implementation of [DnsSettingsDnsSettingsPatch], since [DnsSettingsDnsSettingsPatch] is not instantiable
@BuiltValue(instantiable: true)
abstract class $DnsSettingsDnsSettingsPatch implements DnsSettingsDnsSettingsPatch, Built<$DnsSettingsDnsSettingsPatch, $DnsSettingsDnsSettingsPatchBuilder> {
  $DnsSettingsDnsSettingsPatch._();

  factory $DnsSettingsDnsSettingsPatch([void Function($DnsSettingsDnsSettingsPatchBuilder)? updates]) = _$$DnsSettingsDnsSettingsPatch;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($DnsSettingsDnsSettingsPatchBuilder b) => b;
...
class _$$DnsSettingsDnsSettingsPatchSerializer implements PrimitiveSerializer<$DnsSettingsDnsSettingsPatch> {
  @override
  final Iterable<Type> types = const [$DnsSettingsDnsSettingsPatch, _$$DnsSettingsDnsSettingsPatch];
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(DnsSettingsDnsSettingsPatch))!;
  }
  ...
  void _deserializeProperties(
    ...
    required DnsSettingsDnsSettingsPatchBuilder result,
  ...
  $DnsSettingsDnsSettingsPatch deserialize(
    ...
    final result = $DnsSettingsDnsSettingsPatchBuilder();
