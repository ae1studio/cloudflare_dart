...
part 'browser_vnc_application.g.dart';
...
@BuiltValue()
abstract class BrowserVNCApplication implements AccessAppReqEmbeddedPolicies, AccessAppReqEmbeddedScimConfig, AccessVncProps, Built<BrowserVNCApplication, BrowserVNCApplicationBuilder> {
  BrowserVNCApplication._();

  factory BrowserVNCApplication([void updates(BrowserVNCApplicationBuilder b)]) = _$BrowserVNCApplication;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BrowserVNCApplicationBuilder b) => b
  ...
  static Serializer<BrowserVNCApplication> get serializer => _$BrowserVNCApplicationSerializer();
}

class _$BrowserVNCApplicationSerializer implements PrimitiveSerializer<BrowserVNCApplication> {
  @override
  final Iterable<Type> types = const [BrowserVNCApplication, _$BrowserVNCApplication];

  @override
  final String wireName = r'BrowserVNCApplication';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BrowserVNCApplication object, {
  ...
  void _deserializeProperties(
    ...
    required BrowserVNCApplicationBuilder result,
  ...
  @override
  BrowserVNCApplication deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BrowserVNCApplicationBuilder();
