...
class AccountLevelCustomNameserversAddAccountCustomNameserver4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<AccountLevelCustomNameserversAddAccountCustomNameserver4XXResponseResultEnum> get serializer => _$accountLevelCustomNameserversAddAccountCustomNameserver4XXResponseResultSerializer;

  const AccountLevelCustomNameserversAddAccountCustomNameserver4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<AccountLevelCustomNameserversAddAccountCustomNameserver4XXResponseResultEnum> get values => _$accountLevelCustomNameserversAddAccountCustomNameserver4XXResponseResultValues;
  static AccountLevelCustomNameserversAddAccountCustomNameserver4XXResponseResultEnum valueOf(String name) => _$accountLevelCustomNameserversAddAccountCustomNameserver4XXResponseResultValueOf(name);
}
