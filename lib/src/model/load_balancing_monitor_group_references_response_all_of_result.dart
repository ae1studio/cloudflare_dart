...
class LoadBalancingMonitorGroupReferencesResponseAllOfResultReferenceTypeEnum extends EnumClass {
  ...
  static Serializer<LoadBalancingMonitorGroupReferencesResponseAllOfResultReferenceTypeEnum> get serializer => _$loadBalancingMonitorGroupReferencesResponseAllOfResultReferenceTypeEnumSerializer;

  const LoadBalancingMonitorGroupReferencesResponseAllOfResultReferenceTypeEnum._(String name): super(name);

  static BuiltSet<LoadBalancingMonitorGroupReferencesResponseAllOfResultReferenceTypeEnum> get values => _$loadBalancingMonitorGroupReferencesResponseAllOfResultReferenceTypeEnumValues;
  static LoadBalancingMonitorGroupReferencesResponseAllOfResultReferenceTypeEnum valueOf(String name) => _$loadBalancingMonitorGroupReferencesResponseAllOfResultReferenceTypeEnumValueOf(name);
}
