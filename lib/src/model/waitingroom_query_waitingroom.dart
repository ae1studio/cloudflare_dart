...
part 'waitingroom_query_waitingroom.g.dart';
...
/// * [turnstileMode] 
@BuiltValue()
abstract class WaitingroomQueryWaitingroom implements Built<WaitingroomQueryWaitingroom, WaitingroomQueryWaitingroomBuilder> {
  ...
  WaitingroomQueryWaitingroom._();

  factory WaitingroomQueryWaitingroom([void updates(WaitingroomQueryWaitingroomBuilder b)]) = _$WaitingroomQueryWaitingroom;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(WaitingroomQueryWaitingroomBuilder b) => b
      ..customPageHtml = ''
      ..description = ''
  ...
  static Serializer<WaitingroomQueryWaitingroom> get serializer => _$WaitingroomQueryWaitingroomSerializer();
}

class _$WaitingroomQueryWaitingroomSerializer implements PrimitiveSerializer<WaitingroomQueryWaitingroom> {
  @override
  final Iterable<Type> types = const [WaitingroomQueryWaitingroom, _$WaitingroomQueryWaitingroom];

  @override
  final String wireName = r'WaitingroomQueryWaitingroom';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    WaitingroomQueryWaitingroom object, {
  ...
  void _deserializeProperties(
    ...
    required WaitingroomQueryWaitingroomBuilder result,
  ...
  @override
  WaitingroomQueryWaitingroom deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = WaitingroomQueryWaitingroomBuilder();
