...
class ZoneLevelAuthenticatedOriginPullsUploadCertificate4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<ZoneLevelAuthenticatedOriginPullsUploadCertificate4XXResponseResultEnum> get serializer => _$zoneLevelAuthenticatedOriginPullsUploadCertificate4XXResponseResultEnumSerializer;

  const ZoneLevelAuthenticatedOriginPullsUploadCertificate4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<ZoneLevelAuthenticatedOriginPullsUploadCertificate4XXResponseResultEnum> get values => _$zoneLevelAuthenticatedOriginPullsUploadCertificate4XXResponseResultEnumValues;
  static ZoneLevelAuthenticatedOriginPullsUploadCertificate4XXResponseResultEnum valueOf(String name) => _$zoneLevelAuthenticatedOriginPullsUploadCertificate4XXResponseResultEnumValueOf(name);
}
