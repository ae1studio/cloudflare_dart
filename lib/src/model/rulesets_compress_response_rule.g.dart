...
part of 'rulesets_compress_response_rule.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const RulesetsCompressResponseRuleActionEnum
    _$rulesetsCompressResponseRuleActionEnum_compressResponse =
    const RulesetsCompressResponseRuleActionEnum._('compressResponse');

RulesetsCompressResponseRuleActionEnum
    _$rulesetsCompressResponseRuleActionEnumValueOf(String name) {
  switch (name) {
    case 'compressResponse':
      return _$rulesetsCompressResponseRuleActionEnum_compressResponse;
    default:
      throw ArgumentError(name);
  }
}

final BuiltSet<RulesetsCompressResponseRuleActionEnum>
    _$rulesetsCompressResponseRuleActionEnumValues = BuiltSet<
        RulesetsCompressResponseRuleActionEnum>(const <RulesetsCompressResponseRuleActionEnum>[
  _$rulesetsCompressResponseRuleActionEnum_compressResponse,
]);

Serializer<RulesetsCompressResponseRuleActionEnum>
    _$rulesetsCompressResponseRuleActionEnumSerializer =
    _$RulesetsCompressResponseRuleActionEnumSerializer();

class _$RulesetsCompressResponseRuleActionEnumSerializer
    implements PrimitiveSerializer<RulesetsCompressResponseRuleActionEnum> {
  ...
  @override
  final String wireName = 'RulesetsCompressResponseRuleActionEnum';

  @override
  Object serialize(Serializers serializers,
          RulesetsCompressResponseRuleActionEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  RulesetsCompressResponseRuleActionEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      RulesetsCompressResponseRuleActionEnum.valueOf(
          _fromWire[serialized] ?? (serialized is String ? serialized : ''));
}

class _$RulesetsCompressResponseRule extends RulesetsCompressResponseRule {
  @override
  final String? action;
  @override
  ...
  factory _$RulesetsCompressResponseRule(
          [void Function(RulesetsCompressResponseRuleBuilder)? updates]) =>
      (RulesetsCompressResponseRuleBuilder()..update(updates))._build();

  _$RulesetsCompressResponseRule._(
      {this.action,
      ...
      : super._();
  @override
  RulesetsCompressResponseRule rebuild(
          void Function(RulesetsCompressResponseRuleBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RulesetsCompressResponseRuleBuilder toBuilder() =>
      RulesetsCompressResponseRuleBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RulesetsCompressResponseRule &&
        action == other.action &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RulesetsCompressResponseRule')
          ..add('action', action)
...
class RulesetsCompressResponseRuleBuilder
    implements
        Builder<RulesetsCompressResponseRule,
            RulesetsCompressResponseRuleBuilder>,
        RulesetsRuleBuilder {
  _$RulesetsCompressResponseRule? _$v;
  ...
  RulesetsCompressResponseRuleBuilder() {
    RulesetsCompressResponseRule._defaults(this);
  }

  RulesetsCompressResponseRuleBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _action = $v.action;
  ...
  @override
  void replace(covariant RulesetsCompressResponseRule other) {
    _$v = other as _$RulesetsCompressResponseRule;
  }

  @override
  void update(void Function(RulesetsCompressResponseRuleBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RulesetsCompressResponseRule build() => _build();

  _$RulesetsCompressResponseRule _build() {
    _$RulesetsCompressResponseRule _$result;
    try {
      _$result = _$v ??
          _$RulesetsCompressResponseRule._(
            action: action,
            ...
            lastUpdated: BuiltValueNullFieldError.checkNotNull(
                lastUpdated, r'RulesetsCompressResponseRule', 'lastUpdated'),
            logging: _logging?.build(),
            ratelimit: _ratelimit?.build(),
            ref: ref,
            version: BuiltValueNullFieldError.checkNotNull(
                version, r'RulesetsCompressResponseRule', 'version'),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'RulesetsCompressResponseRule', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
