...
part of 'prompt1.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$Prompt1 extends Prompt1 {
  @override
  ...
  factory _$Prompt1([void Function(Prompt1Builder)? updates]) =>
      (Prompt1Builder()..update(updates))._build();
  ...
  _$Prompt1._(
      ...
      : super._();
  @override
  Prompt1 rebuild(void Function(Prompt1Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  Prompt1Builder toBuilder() => Prompt1Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is Prompt1 &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Prompt1')
...
class Prompt1Builder implements Builder<Prompt1, Prompt1Builder> {
  _$Prompt1? _$v;
  ...
  Prompt1Builder() {
    Prompt1._defaults(this);
  }

  Prompt1Builder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(Prompt1 other) {
    _$v = other as _$Prompt1;
  }

  @override
  void update(void Function(Prompt1Builder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  Prompt1 build() => _build();
    ...
    try {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'Prompt1', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
