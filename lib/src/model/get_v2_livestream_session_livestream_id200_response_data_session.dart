...
part 'get_v2_livestream_session_livestream_id200_response_data_session.g.dart';
...
@BuiltValue()
abstract class GetV2LivestreamSessionLivestreamId200ResponseDataSession implements Built<GetV2LivestreamSessionLivestreamId200ResponseDataSession, GetV2LivestreamSessionLivestreamId200ResponseDataSessionBuilder> {
  ...
  GetV2LivestreamSessionLivestreamId200ResponseDataSession._();

  factory GetV2LivestreamSessionLivestreamId200ResponseDataSession([void updates(GetV2LivestreamSessionLivestreamId200ResponseDataSessionBuilder b)]) = _$GetV2LivestreamSessionLivestreamId200ResponseDataSession;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GetV2LivestreamSessionLivestreamId200ResponseDataSessionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GetV2LivestreamSessionLivestreamId200ResponseDataSession> get serializer => _$GetV2LivestreamSessionLivestreamId200ResponseDataSessionSerializer();
}

class _$GetV2LivestreamSessionLivestreamId200ResponseDataSessionSerializer implements PrimitiveSerializer<GetV2LivestreamSessionLivestreamId200ResponseDataSession> {
  @override
  final Iterable<Type> types = const [GetV2LivestreamSessionLivestreamId200ResponseDataSession, _$GetV2LivestreamSessionLivestreamId200ResponseDataSession];

  @override
  final String wireName = r'GetV2LivestreamSessionLivestreamId200ResponseDataSession';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    GetV2LivestreamSessionLivestreamId200ResponseDataSession object, {
  ...
  void _deserializeProperties(
    ...
    required GetV2LivestreamSessionLivestreamId200ResponseDataSessionBuilder result,
  ...
  @override
  GetV2LivestreamSessionLivestreamId200ResponseDataSession deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = GetV2LivestreamSessionLivestreamId200ResponseDataSessionBuilder();
