...
class SecondaryDnsPrimaryZoneEnableOutgoingZoneTransfers4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<SecondaryDnsPrimaryZoneEnableOutgoingZoneTransfers4XXResponseResultEnum> get serializer => _$secondaryDnsPrimaryZoneEnableOutgoingZoneTransfers4XXResponseResultSerializer;

  const SecondaryDnsPrimaryZoneEnableOutgoingZoneTransfers4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<SecondaryDnsPrimaryZoneEnableOutgoingZoneTransfers4XXResponseResultEnum> get values => _$secondaryDnsPrimaryZoneEnableOutgoingZoneTransfers4XXResponseResultValues;
  static SecondaryDnsPrimaryZoneEnableOutgoingZoneTransfers4XXResponseResultEnum valueOf(String name) => _$secondaryDnsPrimaryZoneEnableOutgoingZoneTransfers4XXResponseResultValueOf(name);
}
