...
part 'brapi_post_screenshot_request.g.dart';
...
@BuiltValue()
abstract class BrapiPostScreenshotRequest implements Built<BrapiPostScreenshotRequest, BrapiPostScreenshotRequestBuilder> {
  ...
  @BuiltValueField(wireName: r'scrollPage')
  bool? get scrollPage;
  ...
  BrapiPostScreenshotRequest._();

  factory BrapiPostScreenshotRequest([void updates(BrapiPostScreenshotRequestBuilder b)]) = _$BrapiPostScreenshotRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BrapiPostScreenshotRequestBuilder b) => b
      ..userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36';

  @BuiltValueSerializer(custom: true)
  static Serializer<BrapiPostScreenshotRequest> get serializer => _$BrapiPostScreenshotRequestSerializer();
}

class _$BrapiPostScreenshotRequestSerializer implements PrimitiveSerializer<BrapiPostScreenshotRequest> {
  @override
  final Iterable<Type> types = const [BrapiPostScreenshotRequest, _$BrapiPostScreenshotRequest];

  @override
  final String wireName = r'BrapiPostScreenshotRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BrapiPostScreenshotRequest object, {
    ...
    if (object.screenshotOptions != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BrapiPostScreenshotRequestAllOfScreenshotOptions),
      );
    }
    if (object.scrollPage != null) {
      yield r'scrollPage';
      yield serializers.serialize(
        object.scrollPage,
        specifiedType: const FullType(bool),
  ...
  void _deserializeProperties(
    ...
    required BrapiPostScreenshotRequestBuilder result,
      ...
      switch (key) {
        ...
        case r'screenshotOptions':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BrapiPostScreenshotRequestAllOfScreenshotOptions),
          ) as BrapiPostScreenshotRequestAllOfScreenshotOptions;
  ...
  @override
  BrapiPostScreenshotRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BrapiPostScreenshotRequestBuilder();
