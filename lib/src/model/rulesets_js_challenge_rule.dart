...
part 'rulesets_js_challenge_rule.g.dart';
...
@BuiltValue()
abstract class RulesetsJsChallengeRule implements RulesetsRule, Built<RulesetsJsChallengeRule, RulesetsJsChallengeRuleBuilder> {
  RulesetsJsChallengeRule._();

  factory RulesetsJsChallengeRule([void updates(RulesetsJsChallengeRuleBuilder b)]) = _$RulesetsJsChallengeRule;
  ...
  static Serializer<RulesetsJsChallengeRule> get serializer => _$RulesetsJsChallengeRuleSerializer();
}

class _$RulesetsJsChallengeRuleSerializer implements PrimitiveSerializer<RulesetsJsChallengeRule> {
  @override
  final Iterable<Type> types = const [RulesetsJsChallengeRule, _$RulesetsJsChallengeRule];

  @override
  final String wireName = r'RulesetsJsChallengeRule';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RulesetsJsChallengeRule object, {
  ...
  void _deserializeProperties(
    ...
    required RulesetsJsChallengeRuleBuilder result,
  ...
  @override
  RulesetsJsChallengeRule deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RulesetsJsChallengeRuleBuilder();
...
class RulesetsJsChallengeRuleActionEnum extends EnumClass {
