...
abstract class AccessRdpProps implements AccessAppRespEmbeddedTargetCriteriaSelfHosted, AccessSelfHostedProps {
  @BuiltValueSerializer(custom: true)
  static Serializer<AccessRdpProps> get serializer => _$AccessRdpPropsSerializer();
}

class _$AccessRdpPropsSerializer implements PrimitiveSerializer<AccessRdpProps> {
  @override
  final Iterable<Type> types = const [AccessRdpProps];

  @override
  final String wireName = r'AccessRdpProps';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccessRdpProps object, {
  ...
  @override
  AccessRdpProps deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized, specifiedType: FullType($AccessRdpProps)) as $AccessRdpProps;
  }
}

/// a concrete implementation of [AccessRdpProps], since [AccessRdpProps] is not instantiable
@BuiltValue(instantiable: true)
abstract class $AccessRdpProps implements AccessRdpProps, Built<$AccessRdpProps, $AccessRdpPropsBuilder> {
  $AccessRdpProps._();

  factory $AccessRdpProps([void Function($AccessRdpPropsBuilder)? updates]) = _$$AccessRdpProps;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($AccessRdpPropsBuilder b) => b;
...
class _$$AccessRdpPropsSerializer implements PrimitiveSerializer<$AccessRdpProps> {
  @override
  final Iterable<Type> types = const [$AccessRdpProps, _$$AccessRdpProps];
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(AccessRdpProps))!;
  }
  ...
  void _deserializeProperties(
    ...
    required AccessRdpPropsBuilder result,
  ...
  $AccessRdpProps deserialize(
    ...
    final result = $AccessRdpPropsBuilder();
