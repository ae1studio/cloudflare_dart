...
part of 'self_hosted_application.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$SelfHostedApplication extends SelfHostedApplication {
  @override
  ...
  factory _$SelfHostedApplication(
      ...
      (SelfHostedApplicationBuilder()..update(updates))._build();
  ...
  @override
  SelfHostedApplicationBuilder toBuilder() =>
      SelfHostedApplicationBuilder()..replace(this);
...
class SelfHostedApplicationBuilder
    implements
        Builder<SelfHostedApplication, SelfHostedApplicationBuilder>,
        AccessAppReqEmbeddedPoliciesBuilder,
        AccessAppReqEmbeddedScimConfigBuilder,
        AccessSelfHostedPropsBuilder {
  _$SelfHostedApplication? _$v;
  ...
  SelfHostedApplicationBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
...
// ignore: override_on_non_overriding_method
  void replace(covariant SelfHostedApplication other) {
    _$v = other as _$SelfHostedApplication;
  }

  @override
  void update(void Function(SelfHostedApplicationBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  SelfHostedApplication build() => _build();

  _$SelfHostedApplication _build() {
    _$SelfHostedApplication _$result;
    try {
      _$result = _$v ??
          _$SelfHostedApplication._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'SelfHostedApplication', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
