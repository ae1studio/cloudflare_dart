...
part 'teams_devices_device_posture_rules.g.dart';
...
/// * [type] 
@BuiltValue()
abstract class TeamsDevicesDevicePostureRules implements Built<TeamsDevicesDevicePostureRules, TeamsDevicesDevicePostureRulesBuilder> {
  ...
  TeamsDevicesDevicePostureRules._();

  factory TeamsDevicesDevicePostureRules([void updates(TeamsDevicesDevicePostureRulesBuilder b)]) = _$TeamsDevicesDevicePostureRules;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TeamsDevicesDevicePostureRulesBuilder b) => b
      ..description = '';

  @BuiltValueSerializer(custom: true)
  static Serializer<TeamsDevicesDevicePostureRules> get serializer => _$TeamsDevicesDevicePostureRulesSerializer();
}

class _$TeamsDevicesDevicePostureRulesSerializer implements PrimitiveSerializer<TeamsDevicesDevicePostureRules> {
  @override
  final Iterable<Type> types = const [TeamsDevicesDevicePostureRules, _$TeamsDevicesDevicePostureRules];

  @override
  final String wireName = r'TeamsDevicesDevicePostureRules';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    TeamsDevicesDevicePostureRules object, {
  ...
  void _deserializeProperties(
    ...
    required TeamsDevicesDevicePostureRulesBuilder result,
  ...
  @override
  TeamsDevicesDevicePostureRules deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = TeamsDevicesDevicePostureRulesBuilder();
