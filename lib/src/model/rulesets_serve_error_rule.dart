...
part 'rulesets_serve_error_rule.g.dart';
...
@BuiltValue()
abstract class RulesetsServeErrorRule implements RulesetsRule, Built<RulesetsServeErrorRule, RulesetsServeErrorRuleBuilder> {
  RulesetsServeErrorRule._();

  factory RulesetsServeErrorRule([void updates(RulesetsServeErrorRuleBuilder b)]) = _$RulesetsServeErrorRule;
  ...
  static Serializer<RulesetsServeErrorRule> get serializer => _$RulesetsServeErrorRuleSerializer();
}

class _$RulesetsServeErrorRuleSerializer implements PrimitiveSerializer<RulesetsServeErrorRule> {
  @override
  final Iterable<Type> types = const [RulesetsServeErrorRule, _$RulesetsServeErrorRule];

  @override
  final String wireName = r'RulesetsServeErrorRule';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RulesetsServeErrorRule object, {
  ...
  void _deserializeProperties(
    ...
    required RulesetsServeErrorRuleBuilder result,
  ...
  @override
  RulesetsServeErrorRule deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RulesetsServeErrorRuleBuilder();
...
class RulesetsServeErrorRuleActionEnum extends EnumClass {
