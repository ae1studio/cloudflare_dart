...
part of 'magic_ipsec_tunnel_add_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$MagicIpsecTunnelAddRequest extends MagicIpsecTunnelAddRequest {
  @override
  ...
  factory _$MagicIpsecTunnelAddRequest(
          [void Function(MagicIpsecTunnelAddRequestBuilder)? updates]) =>
      (MagicIpsecTunnelAddRequestBuilder()..update(updates))._build();

  _$MagicIpsecTunnelAddRequest._(
      ...
      : super._();
  @override
  MagicIpsecTunnelAddRequest rebuild(
          void Function(MagicIpsecTunnelAddRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  MagicIpsecTunnelAddRequestBuilder toBuilder() =>
      MagicIpsecTunnelAddRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is MagicIpsecTunnelAddRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'MagicIpsecTunnelAddRequest')
...
class MagicIpsecTunnelAddRequestBuilder
    implements
        Builder<MagicIpsecTunnelAddRequest, MagicIpsecTunnelAddRequestBuilder>,
        MagicIpsecTunnelAddSingleRequestBuilder {
  _$MagicIpsecTunnelAddRequest? _$v;
  ...
  MagicIpsecTunnelAddRequestBuilder() {
    MagicIpsecTunnelAddRequest._defaults(this);
  }

  MagicIpsecTunnelAddRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant MagicIpsecTunnelAddRequest other) {
    _$v = other as _$MagicIpsecTunnelAddRequest;
  }

  @override
  void update(void Function(MagicIpsecTunnelAddRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  MagicIpsecTunnelAddRequest build() => _build();

  _$MagicIpsecTunnelAddRequest _build() {
    _$MagicIpsecTunnelAddRequest _$result;
    try {
      _$result = _$v ??
          _$MagicIpsecTunnelAddRequest._(
            cloudflareEndpoint: BuiltValueNullFieldError.checkNotNull(
                cloudflareEndpoint,
                r'MagicIpsecTunnelAddRequest',
                'cloudflareEndpoint'),
            ...
            name: BuiltValueNullFieldError.checkNotNull(
                name, r'MagicIpsecTunnelAddRequest', 'name'),
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'MagicIpsecTunnelAddRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
