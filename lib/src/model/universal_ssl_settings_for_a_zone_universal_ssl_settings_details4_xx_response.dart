...
class UniversalSslSettingsForAZoneUniversalSslSettingsDetails4XXResponseResultEnum extends EnumClass {
  ...
  static Serializer<UniversalSslSettingsForAZoneUniversalSslSettingsDetails4XXResponseResultEnum> get serializer => _$universalSslSettingsForAZoneUniversalSslSettingsDetails4XXResponseResultEnumSerializer;

  const UniversalSslSettingsForAZoneUniversalSslSettingsDetails4XXResponseResultEnum._(String name): super(name);

  static BuiltSet<UniversalSslSettingsForAZoneUniversalSslSettingsDetails4XXResponseResultEnum> get values => _$universalSslSettingsForAZoneUniversalSslSettingsDetails4XXResponseResultEnumValues;
  static UniversalSslSettingsForAZoneUniversalSslSettingsDetails4XXResponseResultEnum valueOf(String name) => _$universalSslSettingsForAZoneUniversalSslSettingsDetails4XXResponseResultEnumValueOf(name);
}
