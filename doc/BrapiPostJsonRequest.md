# cloudflare_dart.model.BrapiPostJsonRequest
...
**allowResourceTypes** | [**BuiltList&lt;BrapiPostContentRequestAllOfAllowResourceTypesInner&gt;**](BrapiPostContentRequestAllOfAllowResourceTypesInner.md) | Only allow requests that match the provided resource types, eg. 'image' or 'script'. | [optional] 
...
**customAi** | [**BuiltList&lt;BrapiPostJsonRequestAllOfCustomAiInner&gt;**](BrapiPostJsonRequestAllOfCustomAiInner.md) | Optional list of custom AI models to use for the request. The models will be tried in the order provided, and in case a model returns an error, the next one will be used as fallback. | [optional] 
...
**rejectResourceTypes** | [**BuiltList&lt;BrapiPostContentRequestAllOfAllowResourceTypesInner&gt;**](BrapiPostContentRequestAllOfAllowResourceTypesInner.md) | Block undesired requests that match the provided resource types, eg. 'image' or 'script'. | [optional] 
**responseFormat** | [**BrapiPostJsonRequestAllOfResponseFormat**](BrapiPostJsonRequestAllOfResponseFormat.md) |  | [optional] 
