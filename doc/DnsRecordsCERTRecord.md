# cloudflare_dart.model.DnsRecordsCERTRecord
...
**content** | **String** | Formatted CERT content. See 'data' to set CERT properties. | [optional] 
**data** | [**DnsRecordsCERTRecordAllOfData**](DnsRecordsCERTRecordAllOfData.md) |  | [optional] 
