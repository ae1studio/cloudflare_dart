# cloudflare_dart.model.DnsAnalyticsResult
...
------------ | ------------- | ------------- | -------------
**data** | [**BuiltList&lt;DnsAnalyticsDataInner&gt;**](DnsAnalyticsDataInner.md) | Array with one row per combination of dimension values. | 
