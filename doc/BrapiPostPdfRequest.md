...
**allowResourceTypes** | [**BuiltList&lt;BrapiPostPdfRequestAllOfAllowResourceTypes&gt;**](BrapiPostPdfRequestAllOfAllowResourceTypes.md) | Only allow requests that match the provided resource types, eg. 'image' or 'script'. | [optional] 
...
**rejectResourceTypes** | [**BuiltList&lt;BrapiPostPdfRequestAllOfRejectResourceTypes&gt;**](BrapiPostPdfRequestAllOfRejectResourceTypes.md) | Block undesired requests that match the provided resource types, eg. 'image' or 'script'. | [optional] 
