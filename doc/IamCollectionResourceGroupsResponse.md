# cloudflare_dart.model.IamCollectionResourceGroupsResponse
...
**result** | [**BuiltList&lt;IamResourceGroup&gt;**](IamResourceGroup.md) | A list of resource groups that the policy applies to. | [optional] 
