# cloudflare_dart.model.AccessSchemasSamlAllOfConfig
...
**signRequest** | **bool** | Sign the SAML authentication request with Access credentials. To verify the signature, use the public key from the Access certs endpoints. | [optional] 
