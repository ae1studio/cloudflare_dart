# cloudflare_dart.model.DnsRecordsLOCRecord
...
**content** | **String** | Formatted LOC content. See 'data' to set LOC properties. | [optional] 
**data** | [**DnsRecordsLOCRecordAllOfData**](DnsRecordsLOCRecordAllOfData.md) |  | [optional] 
