# cloudflare_dart.model.HealthchecksHealthchecks
...
**failureReason** | **String** | The current failure reason if status is unhealthy. | [optional] 
...
**status** | [**HealthchecksStatus**](HealthchecksStatus.md) |  | [optional] 
