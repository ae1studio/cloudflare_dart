# cloudflare_dart.model.DnsRecordsDSRecord
...
**content** | **String** | Formatted DS content. See 'data' to set DS properties. | [optional] 
**data** | [**DnsRecordsDSRecordAllOfData**](DnsRecordsDSRecordAllOfData.md) |  | [optional] 
