...
**allowResourceTypes** | [**BuiltList&lt;BrapiPostScrapeRequestAllOfAllowResourceTypes&gt;**](BrapiPostScrapeRequestAllOfAllowResourceTypes.md) | Only allow requests that match the provided resource types, eg. 'image' or 'script'. | [optional] 
...
**rejectResourceTypes** | [**BuiltList&lt;BrapiPostScrapeRequestAllOfRejectResourceTypes&gt;**](BrapiPostScrapeRequestAllOfRejectResourceTypes.md) | Block undesired requests that match the provided resource types, eg. 'image' or 'script'. | [optional] 
