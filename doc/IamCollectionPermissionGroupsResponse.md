# cloudflare_dart.model.IamCollectionPermissionGroupsResponse
...
**result** | [**BuiltList&lt;IamPermissionGroup&gt;**](IamPermissionGroup.md) | A set of permission groups that are specified to the policy. | [optional] 
