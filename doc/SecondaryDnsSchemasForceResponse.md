# cloudflare_dart.model.SecondaryDnsSchemasForceResponse
...
**result** | **String** | When force_notify query parameter is set to true, the response is a simple string. | [optional] 
