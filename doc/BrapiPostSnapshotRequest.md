...
**allowResourceTypes** | [**BuiltList&lt;BrapiPostSnapshotRequestAllOfAllowResourceTypes&gt;**](BrapiPostSnapshotRequestAllOfAllowResourceTypes.md) | Only allow requests that match the provided resource types, eg. 'image' or 'script'. | [optional] 
...
**rejectResourceTypes** | [**BuiltList&lt;BrapiPostSnapshotRequestAllOfRejectResourceTypes&gt;**](BrapiPostSnapshotRequestAllOfRejectResourceTypes.md) | Block undesired requests that match the provided resource types, eg. 'image' or 'script'. | [optional] 
