# cloudflare_dart.model.DnsRecordsNAPTRRecord
...
**content** | **String** | Formatted NAPTR content. See 'data' to set NAPTR properties. | [optional] 
**data** | [**DnsRecordsNAPTRRecordAllOfData**](DnsRecordsNAPTRRecordAllOfData.md) |  | [optional] 
