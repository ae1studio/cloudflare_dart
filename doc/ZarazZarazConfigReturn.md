# cloudflare_dart.model.ZarazZarazConfigReturn
...
**tools** | [**BuiltMap&lt;String, ZarazZarazConfigReturnAllOfTools&gt;**](ZarazZarazConfigReturnAllOfTools.md) | Tools set up under Zaraz configuration, where key is the alpha-numeric tool ID and value is the tool configuration object. | 
