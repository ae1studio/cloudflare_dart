# cloudflare_dart.model.TunnelSchemasConnection
...
------------ | ------------- | ------------- | -------------
**clientId** | **String** | UUID of the Cloudflare Tunnel connector. | [optional] 
...
**openedAt** | [**DateTime**](DateTime.md) | Timestamp of when the connection was established. | [optional] 
