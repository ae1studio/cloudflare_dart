# cloudflare_dart.model.DurableObjectsNamespaceListObjects200ResponseAllOfResultInfo
...
------------ | ------------- | ------------- | -------------
**count** | **num** | Total results returned based on your list parameters. | [optional] 
