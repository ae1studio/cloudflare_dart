# cloudflare_dart.model.StreamClipping
...
**created** | [**DateTime**](DateTime.md) | The date and time the clip was created. | [optional] 
**creator** | **String** | A user-defined identifier for the media creator. | [optional] 
**endTimeSeconds** | **int** | Specifies the end time for the video clip in seconds. | [optional] 
...
**startTimeSeconds** | **int** | Specifies the start time for the video clip in seconds. | [optional] 
**status** | [**StreamMediaState**](StreamMediaState.md) |  | [optional] 
