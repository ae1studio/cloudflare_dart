# cloudflare_dart.model.DnsRecordsCAARecord
...
**content** | **String** | Formatted CAA content. See 'data' to set CAA properties. | [optional] 
**data** | [**DnsRecordsCAARecordAllOfData**](DnsRecordsCAARecordAllOfData.md) |  | [optional] 
