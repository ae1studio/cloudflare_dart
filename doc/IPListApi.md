...
final api = CloudflareDart().getIPListApi();
final String accountId = accountId_example; // String | 

try {
    final response = api.ipListGetIpLists(accountId);
    print(response);
} catch on DioException (e) {
    print('Exception when calling IPListApi->ipListGetIpLists: $e\n');
}
```
