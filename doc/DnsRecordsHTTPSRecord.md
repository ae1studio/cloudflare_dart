# cloudflare_dart.model.DnsRecordsHTTPSRecord
...
**content** | **String** | Formatted HTTPS content. See 'data' to set HTTPS properties. | [optional] 
**data** | [**DnsRecordsHTTPSRecordAllOfData**](DnsRecordsHTTPSRecordAllOfData.md) |  | [optional] 
