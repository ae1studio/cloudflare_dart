# cloudflare_dart.model.MagicIpsecTunnel
...
**allowNullCipher** | **bool** | When `true`, the tunnel can use a null-cipher (`ENCR_NULL`) in the ESP tunnel (Phase 2). | [optional] 
...
**bgpStatus** | [**MagicBgpStatusWithState**](MagicBgpStatusWithState.md) |  | [optional] 
**createdOn** | [**DateTime**](DateTime.md) | The date and time the tunnel was created. | [optional] 
**customRemoteIdentities** | [**MagicCustomRemoteIdentities**](MagicCustomRemoteIdentities.md) |  | [optional] 
