# cloudflare_dart.model.DnsRecordsSVCBRecord
...
**content** | **String** | Formatted SVCB content. See 'data' to set SVCB properties. | [optional] 
**data** | [**DnsRecordsSVCBRecordAllOfData**](DnsRecordsSVCBRecordAllOfData.md) |  | [optional] 
