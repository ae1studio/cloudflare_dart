# cloudflare_dart.model.DnsRecordsSSHFPRecord
...
**content** | **String** | Formatted SSHFP content. See 'data' to set SSHFP properties. | [optional] 
**data** | [**DnsRecordsSSHFPRecordAllOfData**](DnsRecordsSSHFPRecordAllOfData.md) |  | [optional] 
