...
**allowResourceTypes** | [**BuiltList&lt;BrapiPostContentRequestAllOfAllowResourceTypes&gt;**](BrapiPostContentRequestAllOfAllowResourceTypes.md) | Only allow requests that match the provided resource types, eg. 'image' or 'script'. | [optional] 
...
**rejectResourceTypes** | [**BuiltList&lt;BrapiPostContentRequestAllOfRejectResourceTypes&gt;**](BrapiPostContentRequestAllOfRejectResourceTypes.md) | Block undesired requests that match the provided resource types, eg. 'image' or 'script'. | [optional] 
