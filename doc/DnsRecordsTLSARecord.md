# cloudflare_dart.model.DnsRecordsTLSARecord
...
**content** | **String** | Formatted TLSA content. See 'data' to set TLSA properties. | [optional] 
**data** | [**DnsRecordsTLSARecordAllOfData**](DnsRecordsTLSARecordAllOfData.md) |  | [optional] 
