# cloudflare_dart.model.MagicNetworkMonitoringRulesUpdateRuleRequest
...
**name** | **String** | The name of the rule. Must be unique. Supports characters A-Z, a-z, 0-9, underscore (_), dash (-), period (.), and tilde (~). You can’t have a space in the rule name. Max 256 characters. | [optional] 
