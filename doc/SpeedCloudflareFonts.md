# cloudflare_dart.model.SpeedCloudflareFonts
...
**id** | **String** | ID of the zone setting. | [optional] 
**modifiedOn** | [**DateTime**](DateTime.md) | last time this setting was modified. | [optional] 
**value** | [**SpeedCloudflareFontsValue**](SpeedCloudflareFontsValue.md) |  | [optional] 
